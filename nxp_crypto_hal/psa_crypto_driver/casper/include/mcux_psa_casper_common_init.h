...
#ifndef MCUX_PSA_CASPER_COMMON_INIT_H
#define MCUX_PSA_CASPER_COMMON_INIT_H

/** \file mcux_psa_casper_common_init.h
 *
...
/*!
 * @brief  Initialises the CASPER driver
 *
...
/*!
 * @brief  De-Initialises the CASPER driver
 *
 * @return PSA_SUCCESS on success. Error code from psa_status_t on
 *          failure
 */
...
#endif /* MCUX_PSA_CASPER_COMMON_INIT_H */
