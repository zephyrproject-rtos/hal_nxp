...
#ifndef MCUX_PSA_CAAM_COMMON_ASYMMETRIC_ENCRYPTION_H
#define MCUX_PSA_CAAM_COMMON_ASYMMETRIC_ENCRYPTION_H

/** \file mcux_psa_caam_common_asymmetric_encryption.h
 *
...
#endif
#endif /* MCUX_PSA_CAAM_COMMON_ASYMMETRIC_ENCRYPTION_H */
