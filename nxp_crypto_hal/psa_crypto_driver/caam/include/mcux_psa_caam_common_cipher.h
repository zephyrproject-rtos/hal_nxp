...
#ifndef MCUX_PSA_CAAM_COMMON_CIPHER_H
#define MCUX_PSA_CAAM_COMMON_CIPHER_H

/** \file mcux_psa_caam_common_cipher.h
 *
 ...
 *
 * \param[in]  caam_key_type   CAAM key encryption type.d.
 * \param[in]  attributes      Key attributes
 * \param[in]  key_buffer      Buffer holding key material
 * \param[in]  key_buffer_size Size in bytes of the key
 * \param[in]  alg             Algorithm to be used for which
...
#endif
#endif /* MCUX_PSA_CAAM_COMMON_CIPHER_H */
