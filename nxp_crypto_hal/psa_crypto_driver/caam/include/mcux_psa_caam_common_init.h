...
#ifndef MCUX_PSA_CAAM_COMMON_INIT_H
#define MCUX_PSA_CAAM_COMMON_INIT_H

/** \file mcux_psa_caam_common_init.h
 *
...
/*!
 * @brief  Initialises the CAAM driver
 *
...
/*!
 * @brief  De-Initialises the CAAM driver
 *
 * @return PSA_SUCCESS on success. Error code from psa_status_t on
 *          failure
 */
...
#endif /* MCUX_PSA_CAAM_COMMON_INIT_H */
