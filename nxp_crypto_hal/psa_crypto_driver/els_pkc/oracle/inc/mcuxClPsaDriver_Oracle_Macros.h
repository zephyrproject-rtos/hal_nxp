...
#define PSA_DRIVER_RETURN_STATUS_MSG(STATUS, ...) \
    psa_status = STATUS;                        \
    PSA_DRIVER_ERROR(__VA_ARGS__);              \
    return psa_status;
...
#define PSA_DRIVER_ASSERT_OR_RETURN_STATUS_MSG(CONDITION, STATUS, ...) \
    if (!(CONDITION))                                                \
    {                                                                \
        PSA_DRIVER_RETURN_STATUS_MSG(STATUS, __VA_ARGS__);             \
    }
