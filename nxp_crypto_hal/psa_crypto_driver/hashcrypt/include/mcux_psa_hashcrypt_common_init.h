...
#ifndef MCUX_PSA_HASHCRYPT_COMMON_INIT_H
#define MCUX_PSA_HASHCRYPT_COMMON_INIT_H

/** \file mcux_psa_hashcrypt_common_init.h
 *
...
/*!
 * @brief  Initialises the HASHCRYPT driver
 *
...
/*!
 * @brief  De-Initialises the HASHCRYPT driver
 *
 * @return PSA_SUCCESS on success. Error code from psa_status_t on
 *          failure
 */
...
#endif /* MCUX_PSA_HASHCRYPT_COMMON_INIT_H */
