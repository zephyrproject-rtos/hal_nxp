...
#ifndef MCUX_PSA_HASHCRYPT_COMMON_CIPHER_H
#define MCUX_PSA_HASHCRYPT_COMMON_CIPHER_H

/** \file mcux_psa_hashcrypt_common_cipher.h
 *
...
#endif
#endif /* MCUX_PSA_HASHCRYPT_COMMON_CIPHER_H */
