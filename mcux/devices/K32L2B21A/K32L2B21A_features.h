...
#define FSL_FEATURE_TPM_CHANNEL_COUNTn(x) (((x) == TPM0) ? (6) : (((x) == TPM1) ? (2) : (((x) == TPM2) ? (2) : (-1))))
...
/* @brief Is affected by errata with ID 050050 (Incorrect duty output when EPWM mode is set to PS=0 during write 1 to
 * CnV register). */
