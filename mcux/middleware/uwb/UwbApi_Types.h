...
#define SHORT_MAC_ADDRESS_MODE UWB_MAC_ADDR_MODE_2BYTES
#define EXTENDED_MAC_ADDRESS_MODE UWB_MAC_ADDR_MODE_8BYTES
#define EXTENDED_MAC_ADDRESS_MODE_WITH_HEADER UWB_MAC_ADDR_MODE_8BYTES_WITH_HEADER
#define Link_Layer_Mode_Bypass UWB_LINK_LAYER_MODE_BYPASS
#define Link_Layer_Mode_LogicalLink UWB_LINK_LAYER_MODE_LOGICAL_LINK
...
#define kUwb_ConnectionLessNonSecure UWB_LINK_LAYER_MODE_SELECTOR_CONNECTIONLESS_NS
#define kUwb_ConnectionLessSecure UWB_LINK_LAYER_MODE_SELECTOR_CONNECTIONLESS_S
#define kUwb_ConnectionOrientedNonSecure UWB_LINK_LAYER_MODE_SELECTOR_CONNECTION_ORIENTED_NS
#define kUwb_ConnectionOrientedSecure UWB_LINK_LAYER_MODE_SELECTOR_CONNECTION_ORIENTED_S
#define kUwb_ConnectionLessUWBS UWB_LINK_LAYER_MODE_SELECTOR_CONNECTIONLESS_UWBS
#define kUwb_ConnectionOrientedUWBS UWB_LINK_LAYER_MODE_SELECTOR_CONNECTION_ORIENTED_UWBS
#define eLinkLayerModes size_t

#define UWBD_RANGING_SESSION UWB_SESSION_TYPE_RANGING
#define UWBD_RANGING_WITH_INBAND_DATA_TRANSFER UWB_SESSION_TYPE_RANGING_DATA_TRANSFER
#define UWBD_DATA_TRANSFER UWB_SESSION_TYPE_DATA_TRANSFER
#define UWBD_RANGING_ONLY_PHASE UWB_SESSION_TYPE_SECONDARY_RANGING
#define UWBD_INBAND_DATA_PHASE UWB_SESSION_TYPE_SECONDARY_DATA_TRANSFER
#define UWBD_RANGING_WITH_DATA_PHASE UWB_SESSION_TYPE_SECONDARY_RANGING_WITH_DATA_TRANSFER
#define UWBD_HUS_SESSION UWB_SESSION_TYPE_PRIMARY_HUS
#define UWBD_CCC_SESSION UWB_SESSION_TYPE_CCC
#define UWBD_CSA_SESSION UWB_SESSION_TYPE_CSA
#define UWBD_RFTEST UWB_SESSION_TYPE_DEVICE_TEST
#define UWBD_RADAR_TRANSFER 0xF0

#define kUWB_StsConfig_DynamicSts_Ctrlee_key UWB_STS_CONFIG_DYNAMIC_STS_RESPONDER_KEY
#define kUWB_StsConfig_ProvisionSts UWB_STS_CONFIG_PROVISIONED_STS
#define kUWB_StsConfig_ProvisionSts_Ctrlee_key UWB_STS_CONFIG_PROVISIONED_STS_RESPONDER_KEY
...
#define MAX_MESSAGE_SIZE_ID             UWB_CAPABILITY_PARAM_MAX_DATA_MESSAGE_SIZE
#define MAX_DATA_PACKET_PAYLOAD_SIZE_ID UWB_CAPABILITY_PARAM_MAX_DATA_PACKET_PAYLOAD_SIZE
#define FIRA_PHY_VERSION_RANGE_ID       UWB_CAPABILITY_PARAM_FIRA_PHY_VERSION_RANGE
#define FIRA_MAC_VERSION_RANGE_ID       UWB_CAPABILITY_PARAM_FIRA_MAC_VERSION_RANGE
#define DEVICE_TYPE_ID                  UWB_CAPABILITY_PARAM_DEVICE_TYPE
#define DEVICE_ROLES_ID                 UWB_CAPABILITY_PARAM_DEVICE_ROLES
#define RANGING_METHOD_ID               UWB_CAPABILITY_PARAM_RANGING_METHOD
#define STS_CONFIG_ID                   UWB_CAPABILITY_PARAM_STS_CONFIG
#define MULTI_NODE_MODE_ID              UWB_CAPABILITY_PARAM_MULTI_NODE_MODE
#define RANGING_TIME_STRUCT_ID          UWB_CAPABILITY_PARAM_RANGING_TIME_STRUCT
#define SCHEDULED_MODE_ID               UWB_CAPABILITY_PARAM_SCHEDULE_MODE
#define HOPPING_MODE_ID                 UWB_CAPABILITY_PARAM_HOPPING_MODE
#define BLOCK_STRIDING_ID               UWB_CAPABILITY_PARAM_BLOCK_STRIDING
#define UWB_INITIATION_TIME_ID          UWB_CAPABILITY_PARAM_UWB_INITIATION_TIME
#define CHANNELS_ID                     UWB_CAPABILITY_PARAM_CHANNELS
#define RFRAME_CONFIG_ID                UWB_CAPABILITY_PARAM_RFRAME_CONFIG
#define CC_CONSTRAINT_LENGTH_ID         UWB_CAPABILITY_PARAM_CC_CONSTRAINT_LENGTH
#define BPRF_PARAMETER_SETS_ID          UWB_CAPABILITY_PARAM_BPRF_PARAMETER_SETS
#define HPRF_PARAMETER_SETS_ID          UWB_CAPABILITY_PARAM_HPRF_PARAMETER_SETS
#define AOA_SUPPORT_ID                  UWB_CAPABILITY_PARAM_AOA_SUPPORT
#define EXTENDED_MAC_ADDR_ID            UWB_CAPABILITY_PARAM_EXTENDED_MAC_ADDRESS
/** FIXME: To be remove SUSPEND_RANGING_ID*/
#define SUSPEND_RANGING_ID              0x15
#define SESSION_KEY_LEN_ID              UWB_CAPABILITY_PARAM_SESSION_KEY_LENGTH
#define DT_ANCHOR_MAX_ACTIVE_RR_ID      UWB_CAPABILITY_PARAM_DT_ANCHOR_MAX_ACTIVE_RR
#define DT_TAG_MAX_ACTIVE_RR_ID         UWB_CAPABILITY_PARAM_DT_TAG_MAX_ACTIVE_RR
#define DT_TAG_BLOCK_SKIPPING_ID        UWB_CAPABILITY_PARAM_DT_TAG_BLOCK_SKIPPING
#define PSDU_LENGTH_SUPPORT_ID          UWB_CAPABILITY_PARAM_PSDU_LENGTH_SUPPORT
#define LL_CAPABILITY_PARAM             UWB_CAPABILITY_PARAM_LL_CAPABILITY_PARAM
#define BYPASS_MODE_SUPPORT             UWB_CAPABILITY_PARAM_BYPASS_MODE_SUPPORT
#define MIN_SLOT_DURATION_SUPPORT       UWB_CAPABILITY_PARAM_MIN_SLOT_DURATION_SUPPORT
#define FIRA_LL_VERSION                 UWB_CAPABILITY_PARAM_FIRA_LL_VERSION
...
typedef enum
{
    kUWB_DeviceRole_Responder      = UWB_DEVICE_ROLE_RESPONDER,
    kUWB_DeviceRole_Initiator      = UWB_DEVICE_ROLE_INITIATOR,
    kUWB_DeviceRole_UT_Sync_Anchor = UWB_DEVICE_ROLE_UT_SYNC_ANCHOR,
    kUWB_DeviceRole_UT_Anchor      = UWB_DEVICE_ROLE_UT_ANCHOR,
    kUWB_DeviceRole_UT_Tag         = UWB_DEVICE_ROLE_UT_TAG,
    kUWB_DeviceRole_Advertiser     = UWB_DEVICE_ROLE_ADVERTISER,
    kUWB_DeviceRole_Observer       = UWB_DEVICE_ROLE_OBSERVER,
    kUWB_DeviceRole_DlTDoA_Anchor  = UWB_DEVICE_ROLE_DL_TDOA_ANCHOR,
    kUWB_DeviceRole_DlTDoA_Tag     = UWB_DEVICE_ROLE_DL_TDOA_TAG,
} UWB_DeviceRole_t;
...
{
    kUWB_MultiNodeMode_UniCast    = UWB_MULTI_NODE_MODE_UNICAST,
    kUWB_MultiNodeMode_OnetoMany  = UWB_MULTI_NODE_MODE_ONETOMANY,
...
typedef enum UWB_RangingRoundUsage
{
    ...
    /** MMS SS-TWR with Implicit Timestamp */
    kUWB_RangingRoundUsage_MMS_SS_TWR_IMPLICIT_TIMESTAMP = 0xD0,
...
typedef enum UWB_ScheduledMode
{
    ...
    kUWB_ScheduledMode_ContentionBased = UWB_SCHEDULE_MODE_CONTENTION_BASED,
    /** Time based Ranging Scheduling */
    kUWB_ScheduledMode_TimeScheduled = UWB_SCHEDULE_MODE_TIME_SCHEDULED,
    /** Hybrid based Scheduling */
    kUWB_ScheduledMode_HybridBased = UWB_SCHEDULE_MODE_HYBRID_BASED,
} UWB_ScheduledMode_t;
