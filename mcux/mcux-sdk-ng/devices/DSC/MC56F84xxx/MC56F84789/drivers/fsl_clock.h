...
#if (defined(CPU_MC56F84789VLL) || defined(CPU_MC56F84786VLK) || defined(CPU_MC56F84769VLL) || \
     defined(CPU_MC56F84766VLK) || defined(CPU_MC56F84763VLH))
#define SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY (100000000UL)

#elif (defined(CPU_MC56F84587VLL) || defined(CPU_MC56F84567VLL) || defined(CPU_MC56F84565VLK) || \
       defined(CPU_MC56F84553VLH) || defined(CPU_MC56F84550VLF) || defined(CPU_MC56F84543VLH) || \
       defined(CPU_MC56F84540VLF))
#define SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY (80000000UL)

#elif (defined(CPU_MC56F84462VLH) || defined(CPU_MC56F84452VLH) || defined(CPU_MC56F84451VLF) || \
       defined(CPU_MC56F84442VLH) || defined(CPU_MC56F84441VLF))
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_DAC     = 29U, /*!< DAC clock */

    /* SIM_PCE2 */
    kCLOCK_PDB1   = 32U, /*!< PDB 1 clock */
    kCLOCK_PDB0   = 33U, /*!< PDB 0 clock */
    kCLOCK_PIT1   = 34U, /*!< PIT 1 clock */
    kCLOCK_PIT0   = 35U, /*!< PIT 0 clock */
    kCLOCK_QDC    = 36U, /*!< QDC clock */
    kCLOCK_CRC    = 37U, /*!< CRC clock */
    kCLOCK_CYCADC = 39U, /*!< Cyclic ADC clock */
    kCLOCK_SARADC = 40U, /*!< SAR ADC clock */
...
typedef enum _clock_name
{
    ...
    /*---------------------------------- OSC clock -----------------------------------*/
    kCLOCK_FastIrcClk    = 10, /*!< Fast internal RC oscillator, 8M/400K */
    kCLOCK_SlowIrcClk    = 11, /*!< Slow internal RC oscillator, 32K */
...
{
    kCLOCK_MstrOscClkSrcFirc = 0U, /*!< 8M/400K, fast internal RC oscillator */
    kCLOCK_MstrOscClkSrcExt  = 1U, /*!< External clock */
    kCLOCK_MstrOscClkSrcSirc = 2U  /*!< 32K, slow internal RC oscillator */
...
typedef enum _clock_output_clk_src
{
    ...
    kCLOCK_OutputClkSrc_Firc    = 4U, /*!< 8M/400K clock */
    kCLOCK_OutputClkSrc_Sirc    = 5U  /*!< 32K clock, SIRC*/
...
typedef enum _clock_firc_sel
{
    ...
    kCLOCK_FircSel_400K = 1  /*!< FIRC standby mode, output 400K */
} clock_firc_sel_t;
...
typedef enum _pit_count_clock_source
{
    ...
    kPIT_Count8MHzIRCClock  = kPIT_CountClockSource2, /*!< PIT count clock sourced from 8M/400KHz IRC clock */
    kPIT_Count32KHzIRCClock = kPIT_CountClockSource3, /*!< PIT count clock sourced from 32KHz IRC clock */
...
typedef enum _ewm_lpo_clock_source
{
    ...
    /* This part is used for users. */
    kEWM_Lpo8MHzIRCClock  = kEWM_LpoClockSource0, /*!< EWM clock sourced from 8M/400K Hz IRC clock */
    ...
    kEWM_Lpo32KHzIRCClock = kEWM_LpoClockSource3, /*!< EWM clock sourced from 32KHz IRC clock */
...
#define QSPI_CLOCKS                              \
    {                                            \
        kCLOCK_QSPI0, kCLOCK_QSPI1, kCLOCK_QSPI2 \
    }
...
/*! @brief Clock ip name array for SAR ADC. */
#define SARADC_CLOCKS \
    {                 \
        kCLOCK_SARADC \
    }
...
/*! @brief Clock ip name array for COP. */
#define COP_CLOCKS \
    {              \
        kCLOCK_COP \
    }
 ...
 *         true: Crystal oscillator failure.
