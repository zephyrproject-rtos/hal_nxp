...
/* ###################################################################
**     Filename    : Cpu.h
**     Processor   : MC56F84xxx
**     Component   : MC56F84xxx
**     Version     : 0.1
**     Datasheet   : MC56F84xxx Reference Manual
...
/* Explicit indicator for data stored in FlexNVM and accessed from p(flash) space.
 * Note:
 *   To use this section, when code are compiled in LDM mode, please uncheck below setting:
 *     Project Properties -> C/C++ Build -> Settings -> Tool Settings ->
 *     DSC Compiler -> Processor -> Globals Live Lower Memory
 */
#pragma define_section FLEXNVM_DATA "flexnvm.data" RWX

/* Explicit indicator for XIP Code stored in FlexNVM */
#pragma define_section FLEXNVM_CODE "flexnvm.text" RX

/* Explicit indicator for data stored in FlexRAM space and not initiated at startup.
 * Note:
 *   To use this section, when code are compiled in LDM mode, please uncheck below setting:
 *     Project Properties -> C/C++ Build -> Settings -> Tool Settings ->
 *     DSC Compiler -> Processor -> Globals Live Lower Memory
 */
#pragma define_section FLEXRAM_DATA "flexram.data" RW
#endif
 ...
 * Note:
 *   To use this section, since MC56F84xxx flash mapping address in x space is > 64K,
 ...
 *
 * #pragma section FLEXNVM_DATA begin
 * DATA_IN_FLASH uint8_t mapTable[1024] = {x, x, ...};
 * #pragma section FLEXNVM_DATA end
 *
 ...
 *
 * #pragma section FLEXRAM_DATA begin
 * uint8_t none_initiated_buf[1024];
 * #pragma section FLEXRAM_DATA end
 *
