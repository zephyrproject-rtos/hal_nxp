...
/* ###################################################################
**     Filename    : Cpu.h
**     Processor   : MC56F80xxx
**     Component   : MC56F80xxx
**     Version     : 0.1
**     Datasheet   : MC56F80xxx Reference Manual
**     Compiler    : CodeWarrior DSP C Compiler
**     Date/Time   : 2022-02-10, 14:39
*/
 ...
 * Note:
 *   1. MC56F80xxx flash mapping address in x space is 0x4000-0xBFFF(word address).
 *   2. When data allocation only range in x space address 0x4000-0x7FFF.
 *        2.1 SDM and LDM are both supported
 *        2.2 Remove the #if guard for DATA_IN_XFLASH when SDM
 *   3. When data allocation range in x space address 0x8000-0xBFFF(word address)
 *        3.1 SDM is supported only when __has_feature(FE_POINTER_MODIFIERS))
 *        3.2 When code are compiled in LDM mode, please uncheck below setting in
