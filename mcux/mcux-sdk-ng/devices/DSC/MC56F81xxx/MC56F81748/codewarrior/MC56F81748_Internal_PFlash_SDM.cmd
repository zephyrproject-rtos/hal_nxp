...
MEMORY {
  ...
  .p_RamCode     (RX): ORIGIN = 0x60000, LENGTH = 0x1800           # RAM mapped into p space, code resides in flash and runs in RAM

  .p_RamData     (RX): ORIGIN = AFTER(.p_RamCode) - 0x60000, LENGTH = 0x1800 + 0x60000 - AFTER(.p_RamCode)  # .data section
  .x_Data        (RW): ORIGIN = AFTER(.p_RamCode) - 0x60000, LENGTH = 0x1800 + 0x60000 - AFTER(.p_RamCode)  # bss, heap, stack ...
