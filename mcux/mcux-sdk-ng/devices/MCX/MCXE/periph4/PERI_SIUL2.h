...
#define SIUL2_GPDO_COUNT                          156u
#define SIUL2_GPDI_COUNT                          156u
...
typedef struct {
  ...
  __IO uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration Register, array offset: 0x240, array step: 0x4, valid indices: [0-21, 24-37, 40-62, 64-85, 87-114, 116-120, 122-147, 149-154] */
       uint8_t RESERVED_11[1428];
  __IO uint32_t IMCR[SIUL2_IMCR_COUNT];            /**< SIUL2 Input Multiplexed Signal Configuration Register, array offset: 0xA40, array step: 0x4, valid indices: [0-5, 16-71, 80-103, 148-149, 152-194, 211-254, 343-372, 379-385, 399-408] */
       uint8_t RESERVED_12[604];
  __IO uint8_t GPDO[SIUL2_GPDO_COUNT];             /**< SIUL2 GPIO Pad Data Output Register, array offset: 0x1300, array step: 0x1, valid indices: [0-19, 22-35, 38-59, 61-84, 86-111, 113-121, 123-150, 153-155] */
       uint8_t RESERVED_13[356];
  __I  uint8_t GPDI[SIUL2_GPDI_COUNT];             /**< SIUL2 GPIO Pad Data Input Register, array offset: 0x1500, array step: 0x1, valid indices: [0-19, 22-35, 38-59, 61-84, 86-111, 113-121, 123-150, 153-155] */
       uint8_t RESERVED_14[356];
