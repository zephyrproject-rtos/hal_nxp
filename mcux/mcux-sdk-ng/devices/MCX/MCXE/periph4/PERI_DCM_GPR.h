...
typedef struct {
  ...
  __I  uint32_t DCMROF1;                           /**< Read Only GPR On Functional Reset Register, offset: 0x300 */
  ...
  __I  uint32_t DCMRWD8;                           /**< Read Write GPR On Destructive Reset Register, offset: 0x51C */
...
/*! I3C_DBG_DIS_CM7_0
 *  0b0..I3C enters debug mode when CM7_0 enters debug mode.
 *  0b1..I3C remains functional and is not impacted when CM7_0 enters debug mode.
 */
