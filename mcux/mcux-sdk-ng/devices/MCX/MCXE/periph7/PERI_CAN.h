...
typedef struct {
  ...
  __IO uint32_t IMASK2;                            /**< Interrupt Masks 2 Register, offset: 0x24, available only on: CAN_0/FLEXCAN_0, CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2 (missing on CAN_3/FLEXCAN_3) */
  __IO uint32_t IMASK1;                            /**< Interrupt Masks 1 Register, offset: 0x28 */
  __IO uint32_t IFLAG2;                            /**< Interrupt Flags 2 Register, offset: 0x2C, available only on: CAN_0/FLEXCAN_0, CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2 (missing on CAN_3/FLEXCAN_3) */
  ...
  union {                                          /* offset: 0x80 */
    struct {                                         /* offset: 0x80, array step: 0x10 */
      __IO uint32_t CS;                                /**< Message Buffer 0 CS Register..Message Buffer 63 CS Register, array offset: 0x80, array step: 0x10, irregular array, not all indices are valid */
      __IO uint32_t ID;                                /**< Message Buffer 0 ID Register..Message Buffer 63 ID Register, array offset: 0x84, array step: 0x10, irregular array, not all indices are valid */
      __IO uint32_t WORD[CAN_MB_SIZE_MB_8B_GROUP_MB_8B_WORD_8B_COUNT];     /**< Message Buffer 0 WORD_8B Register..Message Buffer 63 WORD_8B Register, array offset: 0x88, array step: index*0x10, index2*0x4, irregular array, not all indices are valid */
    ...
    struct {                                         /* offset: 0x80, array step: 0x10 */
      __IO uint32_t CS;                                /**< Message Buffer 0 CS Register..Message Buffer 63 CS Register, array offset: 0x80, array step: 0x10, irregular array, not all indices are valid */
      __IO uint32_t ID;                                /**< Message Buffer 0 ID Register..Message Buffer 63 ID Register, array offset: 0x84, array step: 0x10, irregular array, not all indices are valid */
      __IO uint32_t WORD0;                             /**< Message Buffer 0 WORD0 Register..Message Buffer 63 WORD0 Register, array offset: 0x88, array step: 0x10, irregular array, not all indices are valid */
      __IO uint32_t WORD1;                             /**< Message Buffer 0 WORD1 Register..Message Buffer 63 WORD1 Register, array offset: 0x8C, array step: 0x10, irregular array, not all indices are valid */
    } MB[CAN_MB_SIZE_MB_GROUP_MB_COUNT];
  };
       uint8_t RESERVED_3[520];
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced Rx FIFO Control Register, offset: 0xC0C, available only on: CAN_0/FLEXCAN_0 (missing on CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2, CAN_3/FLEXCAN_3) */
  __IO uint32_t ERFIER;                            /**< Enhanced Rx FIFO Interrupt Enable Register, offset: 0xC10, available only on: CAN_0/FLEXCAN_0 (missing on CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2, CAN_3/FLEXCAN_3) */
  __IO uint32_t ERFSR;                             /**< Enhanced Rx FIFO Status Register, offset: 0xC14, available only on: CAN_0/FLEXCAN_0 (missing on CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2, CAN_3/FLEXCAN_3) */
  ...
  __IO uint32_t ERFFEL[CAN_ERFFEL_COUNT];          /**< Enhanced Rx FIFO Filter Element, array offset: 0x3000, array step: 0x4, available only on: CAN_0/FLEXCAN_0 (missing on CAN_1/FLEXCAN_1, CAN_2/FLEXCAN_2, CAN_3/FLEXCAN_3) */
} CAN_Type;
