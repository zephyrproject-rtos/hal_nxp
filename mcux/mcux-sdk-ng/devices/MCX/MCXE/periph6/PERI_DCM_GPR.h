...
typedef struct {
  ...
  __I  uint32_t DCMRWD7;                           /**< Read Write GPR On Destructive Reset Register, offset: 0x518 */
  __IO uint32_t DCMRWD8;                           /**< Read Write GPR On Destructive Reset Register, offset: 0x51C */
  __I  uint32_t DCMRWD9;                           /**< Read Write GPR On Destructive Reset Register, offset: 0x520 */
...
/*! CM7_1_LOCKUP - CM7_1 Core Lockup Status. Read this bit to identify the reason of fault in case of FCCU NCF 0.
...
/*! PF2_CODE_ECC_ERR - Flash2 Code ECC Uncorrectable Error
 *  0b0..No uncorrectable error reported in flash controller port 2 code memory by FMU.
 *  0b1..Uncorrectable error reported in flash controller port 2 code memory by FMU.
 */
...
/*! PF2_DATA_ECC_ERR - Flash2 Data ECC Uncorrectable Error
 *  0b0..No uncorrectable error reported in flash controller port 2 data memory by FMU.
 *  0b1..Uncorrectable error reported in flash controller port 2 data memory by FMU.
 */
...
/*! CM7_1_AHBP_RDATA_EDC_ERR
 *  0b0..No integrity error reported on CM7_1 peripheral read data.
 *  0b1..Integrity error reported on CM7_1 peripheral read data.
 */
...
/*! CM7_1_AHBM_RDATA_EDC_ERR
 *  0b0..No integrity error reported on CM7_1 main read data.
 *  0b1..Integrity error reported on CM7_1 main read data.
 */
...
/*! EDMA_DBG_DIS_CM7_1
 *  0b0..EDMA enters debug mode when CM7_1 enters debug mode.
 *  0b1..EDMA remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! FCCU_DBG_DIS_CM7_1
 *  0b0..FCCU enters debug mode when CM7_1 enters debug mode.
 *  0b1..FCCU remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! LCU0_DBG_DIS_CM7_1
 *  0b0..LCU0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LCU0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! LCU1_DBG_DIS_CM7_1
 *  0b0..LCU1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LCU1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..EMIOS0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..EMIOS0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..EMIOS1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..EMIOS1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..EMIOS2 enters debug mode when CM7_1 enters debug mode.
 *  0b1..EMIOS2 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! RTC_DBG_DIS_CM7_1
 *  0b0..RTC enters debug mode when CM7_1 enters debug mode.
 *  0b1..RTC remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! SWT0_DBG_DIS_CM7_1
 *  0b0..SWT0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..SWT0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! SWT1_DBG_DIS_CM7_1
 *  0b0..SWT1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..SWT1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! STM0_DBG_DIS_CM7_1
 *  0b0..STM0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..STM0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! STM1_DBG_DIS_CM7_1
 *  0b0..STM1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..STM1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! PIT0_DBG_DIS_CM7_1
 *  0b0..PIT0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..PIT0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! PIT1_DBG_DIS_CM7_1
 *  0b0..PIT1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..PIT1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! PIT2_DBG_DIS_CM7_1
 *  0b0..PIT2 enters debug mode when CM7_1 enters debug mode.
 *  0b1..PIT2 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI2 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI2 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI3 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI3 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI4 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI4 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPSPI5 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPSPI5 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPI2C0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPI2C0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..LPI2C1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..LPI2C1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXIO enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXIO remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN2 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN2 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN3 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN3 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN4 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN4 remains functional and is not impacted when CM7_1 enters debug mode.
 */
 ...
 *  0b0..FLEXCAN5 enters debug mode when CM7_1 enters debug mode.
 *  0b1..FLEXCAN5 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! SAI0_DBG_DIS_CM7_1
 *  0b0..SAI0 enters debug mode when CM7_1 enters debug mode.
 *  0b1..SAI0 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! SAI1_DBG_DIS_CM7_1
 *  0b0..SAI1 enters debug mode when CM7_1 enters debug mode.
 *  0b1..SAI1 remains functional and is not impacted when CM7_1 enters debug mode.
 */
...
/*! CM7_1_CPUWAIT
 *  0b0..CPUWAIT for CM7_1 disabled.
 *  0b1..CM7_1 put into wait mode using CPUWAIT.
 */
