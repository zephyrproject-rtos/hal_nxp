...
/*! SWT1_RST - Flag for 'Functional' Reset SWT1_RST
 *  0b0..'Functional' reset event SWT1_RST has not occurred since either the last clear or the last power-on reset assertion.
 *  0b1..'Functional' reset event SWT1_RST has occurred.
 */
...
/*! D_SWT1_RST - SWT1_RST Disable Control
 *  0b0..Functional reset event SWT1_RST triggers a reset sequence.
 *  0b1..Functional reset event SWT1_RST generates an interrupt request.
 */
...
/*! BE_SWT1_RST - Bidirectional Reset Enables for 'Functional' Reset SWT1_RST
 *  0b0..External reset pin is asserted on a 'Functional' reset SWT1_RST event if the reset is enabled.
 *  0b1..External reset pin is not asserted on a 'functional' reset SWT1_RST event.
 */
