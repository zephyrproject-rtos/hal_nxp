...
typedef struct {
  ...
  __IO uint32_t FDCTRL;                            /**< CAN FD Control Register, offset: 0xC00, available only on: FlexCAN0/CAN0, FlexCAN1/CAN1 (missing on FlexCAN2/CAN2) */
  __IO uint32_t FDCBT;                             /**< CAN FD Bit Timing Register, offset: 0xC04, available only on: FlexCAN0/CAN0, FlexCAN1/CAN1 (missing on FlexCAN2/CAN2) */
  __I  uint32_t FDCRC;                             /**< CAN FD CRC Register, offset: 0xC08, available only on: FlexCAN0/CAN0, FlexCAN1/CAN1 (missing on FlexCAN2/CAN2) */
} CAN_Type;
