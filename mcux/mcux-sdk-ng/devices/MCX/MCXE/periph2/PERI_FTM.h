...
typedef struct {
  ...
  __IO uint32_t QDCTRL;                            /**< Quadrature Decoder Control And Status, offset: 0x80, available only on: FTM1, FTM2, FTM4 (missing on FTM0, FTM3, FTM5) */
  ...
  __IO uint32_t MOD_MIRROR;                        /**< Mirror of Modulo Value, offset: 0x200, available only on: FTM1, FTM2 (missing on FTM0, FTM3, FTM4, FTM5) */
  __IO uint32_t CV_MIRROR[FTM_CV_MIRROR_COUNT];    /**< Mirror of Channel (n) Match Value, array offset: 0x204, array step: 0x4, available only on: FTM1, FTM2 (missing on FTM0, FTM3, FTM4, FTM5) */
} FTM_Type;
