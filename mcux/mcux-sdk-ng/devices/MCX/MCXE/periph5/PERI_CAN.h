...
typedef struct {
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced RX FIFO Control, offset: 0xC0C, available only on: FLEXCAN_0 (missing on FLEXCAN_1, FLEXCAN_2) */
  __IO uint32_t ERFIER;                            /**< Enhanced RX FIFO Interrupt Enable, offset: 0xC10, available only on: FLEXCAN_0 (missing on FLEXCAN_1, FLEXCAN_2) */
  __IO uint32_t ERFSR;                             /**< Enhanced RX FIFO Status, offset: 0xC14, available only on: FLEXCAN_0 (missing on FLEXCAN_1, FLEXCAN_2) */
  ...
  __IO uint32_t ERFFEL[CAN_ERFFEL_COUNT];          /**< Enhanced RX FIFO Filter Element, array offset: 0x3000, array step: 0x4, available only on: FLEXCAN_0 (missing on FLEXCAN_1, FLEXCAN_2) */
} CAN_Type;
 ...
 *  0b1..FlexCAN is in Disable mode or Freeze mode.
 */
