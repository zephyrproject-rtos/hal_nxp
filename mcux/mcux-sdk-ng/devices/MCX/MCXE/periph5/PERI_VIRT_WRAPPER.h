...
#define VIRT_WRAPPER_REG_A_COUNT                  10u
#define VIRT_WRAPPER_REG_B_COUNT                  25u
...
typedef struct {
  ...
  __IO uint32_t REG_B[VIRT_WRAPPER_REG_B_COUNT];   /**< Parameter_n Register, array offset: 0x80, array step: 0x4, valid indices: [0-6, 9-11, 13-15, 21-24] */
