...
#if !defined(MCXN527T_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXN527T_cm33_core1_H_
...
#endif  /* #if !defined(MCXN527T_cm33_core1_H_) */
