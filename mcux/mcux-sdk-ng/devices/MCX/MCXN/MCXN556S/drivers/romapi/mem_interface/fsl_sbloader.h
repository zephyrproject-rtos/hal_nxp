...
/*! @brief Determines the version of SB loader implementation (1: sb1.0; 2: sb2.0; 3.1: sb3.1, ; 4: sb4.0) */
#define SB_FILE_MAJOR_VERSION (4)
#define SB_FILE_MINOR_VERSION (0)
...
#elif SB_FILE_MAJOR_VERSION == 4
#define SBLOADER_CMD_SET_IN_ISP_MODE (SBLOADER_V4_CMD_SET_IN_ISP_MODE)
#define SBLOADER_CMD_SET_IN_REC_MODE (SBLOADER_V4_CMD_SET_IN_REC_MODE)
#endif
