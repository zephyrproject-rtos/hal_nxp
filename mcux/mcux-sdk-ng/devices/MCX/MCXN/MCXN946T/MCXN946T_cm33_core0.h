...
#if !defined(MCXN946T_cm33_core0_H_)  /* Check if memory map has not been already included */
#define MCXN946T_cm33_core0_H_
...
#endif  /* #if !defined(MCXN946T_cm33_core0_H_) */
