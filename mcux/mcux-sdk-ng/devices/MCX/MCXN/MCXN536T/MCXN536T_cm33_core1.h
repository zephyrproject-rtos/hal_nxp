...
#if !defined(MCXN536T_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXN536T_cm33_core1_H_
...
#endif  /* #if !defined(MCXN536T_cm33_core1_H_) */
