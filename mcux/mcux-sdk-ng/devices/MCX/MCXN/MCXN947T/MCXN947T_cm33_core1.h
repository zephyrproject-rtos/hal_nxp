...
#if !defined(MCXN947T_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXN947T_cm33_core1_H_
...
#endif  /* #if !defined(MCXN947T_cm33_core1_H_) */
