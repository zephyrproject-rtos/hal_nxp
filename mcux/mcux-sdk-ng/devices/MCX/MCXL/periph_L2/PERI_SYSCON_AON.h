...
typedef struct {
  ...
  __IO uint32_t SYNC_EN_INPUTMUX;                  /**< Synchronization Enable AON_INPUTMUX, offset: 0x28 */
  ...
  __IO uint32_t TAMP_GD_EN;                        /**< Tamper and Glitch Detect Enable, offset: 0x40 */
} SYSCON_AON_Type;
 ...
 *  0b0..Selects input from AON.ACMP
 ...
 *  0b0..Choose Input from AON.ACMP
...
/*! @name SYNC_EN_INPUTMUX - Synchronization Enable AON_INPUTMUX */
/*! @{ */

#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR1_AON_TMR3_PIN_SYNC_EN_MASK (0x1U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR1_AON_TMR3_PIN_SYNC_EN_SHIFT (0U)
 ...
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR1_AON_TMR3_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QTMR1_AON_TMR3_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QTMR1_AON_TMR3_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR2_PIN_SYNC_EN_MASK (0x2U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR2_PIN_SYNC_EN_SHIFT (1U)
/*! QMTR1_AON_TMR2_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR1 timer 2 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR2_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR2_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR2_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR1_PIN_SYNC_EN_MASK (0x4U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR1_PIN_SYNC_EN_SHIFT (2U)
/*! QMTR1_AON_TMR1_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR1 timer 1 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR1_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR1_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR1_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR0_PIN_SYNC_EN_MASK (0x8U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR0_PIN_SYNC_EN_SHIFT (3U)
/*! QMTR1_AON_TMR0_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR1 timer 0 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR0_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR0_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QMTR1_AON_TMR0_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR3_PIN_SYNC_EN_MASK (0x10U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR3_PIN_SYNC_EN_SHIFT (4U)
/*! QTMR0_AON_TMR3_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR0 timer 3 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR3_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR3_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR3_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR0_AON_TMR2_PIN_SYNC_EN_MASK (0x20U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR0_AON_TMR2_PIN_SYNC_EN_SHIFT (5U)
/*! QMTR0_AON_TMR2_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR0 timer 2 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QMTR0_AON_TMR2_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QMTR0_AON_TMR2_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QMTR0_AON_TMR2_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR_AON_TMR1_PIN_SYNC_EN_MASK (0x40U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR_AON_TMR1_PIN_SYNC_EN_SHIFT (6U)
/*! QTMR_AON_TMR1_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR0 timer 1 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR_AON_TMR1_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QTMR_AON_TMR1_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QTMR_AON_TMR1_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR0_PIN_SYNC_EN_MASK (0x80U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR0_PIN_SYNC_EN_SHIFT (7U)
/*! QTMR0_AON_TMR0_PIN_SYNC_EN - Enable or bypass synchronization for AON.QTMR0 timer 0 pin.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR0_PIN_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR0_PIN_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_QTMR0_AON_TMR0_PIN_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPUART0_AON_TRIG_SYNC_EN_MASK (0x100U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPUART0_AON_TRIG_SYNC_EN_SHIFT (8U)
/*! LPUART0_AON_TRIG_SYNC_EN - Enable or bypass synchronization for AON.LPUART0 trigger.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPUART0_AON_TRIG_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPUART0_AON_TRIG_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPUART0_AON_TRIG_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN_MASK (0x200U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN_SHIFT (9U)
/*! LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN - Enable or bypass synchronization for AON.LPTMR0 DMA done trigger.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPTMR0_AON_DMA_DONE_TRIG_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG3_SYNC_EN_MASK (0x400U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG3_SYNC_EN_SHIFT (10U)
/*! LPACMP_TRIG3_SYNC_EN - Enable or bypass synchronization for AON.LPACMP0 trigger 3.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG3_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG3_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG3_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG2_SYNC_EN_MASK (0x800U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG2_SYNC_EN_SHIFT (11U)
/*! LPACMP_TRIG2_SYNC_EN - Enable or bypass synchronization for AON.LPACMP0 trigger 2.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG2_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG2_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG2_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG1_SYNC_EN_MASK (0x1000U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG1_SYNC_EN_SHIFT (12U)
/*! LPACMP_TRIG1_SYNC_EN - Enable or bypass synchronization for AON.LPACMP0 trigger 1.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG1_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG1_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG1_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG0_SYNC_EN_MASK (0x2000U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG0_SYNC_EN_SHIFT (13U)
/*! LPACMP_TRIG0_SYNC_EN
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG0_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG0_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LPACMP_TRIG0_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_LC_SENSE_SYNC_EN_MASK (0x4000U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_LC_SENSE_SYNC_EN_SHIFT (14U)
/*! LC_SENSE_SYNC_EN - Enable or bypass synchronization for LC Sense glue logic.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_LC_SENSE_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_LC_SENSE_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_LC_SENSE_SYNC_EN_MASK)

#define SYSCON_AON_SYNC_EN_INPUTMUX_ACMP0_AON_SAMPLE_SYNC_EN_MASK (0x8000U)
#define SYSCON_AON_SYNC_EN_INPUTMUX_ACMP0_AON_SAMPLE_SYNC_EN_SHIFT (15U)
/*! ACMP0_AON_SAMPLE_SYNC_EN - Enable or bypass synchronization for AON.ACMP0.
 *  0b0..Synchronization is bypassed
 *  0b1..Synchronization is enabled
 */
#define SYSCON_AON_SYNC_EN_INPUTMUX_ACMP0_AON_SAMPLE_SYNC_EN(x) (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_SYNC_EN_INPUTMUX_ACMP0_AON_SAMPLE_SYNC_EN_SHIFT)) & SYSCON_AON_SYNC_EN_INPUTMUX_ACMP0_AON_SAMPLE_SYNC_EN_MASK)
/*! @} */
...
/*! XTAL_32K_CLK_CTRL - This signal acts as a clock enable/disable signal for XTAL32K[0] clock
...
/*! @name TAMP_GD_EN - Tamper and Glitch Detect Enable */
/*! @{ */

#define SYSCON_AON_TAMP_GD_EN_TGD_EN_MASK        (0x1U)
#define SYSCON_AON_TAMP_GD_EN_TGD_EN_SHIFT       (0U)
/*! TGD_EN - Tamper and Glitch Detect Enable
 *  0b0..Disables the actions of the tamper, LVD/HVD, and glitch detectors
 *  0b1..Enables the actions of the tamper, LVD/HVD, and glitch detectors
 */
#define SYSCON_AON_TAMP_GD_EN_TGD_EN(x)          (((uint32_t)(((uint32_t)(x)) << SYSCON_AON_TAMP_GD_EN_TGD_EN_SHIFT)) & SYSCON_AON_TAMP_GD_EN_TGD_EN_MASK)
/*! @} */
