...
typedef struct {
  ...
  __O  uint32_t MTCBR[LPI2C_MTCBR_COUNT];          /**< Controller Transmit Command Burst, array offset: 0x200, array step: 0x4, available only on: AON.LPI2C0/AON__LPI2C0 (missing on LPI2C0) */
  __O  uint32_t MTDBR[LPI2C_MTDBR_COUNT];          /**< Transmit Data Burst, array offset: 0x400, array step: 0x4, available only on: AON.LPI2C0/AON__LPI2C0 (missing on LPI2C0) */
} LPI2C_Type;
