...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MCXL143_cm33
**
...
/*!
 * @file MCXL143_cm33_COMMON.h
 * @version 1.1
 * @date 2026-01-02
 * @brief CMSIS Peripheral Access Layer for MCXL143_cm33
 *
 * CMSIS Peripheral Access Layer for MCXL143_cm33
 */

#if !defined(MCXL143_CM33_COMMON_H_)
#define MCXL143_CM33_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#define NUMBER_OF_INT_VECTORS 175                /**< Number of interrupts in the Vector table */
...
typedef enum IRQn {
  ...
  RTC_XTAL_IRQn                = 143,              /**< RTC XTAL Fail */
...
#include "system_MCXL143_cm33.h"       /* Device specific configuration file */
...
#ifndef MCXL143_cm33_SERIES
#define MCXL143_cm33_SERIES
#endif
/* CPU specific feature definitions */
#include "MCXL143_cm33_features.h"
...
/* LPCMP - Peripheral instance base addresses */
  ...
  #define LPCMP_BASE_ADDRS                         { ACMP0_BASE }
  /** Array initializer of LPCMP peripheral base pointers */
  #define LPCMP_BASE_PTRS                          { ACMP0 }
  /** Array initializer of LPCMP peripheral base addresses */
  #define LPCMP_BASE_ADDRS_NS                      { ACMP0_BASE_NS }
  /** Array initializer of LPCMP peripheral base pointers */
  #define LPCMP_BASE_PTRS_NS                       { ACMP0_NS }
#else
  /** Peripheral ACMP0 base address */
...
/* LPI2C - Peripheral instance base addresses */
  ...
  #define LPI2C_BASE_ADDRS                         { LPI2C0_BASE, 0u, AON__LPI2C0_BASE }
  /** Array initializer of LPI2C peripheral base pointers */
  #define LPI2C_BASE_PTRS                          { LPI2C0, (LPI2C_Type *)0u, AON__LPI2C0 }
  /** Array initializer of LPI2C peripheral base addresses */
  #define LPI2C_BASE_ADDRS_NS                      { LPI2C0_BASE_NS, 0u, AON__LPI2C0_BASE_NS }
  /** Array initializer of LPI2C peripheral base pointers */
  #define LPI2C_BASE_PTRS_NS                       { LPI2C0_NS, (LPI2C_Type *)0u, AON__LPI2C0_NS }
#else
  /** Peripheral LPI2C0 base address */
...
#define LPI2C_IRQS                               { LPI2C0_IRQn, NotAvail_IRQn, LPI2C0_AON_IRQn }
