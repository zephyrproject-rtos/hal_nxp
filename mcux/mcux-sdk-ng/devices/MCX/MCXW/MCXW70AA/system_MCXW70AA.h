 ...
 * @version 1.0
 * @date 2026-01-09
 * @brief Device specific configuration file for MCXW70AA (header file)
 *
...
#ifndef _SYSTEM_MCXW70AA_H_
#define _SYSTEM_MCXW70AA_H_                      /**< Symbol preventing repeated inclusion */
