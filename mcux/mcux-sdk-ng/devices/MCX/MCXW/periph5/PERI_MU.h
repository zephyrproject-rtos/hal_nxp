...
typedef struct {
  ...
  __IO uint32_t CCR0;                              /**< Core Control 0, offset: 0x10, available only on: MU_1.MUA/MU_1__MUA (missing on MU_0.MUA/MU_0__MUA, MU_0.MUB/MU_0__MUB, MU_1.MUB/MU_1__MUB) */
  __IO uint32_t CIER0;                             /**< Core Interrupt Enable 0, offset: 0x14, available only on: MU_0.MUA/MU_0__MUA, MU_0.MUB/MU_0__MUB (missing on MU_1.MUA/MU_1__MUA, MU_1.MUB/MU_1__MUB) */
  __IO uint32_t CSSR0;                             /**< Core Sticky Status 0, offset: 0x18, available only on: MU_0.MUA/MU_0__MUA, MU_0.MUB/MU_0__MUB, MU_1.MUB/MU_1__MUB (missing on MU_1.MUA/MU_1__MUA) */
  __I  uint32_t CSR0;                              /**< Core Status 0, offset: 0x1C, available only on: MU_0.MUA/MU_0__MUA, MU_0.MUB/MU_0__MUB (missing on MU_1.MUA/MU_1__MUA, MU_1.MUB/MU_1__MUB) */
