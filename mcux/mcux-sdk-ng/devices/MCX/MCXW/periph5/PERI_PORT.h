...
typedef struct {
  ...
  __IO uint32_t CALIB0;                            /**< Calibration 0, offset: 0x60, available only on: PORT_B, PORT_C (missing on PORT_A, PORT_D) */
  __IO uint32_t CALIB1;                            /**< Calibration 1, offset: 0x64, available only on: PORT_B, PORT_C (missing on PORT_A, PORT_D) */
       uint8_t RESERVED_3[24];
  __IO uint32_t PCR[PORT_PCR_COUNT];               /**< Pin Control 0..Pin Control 21, array offset: 0x80, array step: 0x4, irregular array, not all indices are valid */
} PORT_Type;
...
/*! @name PCR - Pin Control 0..Pin Control 21 */
/*! @{ */
