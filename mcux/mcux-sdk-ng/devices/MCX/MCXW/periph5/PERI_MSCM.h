...
typedef struct {
  ...
  __I  uint32_t OCMDR7;                            /**< On-Chip Memory Descriptor Register, offset: 0x41C */
...
/*! @name OCMDR7 - On-Chip Memory Descriptor Register */
/*! @{ */

#define MSCM_OCMDR7_OCMPU_MASK                   (0x1000U)
#define MSCM_OCMDR7_OCMPU_SHIFT                  (12U)
/*! OCMPU - OCMPU */
#define MSCM_OCMDR7_OCMPU(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMPU_SHIFT)) & MSCM_OCMDR7_OCMPU_MASK)

#define MSCM_OCMDR7_OCMT_MASK                    (0xE000U)
#define MSCM_OCMDR7_OCMT_SHIFT                   (13U)
/*! OCMT - OCMT
 *  0b000..OCMEMn is a System RAM.
 *  0b001..Reserved
 *  0b010..Reserved
 ...
 *  0b111..Reserved
 */
#define MSCM_OCMDR7_OCMT(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMT_SHIFT)) & MSCM_OCMDR7_OCMT_MASK)

#define MSCM_OCMDR7_OCMW_MASK                    (0xE0000U)
#define MSCM_OCMDR7_OCMW_SHIFT                   (17U)
/*! OCMW - OCMW
 *  0b000-0b001..Reserved
 *  0b010..OCMEMn 32-bits wide
 *  0b011..OCMEMn 64-bits wide
 ...
 *  0b110-0b111..Reserved
 */
#define MSCM_OCMDR7_OCMW(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMW_SHIFT)) & MSCM_OCMDR7_OCMW_MASK)

#define MSCM_OCMDR7_OCMSZ_MASK                   (0xF000000U)
#define MSCM_OCMDR7_OCMSZ_SHIFT                  (24U)
/*! OCMSZ - OCMSZ
 *  0b0000..no OCMEMn
 *  0b0001..1KB OCMEMn
 *  0b0010..2KB OCMEMn
 ...
 *  0b1111..320KB OCMEMn
 */
#define MSCM_OCMDR7_OCMSZ(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMSZ_SHIFT)) & MSCM_OCMDR7_OCMSZ_MASK)

#define MSCM_OCMDR7_OCMSZH_MASK                  (0x10000000U)
#define MSCM_OCMDR7_OCMSZH_SHIFT                 (28U)
/*! OCMSZH - OCMSZH
 *  0b0..OCMEMn is a power-of-2 capacity.
 *  0b1..OCMEMn is not a power-of-2, with a capacity is 0.75 * OCMSZ.
 */
#define MSCM_OCMDR7_OCMSZH(x)                    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMSZH_SHIFT)) & MSCM_OCMDR7_OCMSZH_MASK)

#define MSCM_OCMDR7_OCMECC_MASK                  (0x20000000U)
#define MSCM_OCMDR7_OCMECC_SHIFT                 (29U)
/*! OCMECC - OCMECC
 *  0b0..OCMEMn does not have ECC support.
 *  0b1..OCMEMn has ECC support.
 */
#define MSCM_OCMDR7_OCMECC(x)                    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_OCMECC_SHIFT)) & MSCM_OCMDR7_OCMECC_MASK)

#define MSCM_OCMDR7_V_MASK                       (0x80000000U)
#define MSCM_OCMDR7_V_SHIFT                      (31U)
/*! V - V
 *  0b0..OCMEMn is not present.
 *  0b1..OCMEMn is present.
 */
#define MSCM_OCMDR7_V(x)                         (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR7_V_SHIFT)) & MSCM_OCMDR7_V_MASK)
/*! @} */
