...
/*!@brief MBC register offset in TRDC_Type structure. */
#define TRDC_MBC_OFFSET(x) 0x0000
/*!@brief Offset between two MBC control block, useless if there is only one. */
