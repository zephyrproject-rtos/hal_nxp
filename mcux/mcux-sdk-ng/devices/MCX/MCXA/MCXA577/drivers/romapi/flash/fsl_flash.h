...
/*!
 * @brief Verifies an erasure of the desired flash area at phrase level.
 *
...
/*!
 * @brief Verifies an erasure of the desired flash area at page level.
 *
 * This function checks the appropriate number of flash sectors based on
 * the desired start address and length to check whether the flash is erased
 * to the specified read margin level.
...
/*!
 * @brief Verifies an erasure of the desired flash area at sector level.
 *
 * This function checks the appropriate number of flash sectors based on
 * the desired start address and length to check whether the flash is erased
 * to the specified read margin level.
 ...
 * @param config A pointer to the storage for the driver runtime state.
 *
 * @return Flash driver version information.
 */
...
/*!
 * @brief Verifies an erasure of the desired IFR area at phrase level.
 *
 * This function checks the appropriate number of flash sectors based on
 ...
 * @param lengthInBytes The length, given in bytes, to be verified.
 *
 * @retval #kStatus_FLASH_Success API was executed successfully.
 * @retval #kStatus_FLASH_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FLASH_AlignmentError Parameter is not aligned with specified baseline.
...
/*!
 * @brief Verifies an erasure of the desired IFR area at page level.
 *
 * This function checks the appropriate number of flash sectors based on
 * the desired start address and length to check whether the IFR is erased
 * to the specified read margin level.
...
/*!
 * @brief Verifies an erasure of the desired IFR area at sector level.
 *
 * This function checks the appropriate number of flash sectors based on
 * the desired start address and length to check whether the IFR is erased
 * to the specified read margin level.
