...
#ifndef _MCXA557_FEATURES_H_
#define _MCXA557_FEATURES_H_
...
#define FSL_FEATURE_MCX_SPC_HAS_VD_IO_CFG_LVSEL (0)
/* @brief Has high-voltage detect on IO VDD. */
#define FSL_FEATURE_MCX_SPC_HAS_IOVDD_HVD (0)
