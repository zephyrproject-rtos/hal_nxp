...
typedef struct {
  ...
  __IO uint16_t PKT_BUFFER_TX[ZLL_PKT_BUFFER_TX_COUNT]; /**< Packet Buffer TX, array offset: 0x100, array step: 0x2 */
  __IO uint16_t PKT_BUFFER_RX[ZLL_PKT_BUFFER_RX_COUNT]; /**< Packet Buffer RX, array offset: 0x180, array step: 0x2 */
} ZLL_Type;
...
/*! ZIGBEE_SLEEP_EN - Zigbee sleep enable */
 ...
 *  0b1..Make PREAMBLE_DET and SFD_DET bits of PHY_STS (SEQ_STATE) Register "sticky", i.e.,occurrences of preamble
 *       and SFD detection are latched and held until the start of the next autosequence
 */
...
/*! PKT_BUFFER_TX - Packet Buffer Entry */
...
/*! PKT_BUFFER_RX - Packet Buffer Entry */
