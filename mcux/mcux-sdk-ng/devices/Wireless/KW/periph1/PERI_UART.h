...
typedef struct {
  ...
  union {                                          /* offset: 0x1B */
    __IO uint8_t WP7816T0;                           /**< UART 7816 Wait Parameter Register, offset: 0x1B, available only on: UART0 (missing on UART1, UART2) */
    __IO uint8_t WP7816T1;                           /**< UART 7816 Wait Parameter Register, offset: 0x1B, available only on: UART0 (missing on UART1, UART2) */
  };
 ...
 *  0b0..Break character is detected at one of the following lengths: 10 bit times if C1[M] = 0 11 bit times if
 *       C1[M] = 1 and C4[M10] = 0 12 bit times if C1[M] = 1, C4[M10] = 1, and S1[PE] = 1
