 ...
 *  0b0..The fault input polarity is active high. A one at the fault input indicates a fault.
 *  0b1..The fault input polarity is active low. A zero at the fault input indicates a fault.
 */
