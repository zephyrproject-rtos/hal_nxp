if(CONFIG_MCUX_COMPONENT_device.CMSIS)
    ...
    mcux_add_source(BASE_PATH ${SdkRootDirPath}/devices/${soc_portfolio}/${soc_series}/${device} SOURCES ${device}_hifi4.h CORE_IDS hifi4)
    mcux_add_source(BASE_PATH ${SdkRootDirPath}/devices/${soc_portfolio}/${soc_series}/${device} SOURCES ${device}_hifi4_features.h CORE_IDS hifi4)
    mcux_add_source(BASE_PATH ${SdkRootDirPath}/devices/${soc_portfolio}/${soc_series}/${device} SOURCES ${CONFIG_MCUX_HW_DEVICE_CORE}_COMMON.h CORE_IDS hifi4)
