...
typedef struct {
  ...
  __IO uint32_t DFER;                              /**< Digital Filter Enable Register, offset: 0xC0, not available in all instances (available on 8 out of 104) */
  __IO uint32_t DFCR;                              /**< Digital Filter Clock Register, offset: 0xC4, not available in all instances (available on 8 out of 104) */
  __IO uint32_t DFWR;                              /**< Digital Filter Width Register, offset: 0xC8, not available in all instances (available on 8 out of 104) */
} PORT_Type;
