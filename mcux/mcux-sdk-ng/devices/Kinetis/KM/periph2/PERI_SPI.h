...
typedef struct {
  ...
  __IO uint8_t CI;                                 /**< SPI clear interrupt register, offset: 0xA, available only on: SPI1, SPI2 (missing on SPI0) */
  __IO uint8_t C3;                                 /**< SPI control register 3, offset: 0xB, available only on: SPI1, SPI2 (missing on SPI0) */
} SPI_Type;
