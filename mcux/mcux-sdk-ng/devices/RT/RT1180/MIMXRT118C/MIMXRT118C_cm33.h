...
#if !defined(MIMXRT118C_cm33_H_)  /* Check if memory map has not been already included */
#define MIMXRT118C_cm33_H_
...
#endif  /* #if !defined(MIMXRT118C_cm33_H_) */
