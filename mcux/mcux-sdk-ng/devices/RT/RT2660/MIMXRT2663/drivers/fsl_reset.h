...
typedef uint32_t reset_ip_name_t; 
...
/*! @brief MODCON IP name array for EDMA. */
#define EDMA_RSTS                                                                                                                          \
    {                                                                                                                                      \
        (uint32_t)kModCon_AUDIO_EDMA, (uint32_t)kModCon_MAIN_EDMA1, (uint32_t)kModCon_WAKE_EDMA, (uint32_t)kModCon_MAIN_EDMA0              \
    }                                                                                                                                      \
...
/*! @brief MODCON IP name array for FLEXCAN. */
#define FLEXCAN_RSTS                                                                                                                       \
    {                                                                                                                                      \
...
/*! @brief MODCON IP name array for JPEGDEC. */
#define JPEGDEC_RSTS                                                                                                                       \
    {                                                                                                                                      \
