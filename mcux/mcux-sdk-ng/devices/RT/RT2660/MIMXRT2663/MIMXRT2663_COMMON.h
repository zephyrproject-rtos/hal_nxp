...
/*!
 * @file MIMXRT2663_COMMON.h
 * @version 1.0
 * @date 2024-11-05
 * @brief CMSIS Peripheral Access Layer for MIMXRT2663
 *
 * CMSIS Peripheral Access Layer for MIMXRT2663
 */

#if !defined(MIMXRT2663_COMMON_H_)
#define MIMXRT2663_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  MEDIA_CSI_IRQn               = 326,              /**< CSI:CSI Interrupt Request */
  ...
  MEDIA_MIPI_CSI_IRQn          = 331,              /**< MIPI_CSI: Interrupt Request */
  MEDIA_MIPI_DSI_IRQn          = 332,              /**< MIPI_DSI: Interrupt Request */
...
#include "system_MIMXRT2663.h"         /* Device specific configuration file */
...
#ifndef MIMXRT2663_SERIES
#define MIMXRT2663_SERIES
#endif
/* CPU specific feature definitions */
#include "MIMXRT2663_features.h"
...
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral MEDIA__CSI base address */
  #define MEDIA__CSI_BASE                          (0x5C090000u)
  /** Peripheral MEDIA__CSI base address */
  #define MEDIA__CSI_BASE_NS                       (0x4C090000u)
  /** Peripheral MEDIA__CSI base pointer */
  #define MEDIA__CSI                               ((CSI_Type *)MEDIA__CSI_BASE)
  /** Peripheral MEDIA__CSI base pointer */
  #define MEDIA__CSI_NS                            ((CSI_Type *)MEDIA__CSI_BASE_NS)
  /** Array initializer of CSI peripheral base addresses */
  #define CSI_BASE_ADDRS                           { MEDIA__CSI_BASE }
  /** Array initializer of CSI peripheral base pointers */
  #define CSI_BASE_PTRS                            { MEDIA__CSI }
  /** Array initializer of CSI peripheral base addresses */
  #define CSI_BASE_ADDRS_NS                        { MEDIA__CSI_BASE_NS }
  /** Array initializer of CSI peripheral base pointers */
  #define CSI_BASE_PTRS_NS                         { MEDIA__CSI_NS }
#else
  /** Peripheral MEDIA__CSI base address */
  #define MEDIA__CSI_BASE                          (0x4C090000u)
  /** Peripheral MEDIA__CSI base pointer */
  #define MEDIA__CSI                               ((CSI_Type *)MEDIA__CSI_BASE)
  /** Array initializer of CSI peripheral base addresses */
  #define CSI_BASE_ADDRS                           { MEDIA__CSI_BASE }
...
#define CSI_IRQS                                 { MEDIA_CSI_IRQn }
...
/* DSI2_HOST - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral DSI2_HOST base address */
  #define DSI2_HOST_BASE                           (0x5C0A0000u)
  /** Peripheral DSI2_HOST base address */
  #define DSI2_HOST_BASE_NS                        (0x4C0A0000u)
  /** Peripheral DSI2_HOST base pointer */
  #define DSI2_HOST                                ((DSI2_HOST_Type *)DSI2_HOST_BASE)
  /** Peripheral DSI2_HOST base pointer */
  #define DSI2_HOST_NS                             ((DSI2_HOST_Type *)DSI2_HOST_BASE_NS)
  /** Array initializer of DSI2_HOST peripheral base addresses */
  #define DSI2_HOST_BASE_ADDRS                     { DSI2_HOST_BASE }
  /** Array initializer of DSI2_HOST peripheral base pointers */
  #define DSI2_HOST_BASE_PTRS                      { DSI2_HOST }
  /** Array initializer of DSI2_HOST peripheral base addresses */
  #define DSI2_HOST_BASE_ADDRS_NS                  { DSI2_HOST_BASE_NS }
  /** Array initializer of DSI2_HOST peripheral base pointers */
  #define DSI2_HOST_BASE_PTRS_NS                   { DSI2_HOST_NS }
#else
  /** Peripheral DSI2_HOST base address */
  #define DSI2_HOST_BASE                           (0x4C0A0000u)
  /** Peripheral DSI2_HOST base pointer */
  #define DSI2_HOST                                ((DSI2_HOST_Type *)DSI2_HOST_BASE)
  /** Array initializer of DSI2_HOST peripheral base addresses */
  #define DSI2_HOST_BASE_ADDRS                     { DSI2_HOST_BASE }
  ...
  #define DSI2_HOST_BASE_PTRS                      { DSI2_HOST }
#endif
/** Interrupt vectors for the DSI2_HOST peripheral type */
#define DSI2_HOST_IRQS                           { MEDIA_MIPI_DSI_IRQn }

/* DSI2_HOST_APB_PKT_IF - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral DSI2_HOST_APB_PKT_IF base address */
  #define DSI2_HOST_APB_PKT_IF_BASE                (0x5C0A0180u)
  /** Peripheral DSI2_HOST_APB_PKT_IF base address */
  #define DSI2_HOST_APB_PKT_IF_BASE_NS             (0x4C0A0180u)
  /** Peripheral DSI2_HOST_APB_PKT_IF base pointer */
  #define DSI2_HOST_APB_PKT_IF                     ((DSI2_HOST_APB_PKT_IF_Type *)DSI2_HOST_APB_PKT_IF_BASE)
  /** Peripheral DSI2_HOST_APB_PKT_IF base pointer */
  #define DSI2_HOST_APB_PKT_IF_NS                  ((DSI2_HOST_APB_PKT_IF_Type *)DSI2_HOST_APB_PKT_IF_BASE_NS)
  /** Array initializer of DSI2_HOST_APB_PKT_IF peripheral base addresses */
  #define DSI2_HOST_APB_PKT_IF_BASE_ADDRS          { DSI2_HOST_APB_PKT_IF_BASE }
  /** Array initializer of DSI2_HOST_APB_PKT_IF peripheral base pointers */
  #define DSI2_HOST_APB_PKT_IF_BASE_PTRS           { DSI2_HOST_APB_PKT_IF }
  /** Array initializer of DSI2_HOST_APB_PKT_IF peripheral base addresses */
  #define DSI2_HOST_APB_PKT_IF_BASE_ADDRS_NS       { DSI2_HOST_APB_PKT_IF_BASE_NS }
  /** Array initializer of DSI2_HOST_APB_PKT_IF peripheral base pointers */
  #define DSI2_HOST_APB_PKT_IF_BASE_PTRS_NS        { DSI2_HOST_APB_PKT_IF_NS }
#else
  /** Peripheral DSI2_HOST_APB_PKT_IF base address */
  #define DSI2_HOST_APB_PKT_IF_BASE                (0x4C0A0180u)
  /** Peripheral DSI2_HOST_APB_PKT_IF base pointer */
  #define DSI2_HOST_APB_PKT_IF                     ((DSI2_HOST_APB_PKT_IF_Type *)DSI2_HOST_APB_PKT_IF_BASE)
  /** Array initializer of DSI2_HOST_APB_PKT_IF peripheral base addresses */
  #define DSI2_HOST_APB_PKT_IF_BASE_ADDRS          { DSI2_HOST_APB_PKT_IF_BASE }
...
/* DSI2_HOST_DBI_IF - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral DSI2_HOST_DBI_IF base address */
  #define DSI2_HOST_DBI_IF_BASE                    (0x5C0A0200u)
  /** Peripheral DSI2_HOST_DBI_IF base address */
  #define DSI2_HOST_DBI_IF_BASE_NS                 (0x4C0A0200u)
  /** Peripheral DSI2_HOST_DBI_IF base pointer */
  #define DSI2_HOST_DBI_IF                         ((DSI2_HOST_DBI_IF_Type *)DSI2_HOST_DBI_IF_BASE)
  /** Peripheral DSI2_HOST_DBI_IF base pointer */
  #define DSI2_HOST_DBI_IF_NS                      ((DSI2_HOST_DBI_IF_Type *)DSI2_HOST_DBI_IF_BASE_NS)
  /** Array initializer of DSI2_HOST_DBI_IF peripheral base addresses */
  #define DSI2_HOST_DBI_IF_BASE_ADDRS              { DSI2_HOST_DBI_IF_BASE }
  /** Array initializer of DSI2_HOST_DBI_IF peripheral base pointers */
  #define DSI2_HOST_DBI_IF_BASE_PTRS               { DSI2_HOST_DBI_IF }
  /** Array initializer of DSI2_HOST_DBI_IF peripheral base addresses */
  #define DSI2_HOST_DBI_IF_BASE_ADDRS_NS           { DSI2_HOST_DBI_IF_BASE_NS }
  /** Array initializer of DSI2_HOST_DBI_IF peripheral base pointers */
  #define DSI2_HOST_DBI_IF_BASE_PTRS_NS            { DSI2_HOST_DBI_IF_NS }
#else
  /** Peripheral DSI2_HOST_DBI_IF base address */
  #define DSI2_HOST_DBI_IF_BASE                    (0x4C0A0200u)
  /** Peripheral DSI2_HOST_DBI_IF base pointer */
  #define DSI2_HOST_DBI_IF                         ((DSI2_HOST_DBI_IF_Type *)DSI2_HOST_DBI_IF_BASE)
  /** Array initializer of DSI2_HOST_DBI_IF peripheral base addresses */
  #define DSI2_HOST_DBI_IF_BASE_ADDRS              { DSI2_HOST_DBI_IF_BASE }
...
/* DSI2_HOST_VID_IF - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral DSI2_HOST_VID_IF base address */
  #define DSI2_HOST_VID_IF_BASE                    (0x5C0A0100u)
  /** Peripheral DSI2_HOST_VID_IF base address */
  #define DSI2_HOST_VID_IF_BASE_NS                 (0x4C0A0100u)
  /** Peripheral DSI2_HOST_VID_IF base pointer */
  #define DSI2_HOST_VID_IF                         ((DSI2_HOST_VID_IF_Type *)DSI2_HOST_VID_IF_BASE)
  /** Peripheral DSI2_HOST_VID_IF base pointer */
  #define DSI2_HOST_VID_IF_NS                      ((DSI2_HOST_VID_IF_Type *)DSI2_HOST_VID_IF_BASE_NS)
  /** Array initializer of DSI2_HOST_VID_IF peripheral base addresses */
  #define DSI2_HOST_VID_IF_BASE_ADDRS              { DSI2_HOST_VID_IF_BASE }
  /** Array initializer of DSI2_HOST_VID_IF peripheral base pointers */
  #define DSI2_HOST_VID_IF_BASE_PTRS               { DSI2_HOST_VID_IF }
  /** Array initializer of DSI2_HOST_VID_IF peripheral base addresses */
  #define DSI2_HOST_VID_IF_BASE_ADDRS_NS           { DSI2_HOST_VID_IF_BASE_NS }
  /** Array initializer of DSI2_HOST_VID_IF peripheral base pointers */
  #define DSI2_HOST_VID_IF_BASE_PTRS_NS            { DSI2_HOST_VID_IF_NS }
#else
  /** Peripheral DSI2_HOST_VID_IF base address */
  #define DSI2_HOST_VID_IF_BASE                    (0x4C0A0100u)
  /** Peripheral DSI2_HOST_VID_IF base pointer */
  #define DSI2_HOST_VID_IF                         ((DSI2_HOST_VID_IF_Type *)DSI2_HOST_VID_IF_BASE)
  /** Array initializer of DSI2_HOST_VID_IF peripheral base addresses */
  #define DSI2_HOST_VID_IF_BASE_ADDRS              { DSI2_HOST_VID_IF_BASE }
...
/* DSI2_TX_PHY - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral DSI2_TX_PHY base address */
  #define DSI2_TX_PHY_BASE                         (0x5C160000u)
  /** Peripheral DSI2_TX_PHY base address */
  #define DSI2_TX_PHY_BASE_NS                      (0x4C160000u)
  /** Peripheral DSI2_TX_PHY base pointer */
  #define DSI2_TX_PHY                              ((DSI2_TX_PHY_Type *)DSI2_TX_PHY_BASE)
  /** Peripheral DSI2_TX_PHY base pointer */
  #define DSI2_TX_PHY_NS                           ((DSI2_TX_PHY_Type *)DSI2_TX_PHY_BASE_NS)
  /** Array initializer of DSI2_TX_PHY peripheral base addresses */
  #define DSI2_TX_PHY_BASE_ADDRS                   { DSI2_TX_PHY_BASE }
  /** Array initializer of DSI2_TX_PHY peripheral base pointers */
  #define DSI2_TX_PHY_BASE_PTRS                    { DSI2_TX_PHY }
  /** Array initializer of DSI2_TX_PHY peripheral base addresses */
  #define DSI2_TX_PHY_BASE_ADDRS_NS                { DSI2_TX_PHY_BASE_NS }
  /** Array initializer of DSI2_TX_PHY peripheral base pointers */
  #define DSI2_TX_PHY_BASE_PTRS_NS                 { DSI2_TX_PHY_NS }
#else
  /** Peripheral DSI2_TX_PHY base address */
  #define DSI2_TX_PHY_BASE                         (0x4C160000u)
  /** Peripheral DSI2_TX_PHY base pointer */
  #define DSI2_TX_PHY                              ((DSI2_TX_PHY_Type *)DSI2_TX_PHY_BASE)
  /** Array initializer of DSI2_TX_PHY peripheral base addresses */
  #define DSI2_TX_PHY_BASE_ADDRS                   { DSI2_TX_PHY_BASE }
...
/* MIPI_CSI2RX - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral CSI2_RX_BASE base address */
  #define CSI2_RX_BASE_BASE                        (0x5C0B0000u)
  /** Peripheral CSI2_RX_BASE base address */
  #define CSI2_RX_BASE_BASE_NS                     (0x4C0B0000u)
  /** Peripheral CSI2_RX_BASE base pointer */
  #define CSI2_RX_BASE                             ((MIPI_CSI2RX_Type *)CSI2_RX_BASE_BASE)
  /** Peripheral CSI2_RX_BASE base pointer */
  #define CSI2_RX_BASE_NS                          ((MIPI_CSI2RX_Type *)CSI2_RX_BASE_BASE_NS)
  /** Array initializer of MIPI_CSI2RX peripheral base addresses */
  #define MIPI_CSI2RX_BASE_ADDRS                   { CSI2_RX_BASE_BASE }
  /** Array initializer of MIPI_CSI2RX peripheral base pointers */
  #define MIPI_CSI2RX_BASE_PTRS                    { CSI2_RX_BASE }
  /** Array initializer of MIPI_CSI2RX peripheral base addresses */
  #define MIPI_CSI2RX_BASE_ADDRS_NS                { CSI2_RX_BASE_BASE_NS }
  /** Array initializer of MIPI_CSI2RX peripheral base pointers */
  #define MIPI_CSI2RX_BASE_PTRS_NS                 { CSI2_RX_BASE_NS }
#else
  /** Peripheral CSI2_RX_BASE base address */
  #define CSI2_RX_BASE_BASE                        (0x4C0B0000u)
  /** Peripheral CSI2_RX_BASE base pointer */
  #define CSI2_RX_BASE                             ((MIPI_CSI2RX_Type *)CSI2_RX_BASE_BASE)
  /** Array initializer of MIPI_CSI2RX peripheral base addresses */
  #define MIPI_CSI2RX_BASE_ADDRS                   { CSI2_RX_BASE_BASE }
  ...
  #define MIPI_CSI2RX_BASE_PTRS                    { CSI2_RX_BASE }
#endif
/** Interrupt vectors for the MIPI_CSI2RX peripheral type */
#define MIPI_CSI2RX_IRQS                         { MEDIA_MIPI_CSI_IRQn }
