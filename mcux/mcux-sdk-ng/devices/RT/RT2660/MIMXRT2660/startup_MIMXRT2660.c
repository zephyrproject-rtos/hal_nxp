...
WEAK void Reserved342_IRQHandler(void);
...
WEAK void Reserved347_IRQHandler(void);
WEAK void Reserved348_IRQHandler(void);
...
void Reserved342_DriverIRQHandler(void) ALIAS(DefaultISR);
...
void Reserved347_DriverIRQHandler(void) ALIAS(DefaultISR);
void Reserved348_DriverIRQHandler(void) ALIAS(DefaultISR);
...
WEAK void Reserved347_IRQHandler(void)
{
    Reserved347_DriverIRQHandler();
}

WEAK void Reserved348_IRQHandler(void)
{
    Reserved348_DriverIRQHandler();
}
...
void (*const STARTUP_VT_SYMBOL[])(void) = {
    ...
    Reserved342_IRQHandler,          // 342: Reserved interrupt
    ...
    Reserved347_IRQHandler,          // 347: Reserved interrupt
    Reserved348_IRQHandler,          // 348: Reserved interrupt
