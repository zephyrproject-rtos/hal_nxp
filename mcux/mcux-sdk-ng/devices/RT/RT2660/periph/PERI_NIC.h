...
#define NIC_AMIB_COUNT                            9u
#define NIC_ASIB_COUNT                            8u

/** NIC - Register Layout Typedef */
typedef struct {
       uint8_t RESERVED_0[8192];
  struct {                                         /* offset: 0x2000, array step: 0x1000 */
         uint8_t RESERVED_0[8];
    __IO uint32_t FN_MOD_BM_ISS;                     /**< Bus Matrix Issuing Functionality Modification., array offset: 0x2008, array step: 0x1000, irregular array, not all indices are valid */
         uint8_t RESERVED_1[24];
    __IO uint32_t FN_MOD2;                           /**< Bypass Merge, array offset: 0x2024, array step: 0x1000, irregular array, not all indices are valid */
         uint8_t RESERVED_2[4];
    __IO uint32_t FN_MOD_LB;                         /**< Long burst, array offset: 0x202C, array step: 0x1000, irregular array, not all indices are valid */
         uint8_t RESERVED_3[216];
    __IO uint32_t FN_MOD;                            /**< Issuing Functionality Modification, array offset: 0x2108, array step: 0x1000, irregular array, not all indices are valid */
         uint8_t RESERVED_4[3828];
  } AMIB[NIC_AMIB_COUNT];
       uint8_t RESERVED_1[225316];
  struct {                                         /* offset: 0x42024, array step: 0x1000 */
    ...
    __IO uint32_t FN_MOD;                            /**< Issuing Functionality Modification, array offset: 0x42108, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t QOS_CNTL;                          /**< QoS Control, array offset: 0x4210C, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t MAX_OT;                            /**< Maximum Number of Outstanding Transactions, array offset: 0x42110, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t MAX_COMB_OT;                       /**< Maximum Combined Outstanding Transactions, array offset: 0x42114, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AW_P;                              /**< AW Channel Peak Rate, array offset: 0x42118, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AW_B;                              /**< AW Channel Burstiness Allowance, array offset: 0x4211C, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AW_R;                              /**< AW Channel Average Rate, array offset: 0x42120, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AR_P;                              /**< AR Channel Peak Rate, array offset: 0x42124, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AR_B;                              /**< AR Channel Burstiness Allowance, array offset: 0x42128, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t AR_R;                              /**< AR Channel Average Rate, array offset: 0x4212C, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t TARGET_FC;                         /**< Feedback Controlled Target, array offset: 0x42130, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t KI_FC;                             /**< Feedback Controlled Scale, array offset: 0x42134, array step: 0x1000, irregular array, not all indices are valid */
    __IO uint32_t QOS_RANGE;                         /**< QoS Range, array offset: 0x42138, array step: 0x1000, irregular array, not all indices are valid */
         uint8_t RESERVED_2[3816];
  } ASIB[NIC_ASIB_COUNT];
} NIC_Type;
...
#define NIC_FN_MOD_BM_ISS_FN_MOD_BM_ISS_MASK     (0x3U)
#define NIC_FN_MOD_BM_ISS_FN_MOD_BM_ISS_SHIFT    (0U)
/*! FN_MOD_BM_ISS - Bus Matrix Issuing Functionality Modification */
#define NIC_FN_MOD_BM_ISS_FN_MOD_BM_ISS(x)       (((uint32_t)(((uint32_t)(x)) << NIC_FN_MOD_BM_ISS_FN_MOD_BM_ISS_SHIFT)) & NIC_FN_MOD_BM_ISS_FN_MOD_BM_ISS_MASK)
/*! @} */

/* The count of NIC_FN_MOD_BM_ISS */
#define NIC_FN_MOD_BM_ISS_COUNT                  (9U)

/*! @name FN_MOD2 - Bypass Merge */
/*! @{ */

#define NIC_FN_MOD2_FN_MOD2_MASK                 (0x1U)
#define NIC_FN_MOD2_FN_MOD2_SHIFT                (0U)
/*! FN_MOD2 - Bypass Merge */
#define NIC_FN_MOD2_FN_MOD2(x)                   (((uint32_t)(((uint32_t)(x)) << NIC_FN_MOD2_FN_MOD2_SHIFT)) & NIC_FN_MOD2_FN_MOD2_MASK)
/*! @} */

/* The count of NIC_FN_MOD2 */
#define NIC_FN_MOD2_COUNT                        (9U)

/*! @name FN_MOD_LB - Long burst */
/*! @{ */

#define NIC_FN_MOD_LB_FN_MOD_LB_MASK             (0x1U)
#define NIC_FN_MOD_LB_FN_MOD_LB_SHIFT            (0U)
/*! FN_MOD_LB - Long bursts functionality modification register */
#define NIC_FN_MOD_LB_FN_MOD_LB(x)               (((uint32_t)(((uint32_t)(x)) << NIC_FN_MOD_LB_FN_MOD_LB_SHIFT)) & NIC_FN_MOD_LB_FN_MOD_LB_MASK)
/*! @} */

/* The count of NIC_FN_MOD_LB */
#define NIC_FN_MOD_LB_COUNT                      (9U)
...
/* The count of NIC_FN_MOD2 */
#define NIC_ASIB_FN_MOD2_COUNT                   (8U)

/*! @name FN_MOD_LB - Long burst functionality modification */
/*! @{ */
...
/* The count of NIC_FN_MOD_LB */
#define NIC_ASIB_FN_MOD_LB_COUNT                 (8U)
...
/* The count of NIC_FN_MOD */
#define NIC_ASIB_FN_MOD_COUNT                    (8U)
...
#define NIC_MAX_COMB_OT_COUNT                    (8U)
