...
#define ADC_STAT_CMDACT_MASK                     (0x1F000000U)
#define ADC_STAT_CMDACT_SHIFT                    (24U)
/*! CMDACT - Command Active
 *  0b00000..No command
 *  0b00001..Command 1
 *  0b00010..Command 2
 *  0b00011-0b11111..Associated command number
 */
 ...
 *  0b00000000..Disable
 *  0b00000001..Enable for trigger source 0 only
 *  0b00000010..Enable for trigger source 1 only
 *  0b00000011-0b11111110..Enable associated trigger completion interrupts
 *  0b11111111..Enable trigger completion interrupts for every trigger source
 */
...
#define ADC_CFG_ADCCLKSEL_MASK                   (0x800U)
#define ADC_CFG_ADCCLKSEL_SHIFT                  (11U)
/*! ADCCLKSEL - ADC Sample Clock Selection
 *  0b0..Select adc_clk0 used for sample clock.
 *  0b1..Select adc_clk1 used for sample clock.
 */
#define ADC_CFG_ADCCLKSEL(x)                     (((uint32_t)(((uint32_t)(x)) << ADC_CFG_ADCCLKSEL_SHIFT)) & ADC_CFG_ADCCLKSEL_MASK)

#define ADC_CFG_HWTRGSEL_MASK                    (0x1000U)
#define ADC_CFG_HWTRGSEL_SHIFT                   (12U)
/*! HWTRGSEL - Hard Trigger Selection
 *  0b0..Select hw_trg0 used for sample trigger.
 *  0b1..Select hw_trg1 used for sample trigger.
 */
#define ADC_CFG_HWTRGSEL(x)                      (((uint32_t)(((uint32_t)(x)) << ADC_CFG_HWTRGSEL_SHIFT)) & ADC_CFG_HWTRGSEL_MASK)
 ...
 *  0b00000000..No trigger is interrupted (or CFG[TRES] = 1)
 *  0b00000001..Trigger 0 is interrupted
 *  0b00000010..Trigger 1 is interrupted
 *  0b00000011-0b11111110..Associated trigger sequence is interrupted by a high-priority exception
 *  0b11111111..Every trigger sequence is interrupted by a high-priority exception.
 */
 ...
 *  0b00000000..No trigger is complete (trigger completion interrupts are disabled)
 *  0b00000001..Trigger 0 is complete (trigger 0 has enabled completion interrupts)
 *  0b00000010..Trigger 1 is complete (trigger 1 has enabled completion interrupts)
 *  0b00000011-0b11111110..Associated trigger sequence is complete (enables completion interrupts)
 *  0b11111111..Every trigger sequence is complete and every trigger has enabled completion interrupts.
 */
...
#define ADC_TCTRL_TCMD_MASK                      (0x1F000000U)
#define ADC_TCTRL_TCMD_SHIFT                     (24U)
/*! TCMD - Trigger Command Select
 *  0b00000..Not a valid selection from the command buffer (trigger event is ignored)
 *  0b00001..CMD1 is executed
 *  0b00010-0b11110..Corresponding CMD is executed
 *  0b11111..CMD31 is executed
 */
...
#define ADC_FCTRL_FCOUNT_MASK                    (0x3FU)
...
#define ADC_FCTRL_FWMARK_MASK                    (0x1F0000U)
 ...
 *  0b001..3.5 + 2 1 ADCK cycles; 5.5 ADCK cycles
 *  0b010..3.5 + 2 2 ADCK cycles; 7.5 ADCK cycles
 *  0b011..3.5 + 2 3 ADCK cycles; 11.5 ADCK cycles
 *  0b100..3.5 + 2 4 ADCK cycles; 19.5 ADCK cycles
 *  0b101..3.5 + 2 5 ADCK cycles; 35.5 ADCK cycles
 *  0b110..3.5 + 2 6 ADCK cycles; 67.5 ADCK cycles
 *  0b111..3.5 + 2 7 ADCK cycles; 131.5 ADCK cycles
 */
...
#define ADC_CMDH_NEXT_MASK                       (0x1F000000U)
#define ADC_CMDH_NEXT_SHIFT                      (24U)
/*! NEXT - Next Command Select
 *  0b00000..No next command defined
 *  0b00001..CMD1 command buffer register
 *  0b00010-0b11110..Corresponding CMD command buffer register
 *  0b11111..CMD31 command buffer register
 */
#define ADC_CMDH_NEXT(x)                         (((uint32_t)(((uint32_t)(x)) << ADC_CMDH_NEXT_SHIFT)) & ADC_CMDH_NEXT_MASK)
/*! @} */

/* The count of ADC_CMDH */
#define ADC_CMDH_COUNT                           (31U)
...
/*! TSRC - Trigger Source
 *  0b000..Trigger source 0
 *  0b001..Trigger source 1
 *  0b010-0b110..Corresponding trigger source
 *  0b111..Trigger source 7
 */
...
#define ADC_CFG2_JLEFT_MASK                      (0x10000U)
#define ADC_CFG2_JLEFT_SHIFT                     (16U)
