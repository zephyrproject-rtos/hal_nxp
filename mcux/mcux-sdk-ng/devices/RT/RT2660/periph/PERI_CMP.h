 ...
 *  0b000..Test channel
 *  0b001..External input 1 for minus channel (INA_3V[1])
 *  0b010..External input 2 for minus channel (INA_3V[2])
 *  0b011..External input 3 for minus channel (INA_3V[3])
 *  0b100..External input 4 for minus channel (INA_3V[4])
 *  0b101..External input 5 for minus channel (INA_3V[5])
 *  0b110..External input 6 for minus channel (INA_3V[6])
 ...
 *  0b000..Test channel
 *  0b001..External input 1 for plus channel (INA_3V[1])
 *  0b010..External input 2 for plus channel (INA_3V[2])
 *  0b011..External input 3 for plus channel (INA_3V[3])
 *  0b100..External input 4 for plus channel (INA_3V[4])
 *  0b101..External input 5 for plus channel (INA_3V[5])
 *  0b110..External input 6 for plus channel (INA_3V[6])
 *  0b111..Internal 8-bit DAC output
 */
 ...
 *  0b0..Input is not changed
 *  0b0..No effect
 *  0b1..Clear the flag
 *  0b1..Input is changed
 */
...
#define CMP_C3_HYST_DIVEN_MASK                   (0x100000U)
#define CMP_C3_HYST_DIVEN_SHIFT                  (20U)
/*! HYST_DIVEN - Hysteresis Divider Enable
 *  0b0..Disable hysteresis divided by 2.
 *  0b1..Enable hysteresis divided by 2.
 */
#define CMP_C3_HYST_DIVEN(x)                     (((uint32_t)(((uint32_t)(x)) << CMP_C3_HYST_DIVEN_SHIFT)) & CMP_C3_HYST_DIVEN_MASK)

#define CMP_C3_NCH_RDIV_BYP_MASK                 (0x1000000U)
#define CMP_C3_NCH_RDIV_BYP_SHIFT                (24U)
/*! NCH_RDIV_BYP - Bypass Negative Channel Resister Divider
 *  0b0..Enable the negative channel resistor divider.
 *  0b1..Bypass the negative channel resistor divider.
 */
#define CMP_C3_NCH_RDIV_BYP(x)                   (((uint32_t)(((uint32_t)(x)) << CMP_C3_NCH_RDIV_BYP_SHIFT)) & CMP_C3_NCH_RDIV_BYP_MASK)

#define CMP_C3_PCH_RDIV_BYP_MASK                 (0x10000000U)
#define CMP_C3_PCH_RDIV_BYP_SHIFT                (28U)
/*! PCH_RDIV_BYP - Bypass Positive Channel Resister Divider
 *  0b0..Enable the Positive channel resistor divider.
 *  0b1..Bypass the Positive channel resistor divider.
 */
#define CMP_C3_PCH_RDIV_BYP(x)                   (((uint32_t)(((uint32_t)(x)) << CMP_C3_PCH_RDIV_BYP_SHIFT)) & CMP_C3_PCH_RDIV_BYP_MASK)
/*! @} */
