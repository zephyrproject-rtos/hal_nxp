...
typedef struct {
  ...
  __IO uint32_t CLK_CFG;                           /**< Clock Configuration, offset: 0x88 */
  __IO uint32_t CA_SFT_CFG;                        /**< Column Address Shift Configuration, offset: 0x8C */
...
#define XSPI_BUFCR_MSTRID_MASK                   (0x3FU)
...
/*! @name INBAND_CFG - In-band Configuration */
/*! @{ */

#define XSPI_INBAND_CFG_CSHHT_MASK               (0xFFU)
#define XSPI_INBAND_CFG_CSHHT_SHIFT              (0U)
/*! CSHHT - Serial Memory CS High Hold Time */
#define XSPI_INBAND_CFG_CSHHT(x)                 (((uint32_t)(((uint32_t)(x)) << XSPI_INBAND_CFG_CSHHT_SHIFT)) & XSPI_INBAND_CFG_CSHHT_MASK)

#define XSPI_INBAND_CFG_CSLHT_MASK               (0xFF00U)
#define XSPI_INBAND_CFG_CSLHT_SHIFT              (8U)
/*! CSLHT - Serial Memory CS Low Hold Time */
#define XSPI_INBAND_CFG_CSLHT(x)                 (((uint32_t)(((uint32_t)(x)) << XSPI_INBAND_CFG_CSLHT_SHIFT)) & XSPI_INBAND_CFG_CSLHT_MASK)

#define XSPI_INBAND_CFG_SDIHT_MASK               (0x70000U)
#define XSPI_INBAND_CFG_SDIHT_SHIFT              (16U)
/*! SDIHT - Serial Data Input Hold Time */
#define XSPI_INBAND_CFG_SDIHT(x)                 (((uint32_t)(((uint32_t)(x)) << XSPI_INBAND_CFG_SDIHT_SHIFT)) & XSPI_INBAND_CFG_SDIHT_MASK)
/*! @} */

/*! @name INBAND_RRT - In-band Reset Recovery Time */
/*! @{ */

#define XSPI_INBAND_RRT_RRT_MASK                 (0xFFFFFFFU)
#define XSPI_INBAND_RRT_RRT_SHIFT                (0U)
/*! RRT - Reset Recovery Time */
#define XSPI_INBAND_RRT_RRT(x)                   (((uint32_t)(((uint32_t)(x)) << XSPI_INBAND_RRT_RRT_SHIFT)) & XSPI_INBAND_RRT_RRT_MASK)
/*! @} */

/*! @name CLK_CFG - Clock Configuration */
/*! @{ */

#define XSPI_CLK_CFG_CLK_RTO_MASK                (0x7U)
#define XSPI_CLK_CFG_CLK_RTO_SHIFT               (0U)
/*! CLK_RTO - Clock Ratio
 *  0b001..1:1
 *  0b010..2:1
 */
#define XSPI_CLK_CFG_CLK_RTO(x)                  (((uint32_t)(((uint32_t)(x)) << XSPI_CLK_CFG_CLK_RTO_SHIFT)) & XSPI_CLK_CFG_CLK_RTO_MASK)

#define XSPI_CLK_CFG_CSINCFG_MASK                (0x1F00U)
#define XSPI_CLK_CFG_CSINCFG_SHIFT               (8U)
/*! CSINCFG - Chip Select Inactive Configuration */
#define XSPI_CLK_CFG_CSINCFG(x)                  (((uint32_t)(((uint32_t)(x)) << XSPI_CLK_CFG_CSINCFG_SHIFT)) & XSPI_CLK_CFG_CSINCFG_MASK)
/*! @} */

/*! @name CA_SFT_CFG - Column Address Shift Configuration */
/*! @{ */

#define XSPI_CA_SFT_CFG_NUM_SFT_MASK             (0x1FU)
#define XSPI_CA_SFT_CFG_NUM_SFT_SHIFT            (0U)
/*! NUM_SFT - Number of Shift for Column Address */
#define XSPI_CA_SFT_CFG_NUM_SFT(x)               (((uint32_t)(((uint32_t)(x)) << XSPI_CA_SFT_CFG_NUM_SFT_SHIFT)) & XSPI_CA_SFT_CFG_NUM_SFT_MASK)
/*! @} */
...
#define XSPI_SR_INBRSTW_MASK                     (0x80000000U)
#define XSPI_SR_INBRSTW_SHIFT                    (31U)
/*! INBRSTW - In-Band Reset Wait
 *  0b0..Indicates that the in-band reset's wait period is not started or completed the wait period during in band operation
 *  0b1..Indicates that the in-band reset's wait period is ongoing
 */
#define XSPI_SR_INBRSTW(x)                       (((uint32_t)(((uint32_t)(x)) << XSPI_SR_INBRSTW_SHIFT)) & XSPI_SR_INBRSTW_MASK)
/*! @} */
...
/*! OSD4GBIT - Octal SNAND 2Gb/4Gb Support
 *  0b0..Disabled
 *  0b1..Enabled
 */
...
/*! OS4GASFT - Octal SNAND Address Shift
 *  0b00..Shift disabled
 *  0b01..One time
 *  0b10..Two time
 *  0b11..Three time
...
/*! CONFIG - IPED CTR/GCM/XEX Interface Configure
 *  0b0..Normal execution
 *  0b1..Double encryption/decryption execution
 */
...
/*! IPED_EN - IPED CTR-GCM-XEX Interface Enable
...
/*! IPSXEXWE - IPS Write IPED XEX Mode Enable
 *  0b0..Bypasses IPS-based data and writes unencrypted data
 *  0b1..Enables
 */
...
/*! AHBXEXWE - AHB Write IPED XEX Mode Encryption Enable
 *  0b0..Bypasses AHB-based data and writes unencrypted
 *  0b1..Enables
 */
...
/*! AHBXEXRE - AHB Read IPED XEX Mode Decryption Enable
 *  0b0..Bypasses AHB-based data and reads unencrypted
 *  0b1..Enables
 */
...
/*! WWEBTMID - Initiator ID of Write Wrap Burst Ignored due to Early Termination */
...
/*! WWARLMID - Initiator ID of Write Wrap Burst Ignored due to Arbitration Lock */
...
/*! WWMID - Rejected Initiator ID of Write Wrap Burst */
...
/*! WWEBTADR - Write Wrap Burst Error Address due to Early Termination */
...
/*! WWARLADR - Write Wrap Burst Error Address due to Arbitration Lock */
...
/*! WWADR - Rejected Write Wrap Burst Address */
...
/*! WWI - Write Wrap Burst Ignored due to Error Response
 *  0b0..No action
 *  0b0..No error
 *  0b1..Clears flag
 *  0b1..Error
...
/*! WWI_EBT - Write Wrap Burst Ignored due to Early Termination
 *  0b0..No action
 *  0b0..No error
 *  0b1..Clears flag
 *  0b1..Error
...
/*! WWI_ARL - Write Wrap Burst Ignored due to Arbitration Lock
 *  0b0..No action
 *  0b0..No error
 *  0b1..Clears flag
 *  0b1..Error
...
/*! WW_IE - Wrap Write Burst Subordinate Error Interrupt Enable
 *  0b0..Disables
 *  0b1..Enables
 */
...
/*! WWEBTIE - Write Wrap Burst Early Termination Interrupt Enable
 *  0b0..Disables
 *  0b1..Enables
 */
...
/*! WWARLIE - Write Wrap Burst Arbitration Lock Interrupt Enable
 *  0b0..Disables
 *  0b1..Enables
 */
...
#define XSPI_FSMSTAT_ATQ_MASK                    (0x3C0000U)
#define XSPI_FSMSTAT_ATQ_SHIFT                   (18U)
/*! ATQ - Active Target Queue
 *  0b0000..TG0
 *  0b0001..TG1
 *  0b0010..TG2
 *  0b0011..TG3
 ...
 *  0b1111..TG15
 */
#define XSPI_FSMSTAT_ATQ(x)                      (((uint32_t)(((uint32_t)(x)) << XSPI_FSMSTAT_ATQ_SHIFT)) & XSPI_FSMSTAT_ATQ_MASK)
...
#define XSPI_SFP_LOCK_ERR_ADDR_ADDRW_MASK        (0xFFFFU)
