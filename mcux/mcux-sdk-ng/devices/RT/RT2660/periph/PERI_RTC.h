...
#define RTC_STATUS_SUBSECOND_READ_ERR_MASK       (0x1000U)
#define RTC_STATUS_SUBSECOND_READ_ERR_SHIFT      (12U)
/*! SUBSECOND_READ_ERR - Reading SubSeconds counter value(RTC_TEST2) is error
 *  0b0..Reading RTC_TEST2 operation is normal
 *  0b1..Reading RTC_TEST2 operation is error
 */
#define RTC_STATUS_SUBSECOND_READ_ERR(x)         (((uint16_t)(((uint16_t)(x)) << RTC_STATUS_SUBSECOND_READ_ERR_SHIFT)) & RTC_STATUS_SUBSECOND_READ_ERR_MASK)
/*! @} */
