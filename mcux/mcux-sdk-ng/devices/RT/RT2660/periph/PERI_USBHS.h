...
#define USBHS_HCIVERSION_CAPLENGTH_MASK          USBHS_CAPLENGTH_CAPLENGTH_MASK
#define USBHS_HCIVERSION_CAPLENGTH_SHIFT         USBHS_CAPLENGTH_CAPLENGTH_SHIFT
#define USBHS_HCIVERSION_CAPLENGTH(x)            USBHS_CAPLENGTH_CAPLENGTH(x)
...
#define USBHS_USBCMD_FS2_MASK                    USBHS_USBCMD_FS_2_MASK
#define USBHS_USBCMD_FS2_SHIFT                   USBHS_USBCMD_FS_2_SHIFT
#define USBHS_USBCMD_FS2(x)                      USBHS_USBCMD_FS_2(x)
#define USBHS_PERIODICLISTBASE_PERBASE_MASK      USBHS_PERIODICLISTBASE_BASEADR_MASK
#define USBHS_PERIODICLISTBASE_PERBASE_SHIFT     USBHS_PERIODICLISTBASE_BASEADR_SHIFT
#define USBHS_PERIODICLISTBASE_PERBASE(x)        USBHS_PERIODICLISTBASE_BASEADR(x)
...
#define USBHS_PORTSC1_PTS2_MASK                  USBHS_PORTSC1_PTS_2_MASK
#define USBHS_PORTSC1_PTS2_SHIFT                 USBHS_PORTSC1_PTS_2_SHIFT
#define USBHS_PORTSC1_PTS2(x)                    USBHS_PORTSC1_PTS_2(x)
#define USBHS_PORTSC1_PTS_MASK                   USBHS_PORTSC1_PTS_1_MASK
#define USBHS_PORTSC1_PTS_SHIFT                  USBHS_PORTSC1_PTS_1_SHIFT
#define USBHS_PORTSC1_PTS(x)                     USBHS_PORTSC1_PTS_1(x)
#define USBHS_OTGSC_MST_MASK                     USBHS_OTGSC_TOG_1MS_MASK
#define USBHS_OTGSC_MST_SHIFT                    USBHS_OTGSC_TOG_1MS_SHIFT
#define USBHS_OTGSC_MST(x)                       USBHS_OTGSC_TOG_1MS(x)
#define USBHS_OTGSC_MSS_MASK                     USBHS_OTGSC_STATUS_1MS_MASK
#define USBHS_OTGSC_MSS_SHIFT                    USBHS_OTGSC_STATUS_1MS_SHIFT
#define USBHS_OTGSC_MSS(x)                       USBHS_OTGSC_STATUS_1MS(x)
#define USBHS_OTGSC_MSE_MASK                     USBHS_OTGSC_EN_1MS_MASK
#define USBHS_OTGSC_MSE_SHIFT                    USBHS_OTGSC_EN_1MS_SHIFT
#define USBHS_OTGSC_MSE(x)                       USBHS_OTGSC_EN_1MS(x)
...
#define USBHS_IRQHandler                         COMM_USB0_IRQHandler
#define USBHS_STACK_BASE_ADDRS                   { COMM__USBC_BASE }
