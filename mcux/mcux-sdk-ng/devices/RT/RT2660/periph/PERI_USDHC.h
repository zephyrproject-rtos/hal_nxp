...
#define USDHC_PRES_STATE_LVSI_RES_MASK           (0x100000U)
#define USDHC_PRES_STATE_LVSI_RES_SHIFT          (20U)
/*! LVSI_RES - Indicates the result of LVSI, reflecting the status of DAT[2].
 *  0b0..LVS Card is not detected.
 *  0b1..LVS Card is detected.
 */
#define USDHC_PRES_STATE_LVSI_RES(x)             (((uint32_t)(((uint32_t)(x)) << USDHC_PRES_STATE_LVSI_RES_SHIFT)) & USDHC_PRES_STATE_LVSI_RES_MASK)
...
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_DLOW_MASK (0x40000U)
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_DLOW_SHIFT (18U)
/*! LVSI_DLOW - LVSI Drive Low.
 *  0b0..Not drive.
 *  0b1..Drive to low.
 */
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_DLOW(x)  (((uint32_t)(((uint32_t)(x)) << USDHC_AUTOCMD12_ERR_STATUS_LVSI_DLOW_SHIFT)) & USDHC_AUTOCMD12_ERR_STATUS_LVSI_DLOW_MASK)
...
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_EXE_MASK (0x2000000U)
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_EXE_SHIFT (25U)
/*! LVSI_EXE - LVSI Execution.
 *  0b0..LVSI is not executed or already completed.
 *  0b1..Executing LVSI.
 */
#define USDHC_AUTOCMD12_ERR_STATUS_LVSI_EXE(x)   (((uint32_t)(((uint32_t)(x)) << USDHC_AUTOCMD12_ERR_STATUS_LVSI_EXE_SHIFT)) & USDHC_AUTOCMD12_ERR_STATUS_LVSI_EXE_MASK)
/*! @} */
...
#define USDHC_HOST_CTRL_CAP_LVS_HOST_MASK        (0x80000000U)
#define USDHC_HOST_CTRL_CAP_LVS_HOST_SHIFT       (31U)
/*! LVS_HOST - LVS Host.
 *  0b0..Not LVS Host.
 *  0b1..LVS Host.
 */
#define USDHC_HOST_CTRL_CAP_LVS_HOST(x)          (((uint32_t)(((uint32_t)(x)) << USDHC_HOST_CTRL_CAP_LVS_HOST_SHIFT)) & USDHC_HOST_CTRL_CAP_LVS_HOST_MASK)
/*! @} */
