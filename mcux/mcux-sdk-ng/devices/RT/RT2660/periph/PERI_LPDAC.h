 ...
 *  0b0..Selects VREFH0 as the reference voltage
 *  0b1..Selects VREFH1 as the reference voltage
 */
...
#define LPDAC_GCR_DAC_OPTION_EN_MASK             (0x10000U)
#define LPDAC_GCR_DAC_OPTION_EN_SHIFT            (16U)
/*! DAC_OPTION_EN - Optional Enable
 *  0b0..Not bypassed
 *  0b1..Bypassed
 */
#define LPDAC_GCR_DAC_OPTION_EN(x)               (((uint32_t)(((uint32_t)(x)) << LPDAC_GCR_DAC_OPTION_EN_SHIFT)) & LPDAC_GCR_DAC_OPTION_EN_MASK)
...
#define LPDAC_GCR_IREF_INT_SEL_MASK              (0x400000U)
#define LPDAC_GCR_IREF_INT_SEL_SHIFT             (22U)
/*! IREF_INT_SEL - Internal Current Reference Select
 *  0b0..Internal Current Reference not selected
 *  0b1..Internal Current Reference selected
 */
#define LPDAC_GCR_IREF_INT_SEL(x)                (((uint32_t)(((uint32_t)(x)) << LPDAC_GCR_IREF_INT_SEL_SHIFT)) & LPDAC_GCR_IREF_INT_SEL_MASK)
...
#define LPDAC_GCR_IREF_INT_TRIM_MASK             (0x7000000U)
#define LPDAC_GCR_IREF_INT_TRIM_SHIFT            (24U)
/*! IREF_INT_TRIM - Internal Current Trim Register
 *  0b000..Invalid trim code. Keep at typical value
 *  0b001..Invalid trim code. Keep at typical value
 *  0b010..Current value -25%
 *  0b011..Current value -12.5%
 *  0b100..Typical value (default)
 *  0b101..Current value +12.5%
 *  0b110..Current value +25%
 *  0b111..Invalid trim code. Keep at typical value
 */
#define LPDAC_GCR_IREF_INT_TRIM(x)               (((uint32_t)(((uint32_t)(x)) << LPDAC_GCR_IREF_INT_TRIM_SHIFT)) & LPDAC_GCR_IREF_INT_TRIM_MASK)
/*! @} */
