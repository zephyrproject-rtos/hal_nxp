...
#define TPM_SC_TRIGCONF_MASK                     (0x200U)
#define TPM_SC_TRIGCONF_SHIFT                    (9U)
/*! TRIGCONF - Counter Trigger Configure
 *  0b0..Disable.
 *  0b1..Enable.
 */
#define TPM_SC_TRIGCONF(x)                       (((uint32_t)(((uint32_t)(x)) << TPM_SC_TRIGCONF_SHIFT)) & TPM_SC_TRIGCONF_MASK)

#define TPM_SC_CTRIGSEL_MASK                     (0x1F000000U)
...
#define TPM_TRIG_TRIGSEL_MASK                    (0x1F000000U)
...
#define TPM_CONF_TRGSEL_MASK                     (0x1F000000U)
#define TPM_CONF_TRGSEL_SHIFT                    (24U)
/*! TRGSEL - Trigger Select
 *  0b00001..Channel 0 pin input capture
 *  0b00010..Channel 1 pin input capture
 *  0b00011..Channel 0 or channel 1 pin input capture
 */
