...
typedef struct {
  ...
  __IO uint32_t USB1_MISC;                         /**< USBPHY Miscellaneous Control and Status, offset: 0xB0 */
  __IO uint32_t USB1_MISC_SET;                     /**< USBPHY Miscellaneous Control and Status, offset: 0xB4 */
  __IO uint32_t USB1_MISC_CLR;                     /**< USBPHY Miscellaneous Control and Status, offset: 0xB8 */
  __IO uint32_t USB1_MISC_TOG;                     /**< USBPHY Miscellaneous Control and Status, offset: 0xBC */
  ...
  __IO uint32_t TRIM_OVERRIDE_EN1;                 /**< USBPHY Trim Override Enable, offset: 0x160 */
  __IO uint32_t TRIM_OVERRIDE_EN1_SET;             /**< USBPHY Trim Override Enable, offset: 0x164 */
  __IO uint32_t TRIM_OVERRIDE_EN1_CLR;             /**< USBPHY Trim Override Enable, offset: 0x168 */
  __IO uint32_t TRIM_OVERRIDE_EN1_TOG;             /**< USBPHY Trim Override Enable, offset: 0x16C */
} USBPHY_Type;
...
#define USBPHY_PWD_TXPWDHSCURRENTGEN_MASK        (0x1U)
#define USBPHY_PWD_TXPWDHSCURRENTGEN_SHIFT       (0U)
/*! TXPWDHSCURRENTGEN - 17p78mA Current Block Powerdown
 *  0b0..Provide bias to enable for normal operation
 *  0b1..Disable or power down
 */
#define USBPHY_PWD_TXPWDHSCURRENTGEN(x)          (((uint32_t)(((uint32_t)(x)) << USBPHY_PWD_TXPWDHSCURRENTGEN_SHIFT)) & USBPHY_PWD_TXPWDHSCURRENTGEN_MASK)
...
#define USBPHY_PWD_SET_TXPWDHSCURRENTGEN_MASK    (0x1U)
#define USBPHY_PWD_SET_TXPWDHSCURRENTGEN_SHIFT   (0U)
/*! TXPWDHSCURRENTGEN - 17p78mA Current Block Powerdown */
#define USBPHY_PWD_SET_TXPWDHSCURRENTGEN(x)      (((uint32_t)(((uint32_t)(x)) << USBPHY_PWD_SET_TXPWDHSCURRENTGEN_SHIFT)) & USBPHY_PWD_SET_TXPWDHSCURRENTGEN_MASK)
...
#define USBPHY_PWD_CLR_TXPWDHSCURRENTGEN_MASK    (0x1U)
#define USBPHY_PWD_CLR_TXPWDHSCURRENTGEN_SHIFT   (0U)
/*! TXPWDHSCURRENTGEN - 17p78mA Current Block Powerdown */
#define USBPHY_PWD_CLR_TXPWDHSCURRENTGEN(x)      (((uint32_t)(((uint32_t)(x)) << USBPHY_PWD_CLR_TXPWDHSCURRENTGEN_SHIFT)) & USBPHY_PWD_CLR_TXPWDHSCURRENTGEN_MASK)
...
#define USBPHY_PWD_TOG_TXPWDHSCURRENTGEN_MASK    (0x1U)
#define USBPHY_PWD_TOG_TXPWDHSCURRENTGEN_SHIFT   (0U)
/*! TXPWDHSCURRENTGEN - 17p78mA Current Block Powerdown */
#define USBPHY_PWD_TOG_TXPWDHSCURRENTGEN(x)      (((uint32_t)(((uint32_t)(x)) << USBPHY_PWD_TOG_TXPWDHSCURRENTGEN_SHIFT)) & USBPHY_PWD_TOG_TXPWDHSCURRENTGEN_MASK)
 ...
 *  0b0xx..Disables post-divider output
 *  0b100..Divide value is 1
 *  0b101..Divide value is 2
 *  0b110..Divide value is 3
 *  0b111..Divide value is 4
 */
...
/*! @name USB1_MISC - USBPHY Miscellaneous Control and Status */
/*! @{ */

#define USBPHY_USB1_MISC_FS_CLKFRO_MASK          (0x100U)
#define USBPHY_USB1_MISC_FS_CLKFRO_SHIFT         (8U)
/*! FS_CLKFRO - Full-Speed Clock FRO
 *  0b0..Disables
 *  0b1..Enables
 */
#define USBPHY_USB1_MISC_FS_CLKFRO(x)            (((uint32_t)(((uint32_t)(x)) << USBPHY_USB1_MISC_FS_CLKFRO_SHIFT)) & USBPHY_USB1_MISC_FS_CLKFRO_MASK)
/*! @} */

/*! @name USB1_MISC_SET - USBPHY Miscellaneous Control and Status */
/*! @{ */

#define USBPHY_USB1_MISC_SET_FS_CLKFRO_MASK      (0x100U)
#define USBPHY_USB1_MISC_SET_FS_CLKFRO_SHIFT     (8U)
/*! FS_CLKFRO - Full-Speed Clock FRO */
#define USBPHY_USB1_MISC_SET_FS_CLKFRO(x)        (((uint32_t)(((uint32_t)(x)) << USBPHY_USB1_MISC_SET_FS_CLKFRO_SHIFT)) & USBPHY_USB1_MISC_SET_FS_CLKFRO_MASK)
/*! @} */

/*! @name USB1_MISC_CLR - USBPHY Miscellaneous Control and Status */
/*! @{ */

#define USBPHY_USB1_MISC_CLR_FS_CLKFRO_MASK      (0x100U)
#define USBPHY_USB1_MISC_CLR_FS_CLKFRO_SHIFT     (8U)
/*! FS_CLKFRO - Full-Speed Clock FRO */
#define USBPHY_USB1_MISC_CLR_FS_CLKFRO(x)        (((uint32_t)(((uint32_t)(x)) << USBPHY_USB1_MISC_CLR_FS_CLKFRO_SHIFT)) & USBPHY_USB1_MISC_CLR_FS_CLKFRO_MASK)
/*! @} */

/*! @name USB1_MISC_TOG - USBPHY Miscellaneous Control and Status */
/*! @{ */

#define USBPHY_USB1_MISC_TOG_FS_CLKFRO_MASK      (0x100U)
#define USBPHY_USB1_MISC_TOG_FS_CLKFRO_SHIFT     (8U)
/*! FS_CLKFRO - Full-Speed Clock FRO */
#define USBPHY_USB1_MISC_TOG_FS_CLKFRO(x)        (((uint32_t)(((uint32_t)(x)) << USBPHY_USB1_MISC_TOG_FS_CLKFRO_SHIFT)) & USBPHY_USB1_MISC_TOG_FS_CLKFRO_MASK)
/*! @} */
 ...
 *  0b000..Disable the comparators
 *  0b001..Enable the VBUS_VALID comparator
 *  0b010..Enable the SESS_VALID detection
 *  0b100..Enable the 3V detection
 */
...
/*! @name TRIM_OVERRIDE_EN1 - USBPHY Trim Override Enable */
/*! @{ */

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_OVERRIDE_MASK (0x1U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_OVERRIDE_SHIFT (0U)
/*! TXFS_DN45_OVERRIDE - Override Enable for FS Termination Resistor Trim
 *  0b0..Disables
 *  0b1..Enables
 */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_OVERRIDE_MASK (0x2U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_OVERRIDE_SHIFT (1U)
/*! TXFS_DP45_OVERRIDE - Override Enable for FS Termination Resistor Trim
 *  0b0..Disables
 *  0b1..Enables
 */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_OVERRIDE_MASK (0x4U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_OVERRIDE_SHIFT (2U)
/*! TXFS_SLEW_RATE_OVERRIDE - Override Enable for FS Slew Rate Trim
 *  0b0..Disables
 *  0b1..Enables
 */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_OVERRIDE_MASK (0x8U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_OVERRIDE_SHIFT (3U)
/*! TXHS_I17P78_OVERRIDE - Override Enable for Course Trim the 17p78mA Current
 *  0b0..Disables
 *  0b1..Enables
 */
#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_MASK  (0x30000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_SHIFT (16U)
/*! TXFS_DN45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45(x)    (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DN45_MASK (0xC0000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DN45_SHIFT (18U)
/*! TRIM_TXFS_DN45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_MASK  (0x300000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_SHIFT (20U)
/*! TXFS_DP45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45(x)    (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DP45_MASK (0xC00000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DP45_SHIFT (22U)
/*! TRIM_TXFS_DP45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_MASK (0x3000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_SHIFT (24U)
/*! TXFS_SLEW_RATE - trim the slew rate when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_SLEW_RATE_MASK (0xC000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_SLEW_RATE_SHIFT (26U)
/*! TRIM_TXFS_SLEW_RATE - trim the slew rate when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_MASK (0x30000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_SHIFT (28U)
/*! TXHS_I17P78 - trim the 17p78mA current when HS */
#define USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78(x)  (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TXHS_I17P78_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXHS_I17P78_MASK (0xC0000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXHS_I17P78_SHIFT (30U)
/*! TRIM_TXHS_I17P78 - trim the 17p78mA current when HS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TRIM_TXHS_I17P78_MASK)
/*! @} */

/*! @name TRIM_OVERRIDE_EN1_SET - USBPHY Trim Override Enable */
/*! @{ */

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_OVERRIDE_MASK (0x1U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_OVERRIDE_SHIFT (0U)
/*! TXFS_DN45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_OVERRIDE_MASK (0x2U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_OVERRIDE_SHIFT (1U)
/*! TXFS_DP45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_OVERRIDE_MASK (0x4U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_OVERRIDE_SHIFT (2U)
/*! TXFS_SLEW_RATE_OVERRIDE - Override Enable for FS Slew Rate Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_OVERRIDE_MASK (0x8U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_OVERRIDE_SHIFT (3U)
/*! TXHS_I17P78_OVERRIDE - Override Enable for Course Trim the 17p78mA Current */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_MASK (0x30000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_SHIFT (16U)
/*! TXFS_DN45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DN45_MASK (0xC0000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DN45_SHIFT (18U)
/*! TRIM_TXFS_DN45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_MASK (0x300000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_SHIFT (20U)
/*! TXFS_DP45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DP45_MASK (0xC00000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DP45_SHIFT (22U)
/*! TRIM_TXFS_DP45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_MASK (0x3000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_SHIFT (24U)
/*! TXFS_SLEW_RATE - trim the slew rate when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_SLEW_RATE_MASK (0xC000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_SLEW_RATE_SHIFT (26U)
/*! TRIM_TXFS_SLEW_RATE - trim the slew rate when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_MASK (0x30000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_SHIFT (28U)
/*! TXHS_I17P78 - trim the 17p78mA current when HS */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TXHS_I17P78_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXHS_I17P78_MASK (0xC0000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXHS_I17P78_SHIFT (30U)
/*! TRIM_TXHS_I17P78 - trim the 17p78mA current when HS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_SET_TRIM_TXHS_I17P78_MASK)
/*! @} */

/*! @name TRIM_OVERRIDE_EN1_CLR - USBPHY Trim Override Enable */
/*! @{ */

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_OVERRIDE_MASK (0x1U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_OVERRIDE_SHIFT (0U)
/*! TXFS_DN45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_OVERRIDE_MASK (0x2U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_OVERRIDE_SHIFT (1U)
/*! TXFS_DP45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_OVERRIDE_MASK (0x4U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_OVERRIDE_SHIFT (2U)
/*! TXFS_SLEW_RATE_OVERRIDE - Override Enable for FS Slew Rate Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_OVERRIDE_MASK (0x8U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_OVERRIDE_SHIFT (3U)
/*! TXHS_I17P78_OVERRIDE - Override Enable for Course Trim the 17p78mA Current */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_MASK (0x30000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_SHIFT (16U)
/*! TXFS_DN45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DN45_MASK (0xC0000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DN45_SHIFT (18U)
/*! TRIM_TXFS_DN45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_MASK (0x300000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_SHIFT (20U)
/*! TXFS_DP45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DP45_MASK (0xC00000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DP45_SHIFT (22U)
/*! TRIM_TXFS_DP45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_MASK (0x3000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_SHIFT (24U)
/*! TXFS_SLEW_RATE - trim the slew rate when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_SLEW_RATE_MASK (0xC000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_SLEW_RATE_SHIFT (26U)
/*! TRIM_TXFS_SLEW_RATE - trim the slew rate when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_MASK (0x30000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_SHIFT (28U)
/*! TXHS_I17P78 - trim the 17p78mA current when HS */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TXHS_I17P78_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXHS_I17P78_MASK (0xC0000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXHS_I17P78_SHIFT (30U)
/*! TRIM_TXHS_I17P78 - trim the 17p78mA current when HS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_CLR_TRIM_TXHS_I17P78_MASK)
/*! @} */

/*! @name TRIM_OVERRIDE_EN1_TOG - USBPHY Trim Override Enable */
/*! @{ */

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_OVERRIDE_MASK (0x1U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_OVERRIDE_SHIFT (0U)
/*! TXFS_DN45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_OVERRIDE_MASK (0x2U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_OVERRIDE_SHIFT (1U)
/*! TXFS_DP45_OVERRIDE - Override Enable for FS Termination Resistor Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_OVERRIDE_MASK (0x4U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_OVERRIDE_SHIFT (2U)
/*! TXFS_SLEW_RATE_OVERRIDE - Override Enable for FS Slew Rate Trim */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_OVERRIDE_MASK (0x8U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_OVERRIDE_SHIFT (3U)
/*! TXHS_I17P78_OVERRIDE - Override Enable for Course Trim the 17p78mA Current */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_OVERRIDE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_OVERRIDE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_MASK (0x30000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_SHIFT (16U)
/*! TXFS_DN45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DN45_MASK (0xC0000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DN45_SHIFT (18U)
/*! TRIM_TXFS_DN45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DN45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DN45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DN45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_MASK (0x300000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_SHIFT (20U)
/*! TXFS_DP45 - trim the termination resistor when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DP45_MASK (0xC00000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DP45_SHIFT (22U)
/*! TRIM_TXFS_DP45 - trim the termination resistor when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DP45(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DP45_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_DP45_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_MASK (0x3000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_SHIFT (24U)
/*! TXFS_SLEW_RATE - trim the slew rate when FS */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_SLEW_RATE_MASK (0xC000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_SLEW_RATE_SHIFT (26U)
/*! TRIM_TXFS_SLEW_RATE - trim the slew rate when FS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_SLEW_RATE(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_SLEW_RATE_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXFS_SLEW_RATE_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_MASK (0x30000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_SHIFT (28U)
/*! TXHS_I17P78 - trim the 17p78mA current when HS */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TXHS_I17P78_MASK)

#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXHS_I17P78_MASK (0xC0000000U)
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXHS_I17P78_SHIFT (30U)
/*! TRIM_TXHS_I17P78 - trim the 17p78mA current when HS from Outside USBPHY */
#define USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXHS_I17P78(x) (((uint32_t)(((uint32_t)(x)) << USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXHS_I17P78_SHIFT)) & USBPHY_TRIM_OVERRIDE_EN1_TOG_TRIM_TXHS_I17P78_MASK)
/*! @} */
