...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for XBAR0
**
 ...
 * @version 1.0
 * @date 2024-11-05
 * @brief CMSIS Peripheral Access Layer for XBAR0
 *
 * CMSIS Peripheral Access Layer for XBAR0
 */

#if !defined(PERI_XBAR0_H_)
#define PERI_XBAR0_H_                            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- XBAR0 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBAR0_Peripheral_Access_Layer XBAR0 Peripheral Access Layer
 * @{
 */

/** XBAR0 - Size of Registers Arrays */
#define XBAR0_SEL_COUNT                           11u

/** XBAR0 - Register Layout Typedef */
typedef struct {
  __IO uint32_t SEL[XBAR0_SEL_COUNT];              /**< Crossbar Select Register, array offset: 0x0, array step: 0x4 */
} XBAR0_Type;

/* ----------------------------------------------------------------------------
   -- XBAR0 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBAR0_Register_Masks XBAR0 Register Masks
 * @{
 */
...
#define XBAR0_SEL_SEL_MASK                       (0x3FU)
#define XBAR0_SEL_SEL_SHIFT                      (0U)
/*! SEL - SEL */
#define XBAR0_SEL_SEL(x)                         (((uint32_t)(((uint32_t)(x)) << XBAR0_SEL_SEL_SHIFT)) & XBAR0_SEL_SEL_MASK)

#define XBAR0_SEL_WP_MASK                        (0x80000000U)
#define XBAR0_SEL_WP_SHIFT                       (31U)
/*! WP - Write Protect
 *  0b0..Writing to this register is allowed.
 *  0b1..No further writing to this register is allowed.
 */
#define XBAR0_SEL_WP(x)                          (((uint32_t)(((uint32_t)(x)) << XBAR0_SEL_WP_SHIFT)) & XBAR0_SEL_WP_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group XBAR0_Register_Masks */


/*!
 * @}
 */ /* end of group XBAR0_Peripheral_Access_Layer */
