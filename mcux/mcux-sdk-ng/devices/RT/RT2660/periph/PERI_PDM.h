...
typedef struct {
  ...
  __I  uint32_t DATACH[PDM_DATACHN_COUNT];         /**< MICFIL Output Result, array offset: 0x20, array step: 0x4, irregular array, not all indices are valid */
...
#define PDM_CTRL_1_DELAY_NUM_MASK                (0x700U)
#define PDM_CTRL_1_DELAY_NUM_SHIFT               (8U)
 ...
 *  0b111..16 cycles
 */
#define PDM_CTRL_1_DELAY_NUM(x)                  (((uint32_t)(((uint32_t)(x)) << PDM_CTRL_1_DELAY_NUM_SHIFT)) & PDM_CTRL_1_DELAY_NUM_MASK)

#define PDM_CTRL_1_PDM_DELAY_MASK                (0x800U)
#define PDM_CTRL_1_PDM_DELAY_SHIFT               (11U)
/*! PDM_DELAY - PDM Delay Enable
 *  0b0..Disables
 *  0b1..Enables
 */
#define PDM_CTRL_1_PDM_DELAY(x)                  (((uint32_t)(((uint32_t)(x)) << PDM_CTRL_1_PDM_DELAY_SHIFT)) & PDM_CTRL_1_PDM_DELAY_MASK)
...
#define PDM_VAD0_CTRL_1_VADCHSEL_MASK            (0x1000000U)
#define PDM_VAD0_CTRL_1_VADCHSEL_SHIFT           (24U)
/*! VADCHSEL - Channel Selector
 *  0b0..PDM Microphone 0 Left
 *  0b1..PDM Microphone 0 Right
 */
