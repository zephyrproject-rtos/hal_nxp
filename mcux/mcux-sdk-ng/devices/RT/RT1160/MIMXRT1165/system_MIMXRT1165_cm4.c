...
**         pattern in the watchdog-disable sequence (SystemInit). Fix ported from the equivalent
**         MIMXRT1166 changes; not Coverity-verified locally because no in-tree board targets
**         MIMXRT1165.
**
** ###################################################################
*/
