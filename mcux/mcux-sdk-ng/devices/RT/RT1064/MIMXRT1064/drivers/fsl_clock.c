...
uint32_t CLOCK_GetPllFreq(clock_pll_t pll)
{
    ...
    {
        case kCLOCK_PllArm:
            freq = (uint32_t)((((uint64_t)freq * ((CCM_ANALOG->PLL_ARM & CCM_ANALOG_PLL_ARM_DIV_SELECT_MASK) >>
        ...
        case kCLOCK_PllSys:
            ...
            freq = (uint32_t)(((uint64_t)freq + (uint64_t)freqTmp) & 0xFFFFFFFFUL);
            break;
        ...
        case kCLOCK_PllAudio:
            ...
            freq = (uint32_t)((((uint64_t)freq * divSelect) + (uint64_t)freqTmp) & 0xFFFFFFFFUL);
        ...
        case kCLOCK_PllUsb2:
            freq = (uint32_t)(((uint64_t)freq *
                               (((CCM_ANALOG->PLL_USB2 & CCM_ANALOG_PLL_USB2_DIV_SELECT_MASK) != 0U) ? 22ULL : 20ULL)) &
                              0xFFFFFFFFUL);
            break;
        default:
            freq = 0U;
