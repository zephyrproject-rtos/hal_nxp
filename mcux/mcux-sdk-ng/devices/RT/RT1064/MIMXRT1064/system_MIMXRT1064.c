...
**         violations on PLL2MainClock += compute and on PLL2 PFD0/PFD2 freq computations.
**
** ###################################################################
*/
    ...
    else
    {
        ...
        switch (CCM->CBCMR & CCM_CBCMR_PRE_PERIPH_CLK_SEL_MASK)
        {
            ...
            case CCM_CBCMR_PRE_PERIPH_CLK_SEL(1U):
                freq = (uint32_t)(((uint64_t)(PLL2MainClock / ((CCM_ANALOG->PFD_528 & CCM_ANALOG_PFD_528_PFD2_FRAC_MASK) >>
            ...
            case CCM_CBCMR_PRE_PERIPH_CLK_SEL(2U):
                freq = (uint32_t)(((uint64_t)(PLL2MainClock / ((CCM_ANALOG->PFD_528 & CCM_ANALOG_PFD_528_PFD0_FRAC_MASK) >>
