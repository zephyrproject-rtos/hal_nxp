...
void SystemCoreClockUpdate (void) {
    ...
    else
    {
        ...
        {
            uint64_t tmpAdj = ((uint64_t)CPU_XTAL_CLK_HZ * ((uint64_t)(CCM_ANALOG->PLL_SYS_NUM))) /
                              ((uint64_t)(CCM_ANALOG->PLL_SYS_DENOM));
            uint64_t tmpSum = (uint64_t)PLL2MainClock + tmpAdj;
        ...
        switch (CCM->CBCMR & CCM_CBCMR_PRE_PERIPH_CLK_SEL_MASK)
        {
            ...
            case CCM_CBCMR_PRE_PERIPH_CLK_SEL(1U):
            {
                uint64_t tmpFreq = (uint64_t)PLL2MainClock /
                    ((CCM_ANALOG->PFD_528 & CCM_ANALOG_PFD_528_PFD2_FRAC_MASK) >> CCM_ANALOG_PFD_528_PFD2_FRAC_SHIFT) * 18UL;
            ...
            {
                uint64_t tmpFreq = (uint64_t)PLL2MainClock /
                    ((CCM_ANALOG->PFD_528 & CCM_ANALOG_PFD_528_PFD0_FRAC_MASK) >> CCM_ANALOG_PFD_528_PFD0_FRAC_SHIFT) * 18UL;
                freq = (tmpFreq > (uint64_t)UINT32_MAX) ? UINT32_MAX : (uint32_t)tmpFreq;
                break;
            }
