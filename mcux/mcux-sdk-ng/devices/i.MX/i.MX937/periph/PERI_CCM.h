...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x80 */
    __IO uint32_t CLOCK_ROOT_CONTROL;                /**< Clock Root Control, array offset: 0x0, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
    __IO uint32_t CLOCK_ROOT_CONTROL_SET;            /**< Clock Root Control, array offset: 0x4, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
    __IO uint32_t CLOCK_ROOT_CONTROL_CLR;            /**< Clock Root Control, array offset: 0x8, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
    __IO uint32_t CLOCK_ROOT_CONTROL_TOG;            /**< Clock Root Control, array offset: 0xC, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
         uint8_t RESERVED_0[16];
    __I  uint32_t STATUS0;                           /**< Clock Root Working Status, array offset: 0x20, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
         uint8_t RESERVED_1[12];
    __IO uint32_t AUTHEN;                            /**< Clock Root Access Control, array offset: 0x30, array step: 0x80, valid indices: [0-22, 24-35, 37-129] */
  ...
  struct {                                         /* offset: 0x8000, array step: 0x40 */
    __IO uint32_t DIRECT;                            /**< LPCG Direct Control, array offset: 0x8000, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
    __I  uint32_t LPM_STATUS0;                       /**< Low Power Mode Information Transfer Status, array offset: 0x8004, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
    __I  uint32_t LPM_STATUS1;                       /**< Low Power Mode Information Transfer Status, array offset: 0x8008, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
         uint8_t RESERVED_0[4];
    __IO uint32_t LPM0;                              /**< LPCG Low Power Mode Setting, array offset: 0x8010, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
    __IO uint32_t LPM1;                              /**< LPCG Low Power Mode Setting, array offset: 0x8014, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
         uint8_t RESERVED_1[4];
    __IO uint32_t LPM_CUR;                           /**< LPM Setting of Current CPU Domain, array offset: 0x801C, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
    __I  uint32_t STATUS0;                           /**< LPCG Working Status, array offset: 0x8020, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
    __I  uint32_t STATUS1;                           /**< LPCG Domain Status, array offset: 0x8024, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
         uint8_t RESERVED_2[8];
    __IO uint32_t AUTHEN;                            /**< LPCG Access Control, array offset: 0x8030, array step: 0x40, valid indices: [0-4, 6-25, 27-88, 90-91, 93-94, 96, 98-114, 116-131, 135-136, 138-143, 145-146, 148-225, 227-259] */
         uint8_t RESERVED_3[12];
  } LPCG[CCM_LPCG_COUNT];
...
/*! @name CLOCK_ROOT_CLOCK_ROOT_CONTROL - Clock Root Control */
/*! @{ */

#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_DIV_MASK (0xFFU)
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_DIV_SHIFT (0U)
/*! DIV - Clock division fraction. */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_DIV(x) (((uint32_t)(((uint32_t)(x)) << CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_DIV_SHIFT)) & CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_DIV_MASK)

#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_MUX_MASK (0x300U)
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_MUX_SHIFT (8U)
 ...
 */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_MUX(x) (((uint32_t)(((uint32_t)(x)) << CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_MUX_SHIFT)) & CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_MUX_MASK)

#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_OFF_MASK (0x1000000U)
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_OFF_SHIFT (24U)
/*! OFF - Shutdown clock root.
 *  0b0..Clock is running.
 *  0b1..Turn off clock.
 */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_OFF(x) (((uint32_t)(((uint32_t)(x)) << CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_OFF_SHIFT)) & CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_OFF_MASK)
/*! @} */

/* The count of CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_COUNT  (130U)

/* The count of CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_SET */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_SET_COUNT (130U)

/* The count of CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_CLR */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_CLR_COUNT (130U)

/* The count of CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_TOG */
#define CCM_CLOCK_ROOT_CLOCK_ROOT_CONTROL_TOG_COUNT (130U)
