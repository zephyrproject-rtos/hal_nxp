...
#define NETC_SW_BPCAPR_NUM_SBP_MASK              (0x1F0000U)
#define NETC_SW_BPCAPR_NUM_SBP_SHIFT             (16U)
#define NETC_SW_BPCAPR_NUM_SBP(x)                (((uint32_t)(((uint32_t)(x)) << NETC_SW_BPCAPR_NUM_SBP_SHIFT)) & NETC_SW_BPCAPR_NUM_SBP_MASK)
/*! @} */
