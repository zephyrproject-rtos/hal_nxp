...
typedef struct {
       uint8_t RESERVED_0[393740];
  __IO uint16_t LANE0_DIG_ANA_RX_VCO_OVRD_OUT_0;   /**< RX VCO Outgoing Signals Override ANA #0, offset: 0x6020C */
       uint8_t RESERVED_1[6];
  __IO uint16_t LANE0_DIG_ANA_RX_VCO_OVRD_OUT_2;   /**< RX VCO Outgoing Signals Override ANA #2, offset: 0x60214 */
} ENET_PHY_Type;
