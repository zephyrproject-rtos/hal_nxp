...
typedef struct {
  ...
  __IO uint32_t CSSR0;                             /**< Core Sticky Status 0, offset: 0x18, not available in all instances (available on 2450 out of 2500) */
  __I  uint32_t CSR0;                              /**< Core Status 0, offset: 0x1C, not available in all instances (available on 2450 out of 2500) */
