...
/*! tx_txd2_clk_from_io_sel - RMII REF_CLK pad selection via TXD2/TX_CLK path
 *  0b0..TX_CLK pad path select
 *  0b1..TXD2 pad path select
 */
...
#define BLK_CTRL_NETCMIX_EXT_PIN_CONTROL_gpr_ethX_rmii_ref50_clk_out_en_MASK (0x80U)
#define BLK_CTRL_NETCMIX_EXT_PIN_CONTROL_gpr_ethX_rmii_ref50_clk_out_en_SHIFT (7U)
/*! gpr_ethX_rmii_ref50_clk_out_en - Port5 RMII Reference clock direction control
 *  0b0..Input from pad
 *  0b1..Output driven by SoC (50 MHz)
 */
#define BLK_CTRL_NETCMIX_EXT_PIN_CONTROL_gpr_ethX_rmii_ref50_clk_out_en(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_NETCMIX_EXT_PIN_CONTROL_gpr_ethX_rmii_ref50_clk_out_en_SHIFT)) & BLK_CTRL_NETCMIX_EXT_PIN_CONTROL_gpr_ethX_rmii_ref50_clk_out_en_MASK)
/*! @} */
