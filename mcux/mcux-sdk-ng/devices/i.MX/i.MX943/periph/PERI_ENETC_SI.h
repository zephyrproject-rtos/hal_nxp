...
typedef struct {
  ...
  __IO uint32_t SIMCAR;                            /**< Station interface message cache attribute register, offset: 0x44, not available in all instances (available on 50 out of 350) */
  ...
  union {                                          /* offset: 0x204 */
    struct {                                         /* offset: 0x204 */
      __IO uint32_t PSIMSGRR;                          /**< Physical station interface message receive register, offset: 0x204, not available in all instances (available on 50 out of 350) */
      __IO uint32_t PSIMSGSR;                          /**< Physical station interface message send register, offset: 0x208, not available in all instances (available on 50 out of 350) */
           uint8_t RESERVED_0[4];
      struct {                                         /* offset: 0x210, array step: 0x8 */
        __IO uint32_t PSIVMSGRCVAR0;                     /**< PSI VSI 1 message receive address register 0..PSI VSI 3 message receive address register 0, array offset: 0x210, array step: 0x8, not available in all instances (available on 50 out of 350) */
        __IO uint32_t PSIVMSGRCVAR1;                     /**< PSI VSI 1 message receive address register 1..PSI VSI 3 message receive address register 1, array offset: 0x214, array step: 0x8, not available in all instances (available on 50 out of 350) */
      } VSI_NUM[ENETC_SI_MSGSR_PSI_A_VSI_NUM_COUNT];
    } PSI_A;
    struct {                                         /* offset: 0x204 */
      __I  uint32_t VSIMSGSR;                          /**< Virtual station interface message send register, offset: 0x204, not available in all instances (available on 150 out of 350) */
      __I  uint32_t VSIMSGRR;                          /**< Virtual station interface message receive register, offset: 0x208, not available in all instances (available on 150 out of 350) */
           uint8_t RESERVED_0[4];
      __IO uint32_t VSIMSGSNDAR0;                      /**< Virtual station interface message address send register 0, offset: 0x210, not available in all instances (available on 150 out of 350) */
      __IO uint32_t VSIMSGSNDAR1;                      /**< Virtual station interface message send address register 1, offset: 0x214, not available in all instances (available on 150 out of 350) */
    } VSI_A;
  };
  ...
  __I  uint32_t SIBLPR[ENETC_SI_SI_BOOT_LOAD_COUNT]; /**< Station interface boot loader parameter register 0..Station interface boot loader parameter register 1, array offset: 0x3F0, array step: 0x4, not available in all instances (available on 150 out of 350) */
  ...
  union {                                          /* offset: 0xA00 */
    struct {                                         /* offset: 0xA00 */
      __IO uint32_t PSIIER;                            /**< Physical station interface interrupt enable register, offset: 0xA00, not available in all instances (available on 50 out of 350) */
           uint8_t RESERVED_0[4];
      __IO uint32_t PSIIDR;                            /**< Physical station interface interrupt detect register, offset: 0xA08, not available in all instances (available on 50 out of 350) */
    } PSI;
    struct {                                         /* offset: 0xA00 */
      __IO uint32_t VSIIER;                            /**< Virtual station interface interrupt enable register, offset: 0xA00, not available in all instances (available on 150 out of 350) */
           uint8_t RESERVED_0[4];
      __IO uint32_t VSIIDR;                            /**< Virtual station interface interrupt detect register, offset: 0xA08, not available in all instances (available on 150 out of 350) */
    } VSI;
  };
  ...
  __IO uint32_t SIMSIVR;                           /**< Station interface MSI-X vector register, offset: 0xA30, not available in all instances (available on 200 out of 350) */
