...
typedef struct {
  ...
  __IO uint32_t PLPMR;                             /**< Port low power mode register, offset: 0x340, not available in all instances (available on 150 out of 200) */
  __I  uint32_t PWOSR;                             /**< Port wake-on status register, offset: 0x344, not available in all instances (available on 150 out of 200) */
  ...
  __IO uint32_t SMHRBDRMR[NETC_ENETC_NUM_SMHRBDRMR_COUNT]; /**< Switch management host reason 1 receive BD ring mapping register..Switch management host reason 15 receive BD ring mapping register, array offset: 0x880, array step: 0x4, not available in all instances (available on 50 out of 200) */
  ...
  struct {                                         /* offset: 0x2000, array step: 0x80 */
    ...
    __IO uint32_t PSICFGR1;                          /**< Port station interface 1 configuration register 1..Port station interface 3 configuration register 1, array offset: 0x2014, array step: 0x80, not available in all instances (available on 50 out of 200), valid indices: [1-3] */
