...
#define FSL_FEATURE_XCACHE_HAS_NO_WRITE_BUF (0)
...
/* @brief If (e)FlexPWM MASK register has UPDATE_MASK bit field. Note: This feature value is not the same on all PWM instances. */
