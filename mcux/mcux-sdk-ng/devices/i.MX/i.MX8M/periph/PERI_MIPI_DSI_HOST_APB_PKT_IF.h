...
/*!
 * @file MIPI_DSI_HOST_APB_PKT_IF.h
 * @version 4.0
 * @date 2018-01-26
...
#if !defined(MIPI_DSI_HOST_APB_PKT_IF_H_)
#define MIPI_DSI_HOST_APB_PKT_IF_H_              /**< Symbol preventing repeated inclusion */
...
#endif  /* MIPI_DSI_HOST_APB_PKT_IF_H_ */
