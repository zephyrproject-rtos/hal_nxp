...
MEMORY
{
  ...
  iram1_8_seg :                       	org = 0x00008A3C, len = 0x17DC4
  dram1_0_seg :                       	org = 0x00820000, len = 0x14000
...
_memmap_seg_iram1_8_max   = 0x20800;
_memmap_seg_dram1_0_start = 0x820000;
_memmap_seg_dram1_0_max   = 0x834000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x834000);
  _heap_sentry = 0x834000;
