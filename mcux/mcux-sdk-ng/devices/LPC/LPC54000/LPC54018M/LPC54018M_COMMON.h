...
#if !defined(LPC54018M_COMMON_H_)
#define LPC54018M_COMMON_H_                      /**< Symbol preventing repeated inclusion */
...
#include "system_LPC54018M.h"          /* Device specific configuration file */
