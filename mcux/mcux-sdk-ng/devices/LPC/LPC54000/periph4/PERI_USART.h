...
/*! DATA - The USART Receiver Data register contains the next received character. The number of bits
...
/*! RXDATA - The USART Receiver Data register contains the next received character. The number of
...
/*! TXDATA - Writing to the USART Transmit Data Register causes the data to be transmitted as soon
 *    as the transmit shift register is available and any conditions for transmitting data are met:
 ...
 *    the input clock from the FRG. 0 = The FRG clock is used directly by the USART function. 1 =
 *    The FRG clock is divided by 2 before use by the USART function. 2 = The FRG clock is divided by
 *    3 before use by the USART function. ... 0xFFFF = The FRG clock is divided by 65,536 before
...
/*! OSRVAL - Oversample Selection Value. 0 to 3 = not supported 0x4 = 5 peripheral clocks are used
 *    to transmit and receive each data bit. 0x5 = 6 peripheral clocks are used to transmit and
 *    receive each data bit. ... 0xF= 16 peripheral clocks are used to transmit and receive each data bit.
 */
