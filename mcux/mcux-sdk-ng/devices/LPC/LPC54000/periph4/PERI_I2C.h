...
typedef struct {
  ...
  __IO uint32_t SLVADR[I2C_SLVADR_COUNT];          /**< Slave address 0., array offset: 0x48, array step: 0x4 */
 ...
 *    clocks, as defined by the CLKDIV register. To change this value while I 2C is in operation,
 ...
 *    32 counts of the I2C function clock. ... 0xFFF = A time-out will occur after 65,536 counts of
...
/*! DIVVAL - This field controls how the clock (PCLK) is used by the I2C functions that need an
 *    internal clock in order to operate. 0x0000 = PCLK is used directly by the I2C. 0x0001 = PCLK is
 *    divided by 2 before use. 0x0002 = PCLK is divided by 3 before use. ... 0xFFFF = PCLK is divided
