...
#if !defined(LPC5516_COMMON_H_)
#define LPC5516_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_LPC5516.h"            /* Device specific configuration file */
