...
typedef struct {
  ...
  __IO uint32_t DATA_DEST;                         /**< Key Destination, offset: 0x20 */
  ...
  __IO uint32_t SEC_LOCK;                          /**< Lock the security level of PUF block until key generate, wrap or unwrap operation is completed., offset: 0x104 */
...
/*! @name DATA_DEST - Key Destination */
/*! @{ */
...
#define PUF_DATA_DEST_DEST_KO_MASK               (0x2U)
#define PUF_DATA_DEST_DEST_KO_SHIFT              (1U)
/*! DEST_KO - Key available via the KO interface */
#define PUF_DATA_DEST_DEST_KO(x)                 (((uint32_t)(((uint32_t)(x)) << PUF_DATA_DEST_DEST_KO_SHIFT)) & PUF_DATA_DEST_DEST_KO_MASK)
/*! @} */
...
/*! @name SEC_LOCK - Lock the security level of PUF block until key generate, wrap or unwrap operation is completed. */
/*! @{ */
