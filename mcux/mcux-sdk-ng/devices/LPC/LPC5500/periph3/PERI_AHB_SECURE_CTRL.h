...
#define AHB_SECURE_CTRL_SEC_CTRL_RAM3_SEC_CTRL_RAM3_MEM_RULE_COUNT 1u
...
typedef struct {
  ...
  struct {                                         /* offset: 0xB0, array step: 0x14 */
    __IO uint32_t SLAVE_RULE;                        /**< Security access rules for RAM3 slaves., array offset: 0xB0, array step: 0x14 */
         uint8_t RESERVED_0[12];
    __IO uint32_t MEM_RULE[AHB_SECURE_CTRL_SEC_CTRL_RAM3_SEC_CTRL_RAM3_MEM_RULE_COUNT];   /**< Security access rules for RAM3., array offset: 0xC0, array step: index*0x14, index2*0x4 */
...
/*! RAM3_RULE - Security access rules for the whole RAM3 : 0x2001_0000 - 0x2001_3FFF
 *  0b00..Non-secure and Non-priviledge user access allowed.
 *  0b01..Non-secure and Privilege access allowed.
 *  0b10..Secure and Non-priviledge user access allowed.
 *  0b11..Secure and Priviledge user access allowed.
...
/*! @name SEC_CTRL_RAM3_MEM_RULE - Security access rules for RAM3. */
/*! @{ */
...
/* The count of AHB_SECURE_CTRL_SEC_CTRL_RAM3_MEM_RULE */
#define AHB_SECURE_CTRL_SEC_CTRL_RAM3_MEM_RULE_COUNT2 (1U)
