...
__vector_table_0x1c
        ...
        DCD     FTM0_IRQHandler                               ;FlexTimer0 interrupt
        DCD     FTM1_IRQHandler                               ;FlexTimer1 interrupt
        DCD     I2C0_IRQHandler                               ;I2C0 interrupt
        DCD     Reserved25_IRQHandler                         ;Reserved interrupt
        DCD     MRT0_IRQHandler                               ;Multi-rate timer interrupt
        DCD     ACMP_IRQHandler                               ;Analog comparator interrupt
        ...
        DCD     GPIO_HS_IRQ0_IRQHandler                       ;GPIO group A interrupt
        DCD     GPIO_HS_IRQ1_IRQHandler                       ;GPIO group B interrupt
...
I3C0_IRQHandler
        ...
        PUBWEAK GPIO_HS_IRQ0_IRQHandler
        PUBWEAK GPIO_HS_IRQ0_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
GPIO_HS_IRQ0_IRQHandler
        LDR     R0, =GPIO_HS_IRQ0_DriverIRQHandler
        BX      R0

        PUBWEAK GPIO_HS_IRQ1_IRQHandler
        PUBWEAK GPIO_HS_IRQ1_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
