...
if (CONFIG_MCUX_PRJSEG_config.dsp56800.ef)
    ...
    mcux_add_codewarrior_configuration(
        CC "-D__CORE_56800EF__"
    )

    mcux_add_codewarrior_configuration(
        TARGETS flash_sdm_spm_debug flash_sdm_spm_release
        LD "-l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/spm/sdm/v4/o4p/librt.lib\" \
            -l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/spm/sdm/v4/o4p/libc.lib\""
    )
    mcux_add_codewarrior_configuration(
    ...
    mcux_add_codewarrior_configuration(
        ...
        LD "-l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/hpm/sdm/v4/o4p/librt.lib\" \
            -l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/hpm/sdm/v4/o4p/libc.lib\""
    )
    mcux_add_codewarrior_configuration(
    ...
    mcux_add_codewarrior_configuration(
        ...
        LD "-l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/hpm/ldm/v4/o4p/librt.lib\" \
            -l\"${MCUToolsBaseDir}/DSP56800x_EABI_Tools/lib/hpm/ldm/v4/o4p/libc.lib\""
    )
endif()