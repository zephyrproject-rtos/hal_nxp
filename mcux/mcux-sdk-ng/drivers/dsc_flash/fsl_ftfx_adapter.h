...
#define FSL_FEATURE_FLASH_FLEX_RAM_SIZE                        FSL_FEATURE_FTFA_FLEX_RAM_SIZE
#define FSL_FEATURE_FLASH_FLEX_RAM_START_ADDRESS               FSL_FEATURE_FTFA_FLEX_RAM_START_ADDRESS
#define FSL_FEATURE_FLASH_HAS_ACCESS_CONTROL                   FSL_FEATURE_FTFA_HAS_ACCESS_CONTROL
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_COUNT                   FSL_FEATURE_FTFA_PFLASH_BLOCK_COUNT
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SECTOR_SIZE             FSL_FEATURE_FTFA_PFLASH_BLOCK_SECTOR_SIZE
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SIZE                    FSL_FEATURE_FTFA_PFLASH_BLOCK_SIZE
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_WRITE_UNIT_SIZE         FSL_FEATURE_FTFA_PFLASH_BLOCK_WRITE_UNIT_SIZE
#define FSL_FEATURE_FLASH_PFLASH_CHECK_CMD_ADDRESS_ALIGMENT    FSL_FEATURE_FTFA_PFLASH_CHECK_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_PROTECTION_REGION_COUNT       FSL_FEATURE_FTFA_PFLASH_PROTECTION_REGION_COUNT
#define FSL_FEATURE_FLASH_PFLASH_RESOURCE_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FTFA_PFLASH_RESOURCE_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT  FSL_FEATURE_FTFA_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT   FSL_FEATURE_FTFA_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_START_ADDRESS                 FSL_FEATURE_FTFA_PFLASH_START_ADDRESS
#define FSL_FEATURE_FLASH_PFLASH_SWAP_CONTROL_CMD_ADDRESS_ALIGMENT \
    FSL_FEATURE_FTFA_PFLASH_SWAP_CONTROL_CMD_ADDRESS_ALIGMENT
...
#define FSL_FEATURE_FLASH_FLEX_RAM_SIZE                        FSL_FEATURE_FTFL_FLEX_RAM_SIZE
#define FSL_FEATURE_FLASH_FLEX_RAM_START_ADDRESS               FSL_FEATURE_FTFL_FLEX_RAM_START_ADDRESS
#define FSL_FEATURE_FLASH_HAS_ACCESS_CONTROL                   FSL_FEATURE_FTFL_HAS_ACCESS_CONTROL
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_COUNT                   FSL_FEATURE_FTFL_PFLASH_BLOCK_COUNT
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SECTOR_SIZE             FSL_FEATURE_FTFL_PFLASH_BLOCK_SECTOR_SIZE
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SIZE                    FSL_FEATURE_FTFL_PFLASH_BLOCK_SIZE
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_WRITE_UNIT_SIZE         FSL_FEATURE_FTFL_PFLASH_BLOCK_WRITE_UNIT_SIZE
#define FSL_FEATURE_FLASH_PFLASH_CHECK_CMD_ADDRESS_ALIGMENT    FSL_FEATURE_FTFL_PFLASH_CHECK_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_PROTECTION_REGION_COUNT       FSL_FEATURE_FTFL_PFLASH_PROTECTION_REGION_COUNT
#define FSL_FEATURE_FLASH_PFLASH_RESOURCE_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FTFL_PFLASH_RESOURCE_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT  FSL_FEATURE_FTFL_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT   FSL_FEATURE_FTFL_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT
#define FSL_FEATURE_FLASH_PFLASH_START_ADDRESS                 FSL_FEATURE_FTFL_PFLASH_START_ADDRESS
#define FSL_FEATURE_FLASH_PFLASH_SWAP_CONTROL_CMD_ADDRESS_ALIGMENT \
    FSL_FEATURE_FTFL_PFLASH_SWAP_CONTROL_CMD_ADDRESS_ALIGMENT
#if defined(FSL_FEATURE_FLASH_HAS_FLEX_RAM) && FSL_FEATURE_FLASH_HAS_FLEX_RAM
...
#define flash_security_state_t               ftfx_security_state_t
#define kFLASH_PropertyPflashBlockBaseAddr   kFLASH_PropertyPflash0BlockBaseAddr
#define kFLASH_PropertyPflashTotalSize       kFLASH_PropertyPflash0TotalSize
#define kFLASH_PropertyPflashSectorSize      kFLASH_PropertyPflash0SectorSize
#define kFLASH_SecurityStateNotSecure        kFTFx_SecurityStateNotSecure
#define kFLASH_SecurityStateBackdoorEnabled  kFTFx_SecurityStateBackdoorEnabled
#define kFLASH_SecurityStateBackdoorDisabled kFTFx_SecurityStateBackdoorDisabled
#define kFLASH_MarginValueUser               kFTFx_MarginValueUser
