...
#define kFTFx_ApiEraseKey 0x6B65666BUL
...
/*!
 * @brief Macro for the two possible options of flash read resource command.
 */
#define kFTFx_ResourceOptionFlashIfr 0x00U /*!< Select code for Program flash 0 IFR, Program flash swap 0 IFR, Data flash 0 IFR */
#define kFTFx_ResourceOptionVersionId 0x01U /*!< Select code for the version ID*/

/*!
 * @brief Macro for supported FTFx margin levels.
 */
#define kFTFx_MarginValueNormal 0x0U
#define kFTFx_MarginValueUser 0x1U    /*!< Apply the 'User' margin to the normal read-1 level.*/
#define kFTFx_MarginValueFactory 0x2U /*!< Apply the 'Factory' margin to the normal read-1 level.*/
#define kFTFx_MarginValueInvalid 0x3U /*!< Not real margin level, Used to determine the range of valid margin level. */
