...
#ifndef FSL_DSC_FMU_FLASH_H_
#define FSL_DSC_FMU_FLASH_H_
...
#define FSL_FLASH_DRIVER_VERSION (MAKE_VERSION(1, 0, 0)) /*!< Version 2.3.3. */
...
{
    msf1_config_t flash[FLASH_FEATURE_ARRAY_COUNT];
} flash_config_t;
