 ...
 */
#ifndef FSL_TSI_V2_H_
#define FSL_TSI_V2_H_
...
#define ALL_FLAGS_MASK (TSI_GENCS_EOSF_MASK | TSI_GENCS_OUTRGF_MASK | TSI_GENCS_EXTERF_MASK | TSI_GENCS_OVRF_MASK)
...
static inline void TSI_EnableLowPower(TSI_Type *base, bool enable)
{
    ...
    {
        base->GENCS =
            (base->GENCS & ~ALL_FLAGS_MASK) & (~TSI_GENCS_STPE_MASK); /* Disable module in low power stop mode */
    }
}
