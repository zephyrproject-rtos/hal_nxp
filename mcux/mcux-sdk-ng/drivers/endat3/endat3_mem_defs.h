...
#define ENDAT3_MEM_XEL_DEVICEFEATURE_SUPP_OFFSETPOS_TYPE   uint16_t
...
#define ENDAT3_MEM_XEL_DEVICEFEATURE_SUPP_OFFSETPOS_SHIFT   2
...
#define ENDAT3_MEM_XEL_DEVICEFEATURE_SUPP_OFFSETPOS_MASK 1
...
#define ENDAT3_MEM_CACHE_WRITE_SET_BUSADDRESS(cache, val)  do { \
             ...
             *(ENDAT3_MEM_SET_BUSADDRESS_TYPE *)(((cache)->cacheMem) + (ENDAT3_MEM_SET_BUSADDRESS_OFFSET)) |= \
			 ...
			 ENDAT3_memCacheSetDirty(cache, ENDAT3_MEM_SET_BUSADDRESS_OFFSET, 1); \
          } while(0)
