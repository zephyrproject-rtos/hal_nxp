...
#define INJECT_CHANNEL(ch)                                                                                        \
    switch (word)                                                                                                 \
    {                                                                                                             \
        SET_##ch##_1 SET_##ch##_2 SET_##ch##_3 SET_##ch##_4 SET_##ch##_5 SET_##ch##_6 default : assert((_Bool)0); \
        break;                                                                                                    \
    }                                                                                                             \
    break;
...
#define GET_CHANNEL(ch)                                                                                           \
    switch (word)                                                                                                 \
    {                                                                                                             \
        GET_##ch##_1 GET_##ch##_2 GET_##ch##_3 GET_##ch##_4 GET_##ch##_5 GET_##ch##_6 default : assert((_Bool)0); \
        break;                                                                                                    \
    }                                                                                                             \
    break;
