...
/*****************************************************************************
 * PHY YT8521 driver change log
 *****************************************************************************/

/*!
@page driver_log Driver Change Log

@section phyyt8521 PHYYT8521
  The current PHYYT8521 driver version is 2.0.0.

  - 2.0.0
    - Initial version.
*/

#ifndef _FSL_PHYYT8521_H_
#define _FSL_PHYYT8521_H_
...
typedef struct _phy_yt8521_resource
{
    mdioWrite write;
    mdioRead read;
} phy_yt8521_resource_t;

extern const phy_operations_t phyyt8521_ops;
