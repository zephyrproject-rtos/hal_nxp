...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template/SEGGER_RTT_Conf.h ${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template driver_rtt_template.MCXA276)
...
if (CONFIG_USE_DEVICES_Project_Template_MCXA276)
# Add set(CONFIG_USE_DEVICES_Project_Template_MCXA276 true) in config.cmake to use this component

message("DEVICES_Project_Template_MCXA276 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_lpuart_adapter AND (CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_device_MCXA276_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_gpio AND CONFIG_USE_driver_lpuart AND CONFIG_USE_driver_port AND CONFIG_USE_driver_mcx_spc AND CONFIG_USE_driver_reset AND ((CONFIG_USE_component_serial_manager AND CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console) OR (CONFIG_USE_utility_assert_lite AND CONFIG_USE_utility_debug_console_lite)))

add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MCXA276.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MCXA276.MCXA276)
...
message(SEND_ERROR "DEVICES_Project_Template_MCXA276.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MCXA276_startup)
# Add set(CONFIG_USE_device_MCXA276_startup true) in config.cmake to use this component

message("device_MCXA276_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_device_MCXA276_system)

if(CONFIG_TOOLCHAIN STREQUAL armgcc)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./gcc/startup_MCXA276.S "" device_MCXA276_startup.MCXA276)
endif()

if(CONFIG_TOOLCHAIN STREQUAL mcux)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_mcxa276.c "" device_MCXA276_startup.MCXA276)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_mcxa276.cpp "" device_MCXA276_startup.MCXA276)
endif()

else()

message(SEND_ERROR "device_MCXA276_startup.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MCXA276_CMSIS)
# Add set(CONFIG_USE_device_MCXA276_CMSIS true) in config.cmake to use this component

message("device_MCXA276_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_CMSIS_Include_core_cm)
...
message(SEND_ERROR "device_MCXA276_CMSIS.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_edma4)

add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.MCXA276)
...
message(SEND_ERROR "RTE_Device.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_mcx_spc AND CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_clock.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma_soc AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_edma4.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_edma_soc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_lpi2c AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_lpi2c_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_lpspi AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_lpspi_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_lpuart AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_lpuart_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_lpspi_edma AND (CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_lpspi AND CONFIG_USE_CMSIS_Driver_Include_SPI AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpspi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_lpi2c_edma AND (CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_lpi2c AND CONFIG_USE_CMSIS_Driver_Include_I2C AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpi2c.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_lpuart_edma AND (CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_lpuart AND CONFIG_USE_CMSIS_Driver_Include_USART AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpuart.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexcan AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_flexcan_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dbi_flexio_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_trdc_soc AND (CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_trdc_1.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexio_uart AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_flexio_uart_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexio_spi AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_flexio_spi_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_edma4 AND CONFIG_USE_driver_flexio_mculcd AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_flexio_mculcd_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_reset AND CONFIG_USE_driver_clock AND CONFIG_USE_device_MCXA276_CMSIS)
...
message(SEND_ERROR "driver_common.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_inputmux_connections.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_debug_console.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_common AND CONFIG_USE_utility_str)
...
message(SEND_ERROR "utility_debug_console_lite.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert_lite.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MCXA276_system)
# Add set(CONFIG_USE_device_MCXA276_system true) in config.cmake to use this component

message("device_MCXA276_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_device_MCXA276_CMSIS)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/./system_MCXA276.c
)
...
message(SEND_ERROR "device_MCXA276_system.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_trdc_soc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_reset.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_dac_1.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_opamp.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_uart.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_spi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "driver_flexio_mculcd.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_i2c_master.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcan.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_waketimer.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_romapi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mcx_vbat.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mcx_spc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mcx_cmc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cdog.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_glikey.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_crc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpcmp.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpadc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i3c_edma.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i3c.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpspi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpspi_freertos.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart_freertos.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpi2c.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpi2c_freertos.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lptmr.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_freqme.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_eqdc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pwm.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ostimer.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_utick.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wwdt.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ctimer.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_aoi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_erm.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_eim.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wuu.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MCXA276) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_inputmux_connections)
...
message(SEND_ERROR "driver_inputmux.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gpio.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_port.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rtt.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_mflash_common AND CONFIG_USE_driver_romapi AND (CONFIG_DEVICE_ID STREQUAL MCXA276))
...
message(SEND_ERROR "component_mflash_mcxa.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_video-common.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dbi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gt911.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_st7796s.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ssd1963.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_spi.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_usb_cdc.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_swo.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpspi_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpuart_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpuart_dma_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_messaging.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_light.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_freertos.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_panic.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_reset_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_timer_manager.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_gpio_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_led.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_button.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpi2c_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ctimer_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lptmr_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ostimer_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lptmr_time_stamp_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ctimer_time_stamp_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ostimer_time_stamp_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_bus.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_bus_adapter.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_shell.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_power_manager_core.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_BOARD_Project_Template_frdmmcxa276_a8974)
# Add set(CONFIG_USE_BOARD_Project_Template_frdmmcxa276_a8974 true) in config.cmake to use this component

message("BOARD_Project_Template_frdmmcxa276_a8974 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_gpio_adapter AND CONFIG_USE_component_lists AND CONFIG_USE_component_lpi2c_adapter AND CONFIG_USE_component_lpuart_adapter AND CONFIG_USE_component_serial_manager AND CONFIG_USE_component_serial_manager_uart AND CONFIG_USE_device_MCXA276_CMSIS AND CONFIG_USE_device_MCXA276_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_gpio AND CONFIG_USE_driver_inputmux AND CONFIG_USE_driver_lpi2c AND CONFIG_USE_driver_lpuart AND CONFIG_USE_driver_port AND CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console)

add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/clock_config.c "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/clock_config.h "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/pin_mux.c "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/pin_mux.h "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/peripherals.c "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/peripherals.h "" BOARD_Project_Template_frdmmcxa276_a8974.MCXA276)

target_include_directories(${MCUX_SDK_PROJECT_NAME} PUBLIC
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa276_a8974/project_template/.
)

else()

message(SEND_ERROR "BOARD_Project_Template_frdmmcxa276_a8974.MCXA276 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
