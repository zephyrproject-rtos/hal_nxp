 ...
 *                          MCUXpresso Compiler
 *
 *     Reference manual:    Rev. 7, 11/2022
...
__attribute__ ((weak)) void SystemInit(void)
{
	 ...
	 */
	ARM_MPU_SetRegionEx(MPU, SMU2_MAIR_IDX, SMU2_CM33_BASE_ADDR,
	 ...
	 */
	ARM_MPU_SetMemAttrEx(MPU, SMU2_MAIR_IDX,
			     ARM_MPU_ATTR(ARM_MPU_ATTR_NON_CACHEABLE, ARM_MPU_ATTR_NON_CACHEABLE));
#endif

#if defined(USE_PB_RAM_AS_SYSTEM_MEMORY)
	/* See Step 1 from USE_SMU2_AS_SYSTEM_MEMORY */
	ARM_MPU_SetRegionEx(MPU, PB_RAM_MAIR_IDX, PB_RAM_CM33_BASE_ADDR,
			    PB_RAM_CM33_END_ADDR | (MPU_RLAR_EN_Msk << MPU_RLAR_EN_Pos) |
			    (PB_RAM_MAIR_IDX << MPU_RLAR_AttrIndx_Pos));
	/* See Step 2 from USE_SMU2_AS_SYSTEM_MEMORY */
	ARM_MPU_SetMemAttrEx(MPU, PB_RAM_MAIR_IDX,
			     ARM_MPU_ATTR(ARM_MPU_ATTR_NON_CACHEABLE, ARM_MPU_ATTR_NON_CACHEABLE));
#endif
#if defined(USE_SMU2_AS_SYSTEM_MEMORY) || defined(USE_PB_RAM_AS_SYSTEM_MEMORY)
	/*
