...
#define CLOCK_IP_FSS_SERVICES_AGENT_TIMEOUT_VALUE_US                (0)

#define CLOCK_IP_FSS_SERVICES_AGENT_LOGICAL_CHANNEL            (0)
...
extern const Clock_Ip_ClockConfigType Clock_Ip_aClockConfig[1U];
