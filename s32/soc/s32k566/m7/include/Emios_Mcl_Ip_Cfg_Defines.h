...
#if (STD_ON == EMIOS_MCL_IP_ICU_SUPPORT_EMIOS)
#include "Emios_Icu_Ip_Cfg.h"
#endif
#if (STD_ON == EMIOS_MCL_IP_PWM_SUPPORT_EMIOS)
...
#define EMIOS_MCL_IP_CFG_DEFINES_SW_MAJOR_VERSION                0
#define EMIOS_MCL_IP_CFG_DEFINES_SW_MINOR_VERSION                8
...
/*-----------------------------------------------/
/  EMIOS HARDWARE INSTANCES                      /
/-----------------------------------------------*/
#define EMIOS_MCL_IP_EMIOS_HW_INST_0            ((uint8)(0U))
#define EMIOS_MCL_IP_EMIOS_HW_INST_1            ((uint8)(1U))
#define EMIOS_MCL_IP_EMIOS_HW_INST_2            ((uint8)(2U))
