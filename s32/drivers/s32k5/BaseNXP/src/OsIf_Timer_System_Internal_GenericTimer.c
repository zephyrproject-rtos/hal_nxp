...
/**
*   @file OsIf_Timer_System_Internal_GenericTimer.c
*   @version 0.8.0
*
*   @brief   BaseNXP - Implements the driver functionality.
*   @details Implements the APIs for Generic timer.
*
*   @addtogroup osif_drv
*   @{
*/
...
#define OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MINOR_VERSION_C     9
...
{
    uint32 u32CurrentVal = GENERICTIMER_GET_COUNTER();
    uint32 u32Dif = 0U;

    if (GENERICTIMER_OVERFLOWED(u32CurrentVal, *CurrentRef))
    {
        /* Overflow occurred */
        u32Dif = GENERICTIMER_DELTA_OUTER(u32CurrentVal, *CurrentRef, GENERICTIMER_TVAL_MAX);
    }
    else
    {
        /* Overflow did not occur */
        u32Dif = GENERICTIMER_DELTA_INNER(*CurrentRef, u32CurrentVal);
    }
