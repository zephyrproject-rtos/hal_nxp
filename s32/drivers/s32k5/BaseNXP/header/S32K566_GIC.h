 ...
 * @version 1.3
 * @date 2024-07-21
 * @brief Peripheral Access Layer for S32K566_GIC
 *
...
#if !defined(S32K566_GIC_H_)  /* Check if memory map has not been already included */
#define S32K566_GIC_H_
...
#endif  /* #if !defined(S32K566_GIC_H_) */
