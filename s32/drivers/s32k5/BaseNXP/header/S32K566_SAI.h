 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32K566_SAI
 *
...
#if !defined(S32K566_SAI_H_)  /* Check if memory map has not been already included */
#define S32K566_SAI_H_
...
#endif  /* #if !defined(S32K566_SAI_H_) */
