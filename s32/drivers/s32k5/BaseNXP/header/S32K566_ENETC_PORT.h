...
/*!
 * @file S32K566_ENETC_PORT.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32K566_ENETC_PORT
 *
...
#if !defined(S32K566_ENETC_PORT_H_)  /* Check if memory map has not been already included */
#define S32K566_ENETC_PORT_H_
...
#endif  /* #if !defined(S32K566_ENETC_PORT_H_) */
