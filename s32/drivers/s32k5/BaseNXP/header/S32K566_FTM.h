 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32K566_FTM
 *
...
#if !defined(S32K566_FTM_H_)  /* Check if memory map has not been already included */
#define S32K566_FTM_H_
...
#endif  /* #if !defined(S32K566_FTM_H_) */
