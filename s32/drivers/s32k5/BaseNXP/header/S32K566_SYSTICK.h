...
/*!
 * @file S32K566_SYSTICK.h
 * @version 1.3
 * @date 2024-06-14
 * @brief Peripheral Access Layer for S32K566_SYSTICK
 *
...
#if !defined(S32K566_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32K566_SYSTICK_H_
...
#endif  /* #if !defined(S32K566_SYSTICK_H_) */
