...
#define EMIOS_MCL_IP_SW_MAJOR_VERSION             0
#define EMIOS_MCL_IP_SW_MINOR_VERSION             8
...
/**
 * @brief  Global time base enable control
 * @details This function select the global time base output of the EMIOS instances available on the platform which enable the global time base input for EMIOS instance.
 *
 * @param[in] Instance    Instance of EMIOS used.
 * @param[in] Selection   The EMIOS instances are selected.
 * @return void
 */
