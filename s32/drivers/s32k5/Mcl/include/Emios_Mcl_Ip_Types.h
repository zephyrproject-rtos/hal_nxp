...
#define EMIOS_MCL_IP_TYPES_SW_MAJOR_VERSION                0
#define EMIOS_MCL_IP_TYPES_SW_MINOR_VERSION                8
...
typedef enum
{
    EMIOS_IP_NONE_EMIOS_SELECTED             = 0U,   /**< @brief The Mcl Emios doesn't select emios intance for global time base control. */
    EMIOS_IP_EMIOS0_SELECTED                 = 1U,   /**< @brief The Mcl Emios selects emios intance 0 for global time base control.  */
    EMIOS_IP_EMIOS1_SELECTED                 = 2U,   /**< @brief The Mcl Emios selects emios intance 1 for global time base control.  */
    EMIOS_IP_EMIOS2_SELECTED                 = 4U,   /**< @brief The Mcl Emios selects emios intance 2 for global time base control.  */
    EMIOS_IP_EMIOS0_1_SELECTED               = 3U,   /**< @brief The Mcl Emios selects emios intance 0 and 1 for global time base control.  */
    EMIOS_IP_EMIOS0_2_SELECTED               = 5U,   /**< @brief The Mcl Emios selects emios intance 0 and 2 for global time base control.  */
    EMIOS_IP_EMIOS1_2_SELECTED               = 6U,   /**< @brief The Mcl Emios selects emios intance 1 and 2 for global time base control.  */
    EMIOS_IP_EMIOS0_1_2_SELECTED             = 7U,   /**< @brief The Mcl Emios selects emios intance 0, 1 and 2 for global time base control.  */

} Emios_Ip_SelectGlobalTimebaseEnType;
...
typedef struct
{
    ...
    const Emios_Ip_SelectGlobalTimebaseEnType   selectGlobalTimeBaseEnable;   /**< Select global timebase enablement   */
