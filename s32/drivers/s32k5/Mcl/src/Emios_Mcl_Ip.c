...
#define EMIOS_MCL_IP_SW_MAJOR_VERSION_C                0
#define EMIOS_MCL_IP_SW_MINOR_VERSION_C                8
...
Emios_Ip_CommonStatusType Emios_Mcl_Ip_Init(uint8 Instance, const Emios_Mcl_Ip_ConfigType* const ConfigPtr)
{
    ...
    if (Emios_Ip_axIpIsInitialized[Instance].runCore == UserId)
    {
        ...
        else
        {
            ...
            Emios_Mcl_Ip_SelectGlobalTimebaseEn(Instance, ConfigPtr->emiosGlobalConfig->selectGlobalTimeBaseEnable);
...
/** @implements Emios_Mcl_Ip_SelectGlobalTimebaseEn_Activity */
void Emios_Mcl_Ip_SelectGlobalTimebaseEn(uint8 Instance, Emios_Ip_SelectGlobalTimebaseEnType Selection)
{
    K566_GPR1_Type*           GPR1_Base = IP_GPR_1;
    uint32                    reg = GPR1_Base->GPR_RWF_1;

#if (STD_ON == EMIOS_MCL_IP_DEV_ERROR_DETECT)
    DevAssert(Instance < eMIOS_INSTANCE_COUNT);
    DevAssert(Selection <= EMIOS_IP_EMIOS0_1_2_SELECTED);
#endif

    switch (Instance)
    {
        case EMIOS_MCL_IP_EMIOS_HW_INST_0:
            GPR1_Base->GPR_RWF_1 = ((reg & (~(K566_GPR1_GPR_RWF_1_TIME_BASE_EN0_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN1_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN2_MASK))) | (K566_GPR1_GPR_RWF_1_TIME_BASE_EN0(Selection) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN1(Selection >> 1U) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN2(Selection >> 2U)));
        break;
        case EMIOS_MCL_IP_EMIOS_HW_INST_1:
            GPR1_Base->GPR_RWF_1 = ((reg & (~(K566_GPR1_GPR_RWF_1_TIME_BASE_EN3_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN4_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN5_MASK))) | (K566_GPR1_GPR_RWF_1_TIME_BASE_EN3(Selection) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN4(Selection >> 1U) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN5(Selection >> 2U)));
        break;
        case EMIOS_MCL_IP_EMIOS_HW_INST_2:
            GPR1_Base->GPR_RWF_1 = ((reg & (~(K566_GPR1_GPR_RWF_1_TIME_BASE_EN6_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN7_MASK | K566_GPR1_GPR_RWF_1_TIME_BASE_EN8_MASK))) | (K566_GPR1_GPR_RWF_1_TIME_BASE_EN6(Selection) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN7(Selection >> 1U) | K566_GPR1_GPR_RWF_1_TIME_BASE_EN8(Selection >> 2U)));
        break;
        default:
            /* Do nothing */
        break;
