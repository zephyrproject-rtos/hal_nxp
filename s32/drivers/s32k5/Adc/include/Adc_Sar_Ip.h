...
#define ADC_SAR_IP_SW_MAJOR_VERSION               0
#define ADC_SAR_IP_SW_MINOR_VERSION               8
...
/*!
 * @brief Configure data conversion mode
 *
 * This function configures the used data conversion mode.
 *
 * @param [in] u32Instance - ADC instance number
 * @param [in] eCType - selected data conversion mode
 * @return status:
 *  - ADC_SAR_IP_STATUS_SUCCESS: set successful
 *  - ADC_SAR_IP_STATUS_ERROR: Adc Instance is not in IDLE state
 */
