...
#define ADC_SAR_IP_SW_MAJOR_VERSION_TYPES               0
#define ADC_SAR_IP_SW_MINOR_VERSION_TYPES               8
...
/**
* @brief          Adc data conversion.
* @details        Used for value received by Tressos interface configuration.
*/
typedef enum
{
    ADC_SAR_IP_DATA_CONV_SINGLE_ENDED      = 0U,    /**< @brief Single-ended data conversion mode */
    ADC_SAR_IP_DATA_CONV_RESERVED          = 1U,    /**< @brief Reserved */
    ADC_SAR_IP_DATA_CONV_DIFFERENTIAL_P_M  = 2U,    /**< @brief Differential data conversion mode */
    ADC_SAR_IP_DATA_CONV_DUAL_SINGLE_ENDED = 3U     /**< @brief Dual single-ended data conversion mode */
} Adc_Sar_Ip_DataConvType;
/*!
...
typedef struct
{
    uint16 AdcSTAWVBGHighVal;       /* Adc STAWVBG threshold high value */
    uint16 AdcSTAWVBGLowVal;        /* Adc STAWVBG threshold low value */
    uint16 AdcSTAWVDDIHighVal;      /* Adc STAWVDDI threshold high value */
    uint16 AdcSTAWVDDILowVal;       /* Adc STAWVDDI threshold low value */
    uint16 AdcSTAWVDDFHighVal;      /* Adc STAWVDDF threshold high value */
    uint16 AdcSTAWVDDFLowVal;       /* Adc STAWVDDF threshold low value */
    uint16 AdcSTAWVRHLLowVal;       /* Adc STAWVRHL threshold low value */
    sint16 AdcSTAWOFSHighVal;       /* Adc STAWOFS threshold high value */
    sint16 AdcSTAWOFSLowVal;        /* Adc STAWOFS threshold low value */
    sint16 AdcSTAWCAPMHighVal;      /* Adc STAWCAPM threshold high value */
    sint16 AdcSTAWCAPMLowVal;       /* Adc STAWCAPM threshold low value */
    sint16 AdcSTAWCAPIHighVal;      /* Adc STAWCAPI threshold high value */
    sint16 AdcSTAWCAPILowVal;       /* Adc STAWCAPI threshold low value */
    sint16 AdcSTAWCAPLHighVal;      /* Adc STAWCAPL threshold high value */
    sint16 AdcSTAWCAPLLowVal;       /* Adc STAWCAPL threshold low value */
    uint8 AdcSTAWVRHLCompVal;       /* Adc STAWVRHL low comparison value */
    uint8 AdcSTAWVRHLCorrVal;       /* Adc STAWVRHL high correction value */
