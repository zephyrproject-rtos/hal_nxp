 ...
 * @version 1.3
 * @date 2021-07-14
 * @brief Peripheral Access Layer for S32Z27_GIC
 *
...
#if !defined(S32Z27_GIC_H_)  /* Check if memory map has not been already included */
#define S32Z27_GIC_H_
...
#endif  /* #if !defined(S32Z27_GIC_H_) */
