...
/*!
 * @file S32Z2_CE_DMAMUX.h
 * @version 1.8
 * @date 2022-07-13
 * @brief Peripheral Access Layer for S32Z2_CE_DMAMUX
 *
...
#if !defined(S32Z2_CE_DMAMUX_H_)  /* Check if memory map has not been already included */
#define S32Z2_CE_DMAMUX_H_
...
#endif  /* #if !defined(S32Z2_CE_DMAMUX_H_) */
