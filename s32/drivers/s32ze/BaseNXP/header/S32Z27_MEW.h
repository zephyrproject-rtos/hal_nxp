 ...
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_MEW
 *
...
#if !defined(S32Z27_MEW_H_)  /* Check if memory map has not been already included */
#define S32Z27_MEW_H_
...
typedef struct {
  __IO uint32_t ECC_GLBL_CTRL;                     /**< AXI ECC Global Control Register, offset: 0x0 */
  __IO uint32_t ECC_MX_EPA;                        /**< AXI ECC Maximum ECC protected address register, offset: 0x4 */
  __IO uint32_t ECC_MN_EPA;                        /**< AXI ECC Minimum ECC protected address register, offset: 0x8 */
  __IO uint32_t ECC_LK_PTN;                        /**< AXI ECC Lock Pattern Register, offset: 0xC */
  __IO uint32_t ECC_ULK_PTN;                       /**< AXI ECC Unlock Pattern Register, offset: 0x10 */
  uint8_t RESERVED_0[4];
  __I  uint32_t ECC_EERAR;                         /**< ECC Error Report Address Register, offset: 0x18 */
  __I  uint32_t ECC_EERDSR[MEW_ECC_EERDSR_COUNT];  /**< AXI ECC Error Report Data and Syndrome Register, array offset: 0x1C, array step: 0x4 */
  __IO uint32_t ECC_ERR_IE;                        /**< AXI ECC error interrupt enable, offset: 0x2C */
  __IO uint32_t ECC_ERR_IN_STCLR;                  /**< AXI ECC error Interupt status and clear register, offset: 0x30 */
  __IO uint32_t EDC_ERR_IE;                        /**< AXI EDC Error interrupt enable register, offset: 0x34 */
  __IO uint32_t EDC_ERR_IN_STCLR;                  /**< AXI EDC Error Interrupt Status and Clear register, offset: 0x38 */
  uint8_t RESERVED_1[4];
  __IO uint32_t ECC_SHD_STAT_CTRL;                 /**< Shadow Control, RW path Status and Status Clear Register, offset: 0x40 */
  __I  uint32_t ECC_CBL_UNCBL_BIT_EC;              /**< Correctable and un-correctable bit error counter, offset: 0x44 */
  __I  uint32_t ECC_CBL_UCBL_BEAT_EC;              /**< Correctable and un-correctable beat error counter, offset: 0x48 */
  uint8_t RESERVED_2[52];
  __IO uint32_t ECC_DBG_CTRL;                      /**< Debug and Debug Control Register, offset: 0x80 */
...
/*! @name ECC_GLBL_CTRL - AXI ECC Global Control Register */
/*! @{ */
...
/*! @name ECC_MX_EPA - AXI ECC Maximum ECC protected address register */
/*! @{ */
...
/*! @name ECC_MN_EPA - AXI ECC Minimum ECC protected address register */
/*! @{ */
...
/*! @name ECC_LK_PTN - AXI ECC Lock Pattern Register */
/*! @{ */
...
/*! @name ECC_ULK_PTN - AXI ECC Unlock Pattern Register */
/*! @{ */
...
/*! @name ECC_EERAR - ECC Error Report Address Register */
/*! @{ */
...
/*! @name ECC_EERDSR - AXI ECC Error Report Data and Syndrome Register */
/*! @{ */
...
/*! @name ECC_ERR_IN_STCLR - AXI ECC error Interupt status and clear register */
/*! @{ */
...
/*! @name EDC_ERR_IE - AXI EDC Error interrupt enable register */
/*! @{ */
...
/*! @name EDC_ERR_IN_STCLR - AXI EDC Error Interrupt Status and Clear register */
/*! @{ */
...
/*! @name ECC_SHD_STAT_CTRL - Shadow Control, RW path Status and Status Clear Register */
/*! @{ */
...
/*! @name ECC_CBL_UNCBL_BIT_EC - Correctable and un-correctable bit error counter */
/*! @{ */
...
/*! @name ECC_CBL_UCBL_BEAT_EC - Correctable and un-correctable beat error counter */
/*! @{ */
...
/*! @name ECC_DBG_CTRL - Debug and Debug Control Register */
/*! @{ */
...
#endif  /* #if !defined(S32Z27_MEW_H_) */
