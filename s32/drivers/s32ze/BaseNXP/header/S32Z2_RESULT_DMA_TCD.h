...
typedef struct {
  struct RESULT_DMA_TCD_TCD {                      /* offset: 0x0, array step: 0x1000 */
...
#define RESULT_DMA_TCD_CH_CSR_EBW_MASK           (0x8U)
#define RESULT_DMA_TCD_CH_CSR_EBW_SHIFT          (3U)
#define RESULT_DMA_TCD_CH_CSR_EBW_WIDTH          (1U)
#define RESULT_DMA_TCD_CH_CSR_EBW(x)             (((uint32_t)(((uint32_t)(x)) << RESULT_DMA_TCD_CH_CSR_EBW_SHIFT)) & RESULT_DMA_TCD_CH_CSR_EBW_MASK)
