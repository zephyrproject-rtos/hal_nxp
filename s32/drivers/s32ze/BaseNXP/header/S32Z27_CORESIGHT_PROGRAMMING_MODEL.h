...
/*!
 * @file S32Z27_CORESIGHT_PROGRAMMING_MODEL.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_CORESIGHT_PROGRAMMING_MODEL
 *
...
#if !defined(S32Z27_CORESIGHT_PROGRAMMING_MODEL_H_)  /* Check if memory map has not been already included */
#define S32Z27_CORESIGHT_PROGRAMMING_MODEL_H_
...
/** Peripheral CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL base address */
#define IP_CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL_BASE (0x24400FD0u)
/** Peripheral CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL base pointer */
#define IP_CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL ((CORESIGHT_PROGRAMMING_MODEL_Type *)IP_CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL_BASE)
/** Array initializer of CORESIGHT_PROGRAMMING_MODEL peripheral base addresses */
#define IP_CORESIGHT_PROGRAMMING_MODEL_BASE_ADDRS { IP_CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL_BASE }
/** Array initializer of CORESIGHT_PROGRAMMING_MODEL peripheral base pointers */
#define IP_CORESIGHT_PROGRAMMING_MODEL_BASE_PTRS { IP_CEVA_SPF2__CORESIGHT_PROGRAMMING_MODEL }
...
#endif  /* #if !defined(S32Z27_CORESIGHT_PROGRAMMING_MODEL_H_) */
