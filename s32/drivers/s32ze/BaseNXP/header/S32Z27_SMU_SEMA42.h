...
/*!
 * @file S32Z27_SMU_SEMA42.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_SMU_SEMA42
 *
...
#if !defined(S32Z27_SMU_SEMA42_H_)  /* Check if memory map has not been already included */
#define S32Z27_SMU_SEMA42_H_
...
typedef struct {
  __IO uint8_t GATE[SMU_SEMA42_GATE_COUNT];        /**< Gate Register, array offset: 0x0, array step: 0x1 */
...
#define SMU_SEMA42_R_ROZ_MASK                    (0xC000U)
#define SMU_SEMA42_R_ROZ_SHIFT                   (14U)
#define SMU_SEMA42_R_ROZ_WIDTH                   (2U)
#define SMU_SEMA42_R_ROZ(x)                      (((uint16_t)(((uint16_t)(x)) << SMU_SEMA42_R_ROZ_SHIFT)) & SMU_SEMA42_R_ROZ_MASK)
/*! @} */
...
#endif  /* #if !defined(S32Z27_SMU_SEMA42_H_) */
