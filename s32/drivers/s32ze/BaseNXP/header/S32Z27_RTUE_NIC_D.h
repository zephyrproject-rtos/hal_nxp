...
/*!
 * @file S32Z27_RTUE_NIC_D.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_RTUE_NIC_D
 *
...
#if !defined(S32Z27_RTUE_NIC_D_H_)  /* Check if memory map has not been already included */
#define S32Z27_RTUE_NIC_D_H_
...
#endif  /* #if !defined(S32Z27_RTUE_NIC_D_H_) */
