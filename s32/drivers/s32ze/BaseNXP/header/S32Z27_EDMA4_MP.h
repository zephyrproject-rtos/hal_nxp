...
/*!
 * @file S32Z27_EDMA4_MP.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_EDMA4_MP
 *
...
#if !defined(S32Z27_EDMA4_MP_H_)  /* Check if memory map has not been already included */
#define S32Z27_EDMA4_MP_H_
...
#define EDMA4_MP_CSR_ECX_MASK                    (0x100U)
#define EDMA4_MP_CSR_ECX_SHIFT                   (8U)
#define EDMA4_MP_CSR_ECX_WIDTH                   (1U)
#define EDMA4_MP_CSR_ECX(x)                      (((uint32_t)(((uint32_t)(x)) << EDMA4_MP_CSR_ECX_SHIFT)) & EDMA4_MP_CSR_ECX_MASK)

#define EDMA4_MP_CSR_CX_MASK                     (0x200U)
#define EDMA4_MP_CSR_CX_SHIFT                    (9U)
#define EDMA4_MP_CSR_CX_WIDTH                    (1U)
#define EDMA4_MP_CSR_CX(x)                       (((uint32_t)(((uint32_t)(x)) << EDMA4_MP_CSR_CX_SHIFT)) & EDMA4_MP_CSR_CX_MASK)
...
#endif  /* #if !defined(S32Z27_EDMA4_MP_H_) */
