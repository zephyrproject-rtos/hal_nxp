...
#if !defined(S32Z27_COMMON_H_)  /* Check if memory map has not been already included */
#define S32Z27_COMMON_H_
#define MCU_S32Z27

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32Z27 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  SMU_SWT1_IRQn                = 10,               /**< Watchdog timer interrupt */
  SMU_STM1_IRQn                = 11,               /**< Single vector for all 4 channels */
  SMU_CE_CTI_0_IRQn            = 12,               /**< CTI interrupt[0] */
  SMU_CE_CTI_1_IRQn            = 13,               /**< CTI interrupt[1] */
  SMU_CE_MCM_IRQn              = 14,               /**< Cortex M33 interrupt for FPU events and TCM errors */
  ...
  SMU_ERM0_SBEC_IRQn           = 26,               /**< Single bit ECC error */
  SMU_ERM0_MBEC_IRQn           = 27,               /**< Multi bit ECC error */
...
typedef enum {
  ...
  /* Core interrupts */
  FLEXLLCE_CE_NonMaskableInt_IRQn      = -14,      /**< Non Maskable Interrupt */
  FLEXLLCE_CE_HardFault_IRQn           = -13,      /**< Cortex-M33 SV Hard Fault Interrupt */
  FLEXLLCE_CE_MemoryManagement_IRQn    = -12,      /**< Cortex-M33 Memory Management Interrupt */
  FLEXLLCE_CE_BusFault_IRQn            = -11,      /**< Cortex-M33 Bus Fault Interrupt */
  FLEXLLCE_CE_UsageFault_IRQn          = -10,      /**< Cortex-M33 Usage Fault Interrupt */
  FLEXLLCE_CE_SVCall_IRQn              = -5,       /**< Cortex-M33 SV Call Interrupt */
  FLEXLLCE_CE_DebugMonitor_IRQn        = -4,       /**< Cortex-M33 Debug Monitor Interrupt */
  FLEXLLCE_CE_PendSV_IRQn              = -2,       /**< Cortex-M33 Pend SV Interrupt */
  FLEXLLCE_CE_SysTick_IRQn             = -1,       /**< Cortex-M33 System Tick Interrupt */
  /* Device specific interrupts */
  FLEXLLCE_CE_SWT0_IRQn                = 0,        /**< Watchdog timer interrupt */
  FLEXLLCE_CE_STM0_IRQn                = 1,        /**< Single vector for all 4 channels */
  FLEXLLCE_CE_CTI_0_IRQn               = 2,        /**< CTI interrupt[0] */
  FLEXLLCE_CE_CTI_1_IRQn               = 3,        /**< CTI interrupt[1] */
  FLEXLLCE_CE_MCM_IRQn                 = 4,        /**< Cortex M33 interrupt for FPU events and TCM errors */
  FLEXLLCE_CE_SWT1_IRQn                = 10,       /**< Watchdog timer interrupt */
  FLEXLLCE_CE_STM1_IRQn                = 11,       /**< Single vector for all 4 channels */
  FLEXLLCE_CE_CE_CTI_0_IRQn            = 12,       /**< CTI interrupt[0] */
  FLEXLLCE_CE_CE_CTI_1_IRQn            = 13,       /**< CTI interrupt[1] */
  FLEXLLCE_CE_CE_MCM_IRQn              = 14,       /**< Cortex M33 interrupt for FPU events and TCM errors */
  FLEXLLCE_CE_CMU_FC_EIC_IRQn          = 20,       /**< Error Injection Complete */
  FLEXLLCE_CE_CE_CMU_FC_IRQn           = 21,       /**< Fault Injection Complete */
  FLEXLLCE_CE_STM2_IRQn                = 22,       /**< Single vector for all 4 channels */
  FLEXLLCE_CE_ERM2_SBEC_IRQn           = 24,       /**< Single bit ECC error */
  FLEXLLCE_CE_ERM2_MBEC_IRQn           = 25,       /**< Multi bit ECC error */
  FLEXLLCE_CE_ERM0_SBEC_IRQn           = 26,       /**< Single bit ECC error */
  FLEXLLCE_CE_ERM0_MBEC_IRQn           = 27,       /**< Multi bit ECC error */
  FLEXLLCE_CE_ERM1_SBEC_IRQn           = 28,       /**< Single bit ECC error */
  FLEXLLCE_CE_ERM1_MBEC_IRQn           = 29,       /**< Multi bit ECC error */
  FLEXLLCE_CE_XRDC_IRQn                = 31,       /**< xRDC.TBD Error Interrupt */
  FLEXLLCE_CE_C_VFCCU_CFRI0_IRQn       = 40,       /**< Central FCCU reaction index0 */
  FLEXLLCE_CE_C_VFCCU_CFRI1_IRQn       = 41,       /**< Central FCCU reaction index1 */
  FLEXLLCE_CE_C_VFCCU_CFRI2_IRQn       = 42,       /**< Central FCCU reaction index2 */
  FLEXLLCE_CE_C_VFCCU_CFR13_IRQn       = 43,       /**< Central FCCU reaction index3 */
...
#endif  /* #if !defined(S32Z27_COMMON_H_) */
