...
/*!
 * @file S32Z27_CAN_TBS.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_CAN_TBS
 *
...
#if !defined(S32Z27_CAN_TBS_H_)  /* Check if memory map has not been already included */
#define S32Z27_CAN_TBS_H_
...
typedef struct {
  __I  uint32_t CAN_TB_VALUE;                      /**< CAN Time Bus Output Value, offset: 0x0 */
...
/*! @name CAN_TB_VALUE - CAN Time Bus Output Value */
/*! @{ */
...
#endif  /* #if !defined(S32Z27_CAN_TBS_H_) */
