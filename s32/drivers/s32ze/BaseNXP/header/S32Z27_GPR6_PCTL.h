...
/*!
 * @file S32Z27_GPR6_PCTL.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_GPR6_PCTL
 *
...
#if !defined(S32Z27_GPR6_PCTL_H_)  /* Check if memory map has not been already included */
#define S32Z27_GPR6_PCTL_H_
...
#endif  /* #if !defined(S32Z27_GPR6_PCTL_H_) */
