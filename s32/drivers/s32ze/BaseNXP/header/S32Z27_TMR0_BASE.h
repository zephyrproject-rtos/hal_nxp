...
/*!
 * @file S32Z27_TMR0_BASE.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_TMR0_BASE
 *
...
#if !defined(S32Z27_TMR0_BASE_H_)  /* Check if memory map has not been already included */
#define S32Z27_TMR0_BASE_H_
...
#endif  /* #if !defined(S32Z27_TMR0_BASE_H_) */
