...
/*!
 * @file S32Z27_CORESIGHT_OCEM.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_CORESIGHT_OCEM
 *
...
#if !defined(S32Z27_CORESIGHT_OCEM_H_)  /* Check if memory map has not been already included */
#define S32Z27_CORESIGHT_OCEM_H_
...
/** Peripheral CEVA_SPF2__CORESIGHT_OCEM base address */
#define IP_CEVA_SPF2__CORESIGHT_OCEM_BASE        (0x24400CFCu)
/** Peripheral CEVA_SPF2__CORESIGHT_OCEM base pointer */
#define IP_CEVA_SPF2__CORESIGHT_OCEM             ((CORESIGHT_OCEM_Type *)IP_CEVA_SPF2__CORESIGHT_OCEM_BASE)
/** Array initializer of CORESIGHT_OCEM peripheral base addresses */
#define IP_CORESIGHT_OCEM_BASE_ADDRS             { IP_CEVA_SPF2__CORESIGHT_OCEM_BASE }
/** Array initializer of CORESIGHT_OCEM peripheral base pointers */
#define IP_CORESIGHT_OCEM_BASE_PTRS              { IP_CEVA_SPF2__CORESIGHT_OCEM }
...
#endif  /* #if !defined(S32Z27_CORESIGHT_OCEM_H_) */
