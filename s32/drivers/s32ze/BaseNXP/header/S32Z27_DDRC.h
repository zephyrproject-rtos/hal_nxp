 ...
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_DDRC
 *
...
#if !defined(S32Z27_DDRC_H_)  /* Check if memory map has not been already included */
#define S32Z27_DDRC_H_
...
#define DDRC_DDR_SDRAM_CFG_BE_8_MASK             (0x40000U)
#define DDRC_DDR_SDRAM_CFG_BE_8_SHIFT            (18U)
#define DDRC_DDR_SDRAM_CFG_BE_8_WIDTH            (1U)
#define DDRC_DDR_SDRAM_CFG_BE_8(x)               (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_CFG_BE_8_SHIFT)) & DDRC_DDR_SDRAM_CFG_BE_8_MASK)
...
#endif  /* #if !defined(S32Z27_DDRC_H_) */
