...
/*!
 * @file S32Z27_CMU_FC.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_CMU_FC
 *
...
#if !defined(S32Z27_CMU_FC_H_)  /* Check if memory map has not been already included */
#define S32Z27_CMU_FC_H_
...
#endif  /* #if !defined(S32Z27_CMU_FC_H_) */
