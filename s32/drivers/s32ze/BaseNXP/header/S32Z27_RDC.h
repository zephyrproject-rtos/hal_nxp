 ...
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_RDC
 *
...
#if !defined(S32Z27_RDC_H_)  /* Check if memory map has not been already included */
#define S32Z27_RDC_H_
...
#endif  /* #if !defined(S32Z27_RDC_H_) */
