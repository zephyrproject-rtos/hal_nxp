...
/*!
 * @file S32Z27_SMU_SRG_S.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_SMU_SRG_S
 *
...
#if !defined(S32Z27_SMU_SRG_S_H_)  /* Check if memory map has not been already included */
#define S32Z27_SMU_SRG_S_H_
...
#endif  /* #if !defined(S32Z27_SMU_SRG_S_H_) */
