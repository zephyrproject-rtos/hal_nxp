...
/*!
 * @file S32Z27_PSI5_S.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_PSI5_S
 *
...
#if !defined(S32Z27_PSI5_S_H_)  /* Check if memory map has not been already included */
#define S32Z27_PSI5_S_H_
...
#endif  /* #if !defined(S32Z27_PSI5_S_H_) */
