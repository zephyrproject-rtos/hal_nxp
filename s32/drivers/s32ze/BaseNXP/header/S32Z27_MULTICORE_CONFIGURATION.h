...
/*!
 * @file S32Z27_MULTICORE_CONFIGURATION.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_MULTICORE_CONFIGURATION
 *
...
#if !defined(S32Z27_MULTICORE_CONFIGURATION_H_)  /* Check if memory map has not been already included */
#define S32Z27_MULTICORE_CONFIGURATION_H_
...
#endif  /* #if !defined(S32Z27_MULTICORE_CONFIGURATION_H_) */
