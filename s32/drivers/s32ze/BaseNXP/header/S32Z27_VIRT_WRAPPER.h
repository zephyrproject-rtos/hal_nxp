...
/*!
 * @file S32Z27_VIRT_WRAPPER.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_VIRT_WRAPPER
 *
...
#if !defined(S32Z27_VIRT_WRAPPER_H_)  /* Check if memory map has not been already included */
#define S32Z27_VIRT_WRAPPER_H_
...
#define VIRT_WRAPPER_INSTANCE_COUNT                 (5u)

/* VIRT_WRAPPER - Peripheral instance base addresses */
/** Peripheral VIRT_WRAPPER_0 base address */
#define IP_VIRT_WRAPPER_0_BASE                      (0x40560000u)
/** Peripheral VIRT_WRAPPER_0 base pointer */
#define IP_VIRT_WRAPPER_0                           ((VIRT_WRAPPER_Type *)IP_VIRT_WRAPPER_0_BASE)
/** Peripheral VIRT_WRAPPER_1 base address */
#define IP_VIRT_WRAPPER_1_BASE                      (0x40D60000u)
/** Peripheral VIRT_WRAPPER_1 base pointer */
#define IP_VIRT_WRAPPER_1                           ((VIRT_WRAPPER_Type *)IP_VIRT_WRAPPER_1_BASE)
/** Peripheral VIRT_WRAPPER_3 base address */
#define IP_VIRT_WRAPPER_3_BASE                      (0x41D60000u)
/** Peripheral VIRT_WRAPPER_3 base pointer */
#define IP_VIRT_WRAPPER_3                           ((VIRT_WRAPPER_Type *)IP_VIRT_WRAPPER_3_BASE)
/** Peripheral VIRT_WRAPPER_4 base address */
#define IP_VIRT_WRAPPER_4_BASE                      (0x42560000u)
/** Peripheral VIRT_WRAPPER_4 base pointer */
#define IP_VIRT_WRAPPER_4                           ((VIRT_WRAPPER_Type *)IP_VIRT_WRAPPER_4_BASE)
/** Peripheral VIRT_WRAPPER_5 base address */
#define IP_VIRT_WRAPPER_5_BASE                      (0x42D60000u)
/** Peripheral VIRT_WRAPPER_5 base pointer */
#define IP_VIRT_WRAPPER_5                           ((VIRT_WRAPPER_Type *)IP_VIRT_WRAPPER_5_BASE)
/** Array initializer of VIRT_WRAPPER peripheral base addresses */
#define IP_VIRT_WRAPPER_BASE_ADDRS                  { IP_VIRT_WRAPPER_0_BASE, IP_VIRT_WRAPPER_1_BASE, IP_VIRT_WRAPPER_3_BASE, IP_VIRT_WRAPPER_4_BASE, IP_VIRT_WRAPPER_5_BASE }
/** Array initializer of VIRT_WRAPPER peripheral base pointers */
#define IP_VIRT_WRAPPER_BASE_PTRS                   { IP_VIRT_WRAPPER_0, IP_VIRT_WRAPPER_1, IP_VIRT_WRAPPER_3, IP_VIRT_WRAPPER_4, IP_VIRT_WRAPPER_5 }
...
#endif  /* #if !defined(S32Z27_VIRT_WRAPPER_H_) */
