...
/*!
 * @file S32Z27_CLASS_0X9_CORESIGHT_COMPONENT.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_CLASS_0X9_CORESIGHT_COMPONENT
 *
...
#if !defined(S32Z27_CLASS_0X9_CORESIGHT_COMPONENT_H_)  /* Check if memory map has not been already included */
#define S32Z27_CLASS_0X9_CORESIGHT_COMPONENT_H_
...
/** Peripheral CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT base address */
#define IP_CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT_BASE (0x24400FCCu)
/** Peripheral CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT base pointer */
#define IP_CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT ((CLASS_0X9_CORESIGHT_COMPONENT_Type *)IP_CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT_BASE)
/** Array initializer of CLASS_0X9_CORESIGHT_COMPONENT peripheral base addresses
 * */
#define IP_CLASS_0X9_CORESIGHT_COMPONENT_BASE_ADDRS { IP_CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT_BASE }
/** Array initializer of CLASS_0X9_CORESIGHT_COMPONENT peripheral base pointers
 * */
#define IP_CLASS_0X9_CORESIGHT_COMPONENT_BASE_PTRS { IP_CEVA_SPF2__CLASS_0X9_CORESIGHT_COMPONENT }
...
#endif  /* #if !defined(S32Z27_CLASS_0X9_CORESIGHT_COMPONENT_H_) */
