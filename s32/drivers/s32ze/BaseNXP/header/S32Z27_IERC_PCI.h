...
/*!
 * @file S32Z27_ierc_pci.h
 * @version 1.7
 * @date 2022-03-16
 * @brief Peripheral Access Layer for S32Z27_ierc_pci
 *
...
#if !defined(S32Z27_ierc_pci_H_)  /* Check if memory map has not been already included */
#define S32Z27_ierc_pci_H_
...
#endif  /* #if !defined(S32Z27_ierc_pci_H_) */
