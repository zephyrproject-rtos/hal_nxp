...
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_70[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_70[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_71[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_71[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_72[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_72[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_73[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_73[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_74[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_74[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_75[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_75[NUMBER_OF_CORES];
